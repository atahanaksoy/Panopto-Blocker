...
!(function (e) {
    ...
    var t = (function () {
      ...
      return (
          ...
          if (this.userId)
            t =
              this.userId === this.ownerId
                ? new e.QuotaPlaybackModalDialogs.OwnerDialog(this.resources)
                : new e.QuotaPlaybackModalDialogs.ViewerDialog(this.resources);
          else {
            var o = new e.QuotaPlaybackModalDialogs.AnonymousUserDialog(
              this.blocked,
              this.signupUrl,
              this.resources
            );
        ...
        (t.prototype.resize = function () {
          ...
          this.modal.css({ transform: "scale(" + Math.min(1, e) + ")" });
        }),
      ...
      var t = (function () {
        function t(e, n, o, i, a, r, s) {
          (this.cookieService = e),
            ...
            (this._onToggle = new PanoptoCore.TypedCallback()),
            (this.quotaBlockedCookieName =
              t.quotaBlockedCookiePrefix + this.deliveryId);
        }
        return (
          Object.defineProperty(t.prototype, "onToggle", {
            get: function () {
          ...
          (t.prototype.initialize = function (n) {
            ...
            (this.overQuota = n),
              ...
              this.overQuota &&
                (this.availableSeconds = this.blocked
                  ? 0
                  : t.playbackTeaseDuration),
              (this.modal = new e.QuotaPlaybackModal(
                this.blocked,
                this.userId,
                this.ownerId,
                this.signupUrl,
          ...
          (t.prototype.update = function (e) {
            if (
              !this.userId &&
              !this.overQuota &&
              0 === this.secondsListened &&
              e
            ) {
              var n =
                parseInt(
                  this.cookieService.getCookie(t.signupViewedCookieName),
                  10
                ) || 0;
              n % t.signupShowInterval == t.signupShowInterval - 1 &&
                this.modal.show(),
                this.cookieService.setCookie(t.signupViewedCookieName, n + 1);
            }
            (this.secondsListened += e),
              (this.blocked =
                void 0 !== this.availableSeconds &&
                this.secondsListened >= this.availableSeconds),
              this.blocked &&
                ((this.modal.blocked = this.blocked),
                this.modal.show(),
          ...
          (t.prototype.setBlockedCookie = function (e) {
            e
              ? this.cookieService.setCookie(this.quotaBlockedCookieName, e)
              : this.cookieService.deleteCookie(this.quotaBlockedCookieName);
          }),
          (t.prototype.getBlockedCookie = function () {
            return (
              "true" ===
              this.cookieService.getCookie(this.quotaBlockedCookieName)
            );
          }),
        ...
        var t = (function () {
          function t(t, n, o, i) {
            (this.target = t),
              ...
              (this.fileProcessingRegion = new e.FileProcessingRegion(
          ...
          return (
            ...
            (t.prototype.toggleProcessingStatus = function (e) {
              ...
              if (e.length) {
                if (
                  (this.fileProcessingRegion.render(e),
                  ...
                  if ((this.errorFiles.push(o.uploadId), 1 === o.streamType)) {
                    ...
                    i.text(
                      Panopto.GlobalResources.ViewerPlus_Overlay_InvalidFiletype.format(
                        o.filename
                      )
                    ),
                      a.attr("src", n),
                      setTimeout(function () {
                        i.text(
                          Panopto.GlobalResources
                            .ViewerPlus_PrimaryOverlay_Subtitle
                        ),
                          a.attr(
                            "src",
                            Panopto.cacheRoot +
                              "/Images/upload_primary_stream_large.svg"
                          );
                    ...
                    r.text(
                      ...
                      setTimeout(function () {
                        r.text(
                          Panopto.GlobalResources
                            .ViewerPlus_SecondaryOverlay_Subtitle
                        ),
                          s.attr(
                            "src",
                            Panopto.cacheRoot +
                              "/Images/upload_secondary_stream.svg"
                          );
                      }, this.errorMessageDuration);
                  }
                }
    ...
    return (
      ...
      (e.QualityReporter = function (t) {
        ...
        return (
          (l = (t.isBroadcast
            ? new RegExp(
                "Sessions/(?:(?:_hlsbc)|(?:_rtmp))/([a-z0-9-]{36})/master.m3u8\\??(.*)",
                "i"
              )
            : new RegExp(
                "Sessions/[a-z0-9-]{36}/([a-z0-9-]{36}(?:-[a-z0-9-]{36})?)..*hls/master.m3u8\\??(.*)",
                "i"
              )
          ).exec(t.streamUrl)) && l.length
            ? (l.length >= 2 && (n = l[1]),
              l.length >= 3 &&
                ((c = new RegExp("InvocationID=([a-z0-9-]{36})", "i").exec(
                  l[2]
                )),
                (o = c && 2 === c.length ? c[1] : "")))
            : (p = !1),
          {
            flushQualityReport: function (l, c, f, h, m, v) {
              var y = c - u;
              p &&
                d &&
                y >= t.minDuration &&
                Panopto.GoogleAnalytics.sendEvent({
                  ...
                  label: t.isBroadcast
                    ? s
                      ? e.Labels.BroadcastAutoLevel
                      : e.Labels.BroadcastManualLevel
                    : s
                    ? e.Labels.OndemandAutoLevel
                    : e.Labels.OndemandManualLevel,
                  customFields: {
                    dimension1: Panopto.webServerFQDN,
                    dimension2: n,
                    dimension3: o,
    ...
    !(function (e) {
      var t = (function () {
        function e(e) {
          ...
          (this.muted = o),
            (this.playsInline = a),
            (this.autoPlayRequested = s);
        }
        return (
          (e.prototype.detect = function () {
            var t = $.Deferred(),
              n = new RegExp(Panopto.viewer.autoPlayWhitelistRegex).test(
                navigator.userAgent
              ),
              o = new RegExp(Panopto.viewer.autoPlayBlacklistRegex).test(
                navigator.userAgent
              );
            if (!this.autoPlayRequested || o) t.resolve(!1);
              ...
              var i = $(
                  '<video class="' + e.videoElementClass + '">'
                ).prependTo("body"),
                a = i[0];
              (a.src = e.dummyMp4WithAudio),
                (a.muted = this.muted),
                (a.playsInline = this.playsInline);
              var r = a.play();
              "Promise" in window && r instanceof Promise
                ? r
                    .then(function () {
                      return t.resolve(!0);
                    })
          ...
          (e.videoElementClass = "auto-play-detector"),
          (e.dummyMp4WithAudio =
    ...
    !(function (e) {
      var t = (function () {
        ...
        return (
          ...
          (e.MinSegmentGap = 1),
          (e.ContiguousSegmentThreshold = 0.2),
          (e.EndPositionThreshold = 0.1),
          ...
          (e.TOCMaxLength = 200),
          (e.EditorTimelineEndOffsetSeconds = 0.01),
          (e.DisplayTimePrecisionMultiplier = Math.pow(
            10,
            Panopto.Core.Constants.DisplayTimeMillisecondPrecision
          )),
          (e.UrlEventClosenessTolerance = 0.1),
          (e.BoundaryCutTolerance = 0.1),
          (e.StreamDeleteCutTolerance = 0.01),
          (e.LeftPaneRatio = 0.35),
          ...
          (e.SilverlightEditorUrlTemplate =
            e.BaseUrl + "/Pages/Editor/Default.aspx#{0}"),
          ...
          (e.YouTubeEditUrlTemplate =
            e.SinglePageAppUrl + "youtubeEmbed/configure/{0}"),
          ...
          (e.BitrateLevels = [
            Panopto.GlobalResources[e.BitrateResourcePrefixString + "Low"],
            Panopto.GlobalResources[e.BitrateResourcePrefixString + "Medium"],
            Panopto.GlobalResources[e.BitrateResourcePrefixString + "Medium"],
            Panopto.GlobalResources[e.BitrateResourcePrefixString + "High"],
          ]),
          (e.MaxScormSegments = 100),
          (e.ScormCompleteThreshold = 0.9),
          ...
          (e.OutcomeFormat =
            "resultScore={0}&lis_result_sourcedid={1}&oauth_consumer_key={2}&lti_message_type=panopto_outcome_pox_response&lti_version=LTI-1p0"),
          e
        );
      })();
      (e.Constants = t),
      ...
      (e.EnumHelpers = n),
        (function (e) {
          e.HttpHeaders = { Date: "date", LastModified: "last-modified" };
  ...
  (Panopto.Viewer.PlayState = (function (e) {
    return (
      (e.Playing = Panopto.Core.ViewerPlayState.Playing),
  ...
  (function (e) {
    !(function (e) {
      Panopto.Core.StringHelpers.parseQueryString(window.location.hash.slice(1))
        .debug &&
        (window.fireDebugEvent = function (e) {
          var t = new CustomEvent(e.typeArg(), { detail: e });
  ...
  (function (e) {
    !(function (e) {
      var t = (function () {
        ...
        return (
          (e.prototype.routeDelivery = function (e) {
            e.isReadyForEditing
              ? Panopto.Core.Browser.isIE8 || Panopto.Core.Browser.isIE9
                ? this.showUnsupportedBrowserCallback()
                : !Panopto.viewer.editingEnabled || e.requiresAdvancedEditor
                ? this.showSilverlightEditorCallback()
                : e.isPurgedLegacyEncode
                ? this.showPurgedDeliveryCallback()
                : Panopto.viewer.hasEditedTranscriptionRequest
                ? this.showPendingTranscriptionCallback()
                : this.showHtmlEditorCallback()
              : e.RehydrationAvailable &&
                Panopto.viewer.enableEditorProcessingPageDuringHydration
              ? this.showEditorProcessingCallback()
              : this.showSessionNotReadyCallback();
          }),
          e
        );
      })();
  ...
  ((Panopto = Panopto || {}).Viewer = Panopto.Viewer || {}),
  ((PanoptoLegacy = Panopto).Viewer.Layout = function (
    e,
    t,
    n,
    o,
    ...
    var d,
      u,
      p,
      f = PanoptoTS.Viewer.ViewMode,
      h = PanoptoTS.Viewer.Constants,
      m = $("#viewer"),
      v = $("#viewerContent"),
      y = $("#searchRegion"),
      P = $("#eventTabs"),
      ...
      R = "",
      D = !1,
      x = !(($.browser.msie && parseFloat($.browser.version) < 10) || l || c),
      L = !1,
      O = g.outerWidth(),
      U = h.LeftPaneMinWidth,
      M = function (o, i) {
        var a = n.getLeftPane();
        a.stop(),
          o
            ? i
              ? (a.width(U).css("max-width", U), (L = !1))
              : a.animate(
                  { width: U, "max-width": U },
                  {
          ...
          S.find("div")
            .text(
              o
                ? Panopto.GlobalResources.ViewerPlus_HideEventTabs
                : Panopto.GlobalResources.ViewerPlus_ShowEventTabs
            )
            .attr("aria-expanded", o),
          y.toggleClass("collapsed", !o),
          t.viewer.setState({ eventPaneIsExpanded: o });
      },
      H = function (e, t) {
        var n = T.is(":visible");
        T.width(e).height(t).show(),
          A.css("margin-top", (t - A.height()) / 2),
          n || T.hide();
      },
      B = function () {
      ...
      F = function (e) {
        ...
        if (
          t !== o.PrimaryDefaultIndex &&
          e === PanoptoTS.Viewer.ViewMode.Secondary
        ) {
    ...
    $("#wrapper").css("min-width", "0px"),
      ...
      $.browser.msie &&
        8 === parseFloat($.browser.version) &&
        (C.find("#transportControls").css("table-layout", "fixed"),
    ...
    $(document)
      ...
      (e.resize = function () {
        var i,
          ...
          I =
            b.is(":visible") &&
            b.hasClass(Panopto.Core.Constants.ExpandedClass),
          R = $(window).height() - s.height() - (I ? b.outerHeight() : 0),
          D = $(window).width(),
          x = S.outerWidth() - S.width(),
          U = y.is(":visible") ? y.outerHeight(!0) : 0,
          M =
            (b.is(":visible") && !I ? b.outerHeight() : 0) +
            (E.is(":visible") ? E.outerHeight() : 0) +
            (w.is(":visible") ? w.outerHeight() : 0),
          F = Math.max(R - C.outerHeight() - M, h.PlayerMinHeight),
          N = V.outerWidth() - V.width(),
          z = V.outerHeight() - V.height();
        switch (
          (v.height(R),
          b.css("top", I ? $(window).height() - b.outerHeight() + "px" : ""),
          d)
        ) {
          case f.Primary:
            (l = h.LeftPaneMinWidth),
              (i = L ? parseInt(S.css("max-width").slice(0, -2)) : l),
              (p = Math.max(D - i - x, h.RightPaneMinWidth)),
              S.width(i),
              (g = Math.max(R, h.EventRegionMinHeight) - U),
              P.height(g),
              t.viewer.setState({ eventPaneSize: { width: i - O, height: g } }),
              k.width(l),
              k.height(R),
              ...
              A.height(0),
              H(p, F),
              $("#copyrightNoticeContainer").height(R),
              m.css("min-width", i + x + h.RightPaneMinWidth),
              c && c.resize(I ? i + x + p : p),
              w.width(p),
          ...
          case f.Secondary:
            (l =
              r.isPrimaryAudioOnly || c
                ? h.LeftPaneMinWidth
                : Math.max(D * h.LeftPaneRatio, h.LeftPaneMinWidth)),
              (i = L ? parseInt(S.css("max-width").slice(0, -2)) : l),
              (p = Math.max(D - i - x, h.RightPaneMinWidth)),
              ...
              T &&
                (R -
                  (u =
                    0 === T.height() || 0 === T.width() || r.isPrimaryAudioOnly
                      ? e.forceLeftPlayerHeight
                        ? h.LeftPlayerDefaultHeight
                        : 0
                      : (i * T.height()) / T.width()) >=
                h.EventRegionMinHeight
                  ? (T.resize(i, u), A.width(i), A.height(u), (g = R - u - U))
                  : (T.resize(
                      i,
                      Math.max(R - h.EventRegionMinHeight, h.PlayerMinHeight)
                    ),
                    A.width(i),
                    A.height(
                      Math.max(R - h.EventRegionMinHeight, h.PlayerMinHeight)
                    ),
                    (g = h.EventRegionMinHeight - U))),
              P.height(g),
              t.viewer.setState({ eventPaneSize: { width: i - O, height: g } }),
              k.width(l),
              k.height(R),
              ...
              _.each(o.getRightPlayers(), function (e, t) {
                if (e) {
                  ...
                  if (t !== o.getPrimaryPlayerIndex()) {
                    ...
                    $(r).css("border-left-width") &&
                      (i += parseFloat($(r).css("border-left-width"))),
                      $(r).css("border-right-width") &&
                        (i += parseFloat($(r).css("border-right-width"))),
                      $(r).css("border-top-width") &&
                        (a += parseFloat($(r).css("border-top-width"))),
                      $(r).css("border-bottom-width") &&
                        (a += parseFloat($(r).css("border-bottom-width")));
                  }
          ...
          case f.LiveNotes:
            (i = h.LeftPaneMinWidth),
              S.width(i),
              t.viewer.setState({ eventPaneSize: { width: i - O, height: R } }),
              k.width(0);
        }
        e.positionAutoplayMessage();
      });
    var z = function (t) {
        o.swapLeftAndRight(t), F(d), e.resize();
      },
      G = function (e) {
          ...
          case f.Primary:
            i.css("max-height", 0),
              ...
              x &&
                ...
                !d || (r.isPrimaryAudioOnly && L) || M(!0, !0));
            break;
          case f.Secondary:
            t.css("max-height", ""),
              i.css("max-height", ""),
              r.isPrimaryAudioOnly ||
                (L && M(!0, !0),
    ...
    (e.swapLeftToRight = function (t) {
      ...
      (e.swapPrimaryAndFirstSecondary = function () {
        e.swapLeftToRight(
          o.getPrimaryPlayerIndex() == o.PrimaryDefaultIndex
            ? 0
            : o.PrimaryDefaultIndex
        );
      }),
      (e.interruptLayoutChanges = function (t) {
        a.length > 1 &&
          (t || e.viewMode()) === f.Secondary &&
          ((p = a.length), e.setSecondaryCount(1));
        var n = o.getPrimaryPlayerIndex();
        n != o.PrimaryDefaultIndex &&
          (void 0 !== t && o.setViewMode(t), (u = n), z(o.PrimaryDefaultIndex));
      }),
      ...
      (e.isSecondarySwapAllowed = function () {
        return (
          ...
          !_.any(a, function (e) {
            return (
              e.getTabControl() &&
              e.getTabControl().selectedTab() &&
              e.getTabControl().selectedTab().content().isSecondaryPaneOnly
            );
          })
        );
      }),
      (e.viewMode = function (n) {
        ...
        n !== d &&
          ...
          !d &&
            x &&
            ((n !== f.Primary && !r.isPrimaryAudioOnly) ||
            (t.viewer && t.viewer.props && t.viewer.props.initialSearchTerm) ||
            r.contents.length
              ? M(!0, !0)
              : M(!1, !0)),
          (d = n),
          n === f.Primary && o.getPrimaryPlayerIndex() !== o.PrimaryDefaultIndex
            ? (e.interruptLayoutChanges(n), G(n))
            : (o.setViewMode(n),
              n === f.Secondary && void 0 !== u
                ? (e.restoreLayoutChanges(), G(n))
                : F(n)),
          e.resize());
      }),
      (e.toggleInlineSecondaries = function () {
        var e,
          t = $(window).width() < h.CollapseSecondaryTabsWidth,
          n = $("#transportControls > ." + h.SecondaryTabHeaderClass),
          o = $("#selectedSecondary");
        Panopto.viewer.allowMultipleSecondaryDisplay
          ? (o.hide(), n.hide())
          : 1 === a.length &&
            ((e = _.filter(a[0].getTabs(), function (e) {
              return !e.hiddenTab();
            })),
            t
              ? (o.toggle(e.length > 1), n.css("display", "none"))
              : (o.toggle(e.length > h.MaxInlineSecondaryTabs),
                n.css(
                  "display",
                  e.length > 1 && e.length <= h.MaxInlineSecondaryTabs
                    ? ""
                    : "none"
                )));
      }),
      ...
      (e.expandTimeline = function (t) {
        b.toggleClass(Panopto.Core.Constants.ExpandedClass, t), e.resize();
      }),
      (e.resizeCaption = function (t, n) {
        var a = o.getLeftPlayerElement(),
          r = o.getRightPlayerElements().first(),
          s = e.fullscreenPlayer(),
          l = s ? (s === i ? a : r) : d === f.Primary ? a : r,
          c = l.find(".screen:visible"),
          u = 0;
        s
          ? ((l = l.find("video")),
            (u = $(".fullscreen-controls").outerHeight(!0) + 10))
          : c.length && c.width() && c.offset().left > 0 && (l = c),
          "string" == typeof t &&
            (R = Panopto.Core.TextHelpers.displayLineBreaks(
              Panopto.Core.TextHelpers.cleanTextWithoutHighlighting(t)
            )),
          void 0 !== n && (D = n),
          s || !D
            ? (I.html(R),
          ...
          (this.quizzes = o),
            ...
            (this.recordResult = function (n, o, i) {
              if (_.isNumber(o) && _.isNumber(i)) {
                a.results[n] = { correct: o, questions: i };
                ...
                if (!_.contains(r, null)) {
                  var s = _.reduce(r, function (e, t) {
                    ...
                    l = Panopto.Core.StringHelpers.format(
                      e.Constants.OutcomeFormat,
                      s.correct / s.questions,
                      a.ltiConfig.outcomeId,
                      a.ltiConfig.oauthConsumerKey
                    );
                  (a.isUpdatingResults = !0),
                    $.ajax({
                      ...
                      error: function (e) {
                        t.warning(
                          "Exception while performing an LTI page get in recordResult",
                          e
                        );
                      },
                    }).always(function () {
  ...
  (function (e) {
    !(function (t) {
      var n = (function () {
        ...
        return (
          Object.defineProperty(n.prototype, "onSecondaryLayoutChanged", {
            get: function () {
          ...
          (n.prototype.getPrimaryPlayerIndex = function () {
            return this.viewMode !== e.Viewer.ViewMode.Secondary
              ? this.PrimaryDefaultIndex
              : this.primaryPlayerIndex;
          }),
          (n.prototype.getLeftPlayer = function () {
            return this.primaryPlayerIndex === this.PrimaryDefaultIndex ||
              this.viewMode !== e.Viewer.ViewMode.Secondary
              ? this.primaryPlayer
              : this.secondaryContentContainers[
                  this.primaryPlayerIndex
                ].getCurrentPlayer();
          }),
          (n.prototype.getLeftPlayerElement = function () {
            return this.primaryPlayerIndex === this.PrimaryDefaultIndex ||
              this.viewMode !== e.Viewer.ViewMode.Secondary
              ? this.pageStructureElements.getPrimaryPlayer()
              : $(
                  this.pageStructureElements.getSecondaryPlayers()[
                    this.primaryPlayerIndex
                  ]
                );
          }),
          (n.prototype.getRightPlayers = function () {
            ...
            return (
              this.primaryPlayerIndex !== this.PrimaryDefaultIndex &&
                this.viewMode === e.Viewer.ViewMode.Secondary &&
                (t[this.primaryPlayerIndex] = this.primaryPlayer),
              t
            );
          }),
          (n.prototype.getRightPlayerElements = function () {
            ...
            return (
              this.primaryPlayerIndex !== this.PrimaryDefaultIndex &&
                ...
                (t[
                  this.primaryPlayerIndex
                ] = this.pageStructureElements.getPrimaryPlayer()[0]),
              t
            );
          }),
          (n.prototype.getPlayerFromElement = function (e) {
            var t,
              n = this.pageStructureElements.getPlayerFromElement(e);
            if (1 === n.length)
              if (n[0] === this.pageStructureElements.getPrimaryPlayer()[0])
                t = this.primaryPlayer;
              else {
                var o = this.pageStructureElements
                  .getSecondaryPlayers()
                  .toArray()
                  .indexOf(n[0]);
                o >= 0 &&
                  (t = this.secondaryContentContainers[o].getCurrentPlayer());
              }
            return t;
          }),
          ...
          (n.prototype.onPlayerSwap = function (e) {
            _.contains(this.playerSwapHandlers, e) ||
              this.playerSwapHandlers.push(e);
          }),
          (n.prototype.offPlayerSwap = function (e) {
            var t = this.playerSwapHandlers.indexOf(e);
            t >= 0 &&
              (this.playerSwapHandlers = this.playerSwapHandlers.splice(t, 1));
          }),
          ...
          (n.prototype.getAllowedSecondaryLayouts = function () {
            return [
              t.SecondaryLayoutType.Single,
              t.SecondaryLayoutType.Double,
              t.SecondaryLayoutType.Quad,
            ];
          }),
          (n.prototype.setSecondaryLayout = function (e) {
            e !== this.secondaryLayout &&
              ((this.secondaryLayout = e),
  ...
  (function (e) {
    ...
    (function (t) {
      var n = (function () {
        function t() {}
        return (
          (t.prototype.getPrimaryPlayer = function () {
          ...
          (t.prototype.getPlayerFromElement = function (e) {
            return e.closest(
              t.primaryPlayerSelector + ", " + t.secondaryPlayerSelector
            );
          }),
          (t.primaryPlayerSelector = "#primaryPlayer"),
          (t.secondaryPlayerSelector =
            "." + e.Viewer.Constants.SecondaryPlayerClass),
          t
        );
      })();
      t.PageElements = n;
        ...
        return (
          ...
          (t.prototype.setContentClass = function (t) {
            this.getContent().attr(
              "class",
              e.Viewer.Constants.SecondaryContentClass + " " + t
            );
          }),
...
(Panopto.Viewer.Viewer = function (e, t, n, o, i, a, r) {
  ...
  var ye,
    ...
    Ce = new PanoptoTS.Viewer.EditorRouter(
      ...
      function () {
        var t = Panopto.Core.StringHelpers.format(
          "<a href='#'>{0}</a>",
        ...
        switch (t.ErrorCode) {
          ...
          default:
            e.toggleMessage(
              ...
              Panopto.GlobalResources.ViewerPlus_ContactSupport,
              $(".support-email").attr("href")
            );
        }
      else
        Panopto.uriScheme !== window.location.protocol.replace(":", "") &&
        Panopto.Core.Browser.isIE
          ? e.toggleMessage(
              Panopto.GlobalResources.ViewerPlus_IESSLWarning,
              Panopto.GlobalResources.ViewerPlus_IESSLLink,
              Panopto.viewer.secureBrowserHelpUrl
            )
        ...
        g.user.key
          ? ((s = Panopto.Viewer.Header(e, g, void 0, void 0, void 0, t)),
            ...
            Panopto.authCookieTimeoutMinutes &&
              setInterval(
                t.refreshAuthCookie,
                (60 * Panopto.authCookieTimeoutMinutes * 1e3) / 2
              ))
          : (window.location.href =
              Panopto.loginUrl +
              "?ReturnUrl=" +
        ...
        if (
          ...
          ("wmv" === g.activePrimary.fileType && Panopto.Core.Browser.isSafari)
            ? (o
                ...
                : Panopto.Core.Browser.isSilverlightSupported
                ? $("#silverlightMessage").show()
                : e.toggleMessage(
                    Panopto.GlobalResources.Silverlight_DisabledChromeViewer,
          ...
          Panopto.viewer.htmlPlaybackOnly
            ? e.toggleMessage(
                Panopto.GlobalResources.ViewerPlus_NoInternetExplorer
              )
            : e.toggleMessage(
      ...
      g.folder.id
        ...
        e.toggleMessage(
          Panopto.GlobalResources.ViewerPlus_SessionNotReady +
            "<br>" +
            Panopto.GlobalResources.ViewerPlus_SessionNotReadyRefresh,
          t,
          n
        );
    },
  ...
  $(document).ready(function () {
    ...
    (e.getPosition = function () {
      return new PanoptoTS.Core.Logic.Time.UneditedFirstPrimaryRelative(
        e.position() * Panopto.Core.Constants.TimelineChunkMultiplier
      );
    }),
    ...
    (e.submitClientLog = function (e, t) {
      ...
      Panopto.Core.ServiceInterface.WCFRest.DataCS.submitViewerClientLog(
        n,
        e,
        t
      );
    ...
    (e.reportPercentCompleted = function (t) {
      Panopto.viewer.disableSeekAndVsp &&
        Panopto.viewer.enableSeekAndVspAfterPercentage > 0 &&
        Panopto.viewer.enableSeekAndVspAfterPercentage < t &&
        e.updateDisableSeekAndVsp(!1);
    }),
          ...
          o = (function () {
            ...
            return (
              ...
              (t.prototype.handleTrigger = function (e, n, o) {
                ...
                null != this.currentTriggerRecord ||
                this.getInternalQueue(t.mainQueue).data.length
                  ? this.queueTrigger(t.mainQueue, i)
                  : this.runTrigger(i);
              }),
              (t.prototype.getInternalQueue = function (t) {
                ...
                return (
                  n ||
                    ((n = new e.Logic.StateMachine.Machine.TriggerRecordQueue(
                      t.name
                    )),
              ...
              (t.prototype.shouldQueueTrigger = function (e, n) {
                ...
                if (!n.completeCallback) {
                  var i,
                    a = this.getInternalQueue(e);
                  a.data.length
                    ? (i = a.data[a.data.length - 1])
                    : e === t.mainQueue && (i = this.currentTriggerRecord),
                    i &&
                      i.trigger === n.trigger &&
                      i.data === n.data &&
                      (o = !1);
              ...
              (t.prototype.logQueue = function (e) {
                ...
                n.verbose(
                  Panopto.Core.StringHelpers.format(
                    "[{0}] {1} {2}: {3}",
                    this.name,
                    "Queue",
                    e.name,
                ...
                if (e) {
                  ...
                  o
                    ? (n = o.toState)
                      ...
                      : (n = e)
                    : _.contains(e.ignoreTriggers, t.trigger) && (n = e);
                }
                return n;
              }),
              (t.prototype.queueTrigger = function (e, n) {
                if (this.shouldQueueTrigger(e, n)) {
                  ...
                  e === t.mainQueue &&
                    (o.expectedEndState ||
                      (o.expectedEndState = this.getExpectedState(
                        this.currentState,
                        this.currentTriggerRecord
                      )),
                    ...
                    o.data.push(n),
                    this.logTriggerRecord(
                      n,
                      e === t.mainQueue ? "Queued" : "Delay queued"
                    ),
                    this.logQueue(o);
                }
              }),
              (t.prototype.createTriggerRecord = function (e, t, n) {
                return { trigger: e, data: t, completeCallback: n };
              }),
              (t.prototype.logTriggerRecord = function (e, t) {
                var o = new Date(),
                  i = Panopto.Core.StringHelpers.format(
                    "[{0}] {1}:{2}.{3} {4} trigger {5} from state {6}{7}{8}",
                    this.name,
                    o.getMinutes(),
                    o.getSeconds(),
                    o.getMilliseconds(),
                    ...
                    void 0 !== e.data
                      ? " with data " +
                          ("object" == typeof e.data
                            ...
                            : e.data)
                      : "",
                    e.expectedStartState
                      ? " expectedState " + e.expectedStartState.name
                      : ""
                  );
                n.verbose(i);
              }),
              (t.prototype.runTrigger = function (e) {
                ...
                if (o)
                  if (o.delayToQueue) this.queueTrigger(o.delayToQueue, e);
                    ...
                    if (
                      this.currentTriggerRecord.expectedStartState !==
                        this.currentState &&
                      i.data.length
                    ) {
                      ...
                      _.each(i.data, function (e) {
                        a || e.expectedStartState === r
                          ? (a = !0)
                          : ((e.expectedStartState = r),
                    ...
                    if (
                      (this.currentTransition.exitEvent &&
                        this.attachEvent(
                          void 0,
                          this.currentTransition.exitEvent,
                          s
                  ...
                  _.contains(this.currentState.ignoreTriggers, e.trigger) ||
                    this.logTriggerRecord(e, "No transition for"),
              ...
              (t.prototype.exitTransition = function (e, o) {
                if (e && e !== this.currentTransition)
                  n.info(
                    "Transition ended which is not the current transition"
                  );
                else {
                  var i;
                  (this.currentTriggerRecord = void 0),
                    ...
                    e &&
                      e.toState &&
                      (this.enterState(e.toState),
                      e.toState.triggerOnEnter &&
                        (i = this.createTriggerRecord(
                          e.toState.triggerOnEnter,
                          o,
                          void 0
                        )));
      ...
      !(function (t) {
        var n = PanoptoCore.VoidCallback,
          o = (function () {
            ...
            return (
              Object.defineProperty(t.prototype, "onDismiss", {
                get: function () {
              ...
              (t.prototype.render = function () {
                var n = this;
                (this.dialogTitle = this.blocked
                  ? this.resources.QuotaDialog_OutOfHours
                  : this.resources.QuotaDialog_TryPanopto),
                  (this.dialogSubTitle = this.blocked
                    ? "<div class='quota-dialog-subtitle-spacing'>" +
                      this.resources.QuotaDialog_GetAccess +
                      "</div>"
                    : ""),
                  (this.panoptoLogo = e.ImageHelpers.getImageUrl(
                    "Header/Panopto_logo_2015.svg"
                  )),
                  (this.element = $(t.template(this))),
                  this.blocked ||
                    Panopto.Core.UI.Handlers.button(
                      this.element.find(".quota-dialog-close"),
                      function () {
                        n._onDismiss.fire();
                      }
                    );
          ...
          return (
            (t.prototype.render = function () {
              (this.panoptoLogo = e.ImageHelpers.getImageUrl(
                ...
                (this.element = $(t.template(this))),
                Panopto.Core.UI.Handlers.button(
                  this.element.find(".upgrade-link-dialog"),
                  function () {
                    Panopto.GoogleAnalytics.sendProUpgradeEvent(
                      PanoptoCore.ProUpgradeActions.Open,
                      PanoptoCore.ProUpgradeLabels.OpenFromOwner
                    ),
      ...
      var t = (function (e) {
        ...
        return (
          ...
          (t.prototype.renderElement = function () {
            var e = {
              primaryImage:
                Panopto.cacheRoot + "/Images/upload_primary_stream_large.svg",
              secondaryImage:
                Panopto.cacheRoot + "/Images/upload_secondary_stream.svg",
              resx: this.resources,
            };
            (this.element = $(t.template(e))),
              this.overlayUploader.attachPrimaryTargetHandler(
                this.element.find(".primary-stream .graphic-container")
              ),
              this.overlayUploader.attachSecondaryOrSlidesTargetHandler(
                this.element.find(".secondary-stream .graphic-container")
              );
          }),
          (t.template = _.template(
      ...
      var t = (function (e) {
        ...
        return (
          ...
          (t.prototype.renderElement = function () {
            var e = {
              sessionImage:
                Panopto.cacheRoot + "/Images/upload_primary_stream_small.svg",
              resx: this.resources,
            };
            (this.element = $(t.template(e))),
              this.overlayUploader.attachPrimaryTargetHandler(
                this.element.find(".graphic-container")
              );
          }),
          (t.template = _.template(
        ...
        var t = (function () {
          function e(t, n, o, i) {
            ...
            r.appendTo(t),
              ...
              i &&
                i.toggleAppearsOnHover &&
                Panopto.Core.UI.Handlers.hoverableParent(t, n);
            var s = "edit-menu-open";
            Panopto.Core.UI.Components.popup(
              r,
              n,
              function () {
                r.show();
...
!(function (e) {
          ...
          return (
            (e.prototype.onResize = function (e) {
              e &&
                e.width > 0 &&
                e.height > 0 &&
                (this.eventTabPanes.width(e.width),
              ...
              if (
                ...
                switch ((t.removeClass(i), a.state)) {
                  case 1:
                    t.text(
                      Panopto.Core.StringHelpers.format(
                        this.resources.FileProcessingRegion_Uploading,
                        a.filename
                      )
                    ),
                      n
                        .show()
                        .text(
                          Math.round((a.bytesUploaded / a.fileSize) * 100) + "%"
                        ),
                      o.hide();
                    break;
                  case 2:
                  default:
                    t.text(
                      Panopto.Core.StringHelpers.format(
                        this.resources.FileProcessingRegion_Processing,
                        a.filename
                      )
                    ),
                      n.hide(),
                ...
                t
                  ...
                  .text(
                    Panopto.Core.StringHelpers.format(
                      this.resources.FileProcessingRegion_ProcessingMultiple,
                      e.length
                    )
                  ),
                  n.hide(),
  ...
  (Panopto.Viewer.Header = function (e, t, n, o, i, a) {
    var r,
      ...
      f = $("#viewerHeader"),
      h = f.find("#logoContainer"),
      m = f.find("#deliveryTitle"),
      v = f.find("#editDeliveryTitle"),
      y = v.find("input"),
      P = f.find("#parentContext"),
      g = f.find("#starRating"),
      S = f.find("#podcastDownload"),
      C = f.find("#settingsButton"),
      w = f.find("#shareButton"),
      b = f.find("#editButton"),
      T = f.find("#statsButton"),
      A = f.find("#viewerHelpLink"),
      E = f.find("#signUpButton"),
      V = f.find("#signInButton"),
      I = f.find(".login-status"),
      k = f.find("#saveMessage"),
      R = f.find("#undoButton"),
      D = f.find("#redoButton"),
      x = f.find("#commitButton"),
      L = f.find("#revertButton"),
      O = f.find("#closeButton"),
      U = t.user.rating || 0,
      M =
        !Panopto.Core.Browser.inIframe() || Panopto.viewer.linksEnabledInIframe,
      H = PanoptoTS.StringHelpers.format(
        "{0}/Pages/Sessions/List.aspx",
        p.BaseUrl
      );
    !(function () {
      var e;
      if (i) e = { icon: "&#xE05F;", name: i.name };
      else if (t.folder.name) e = { icon: "&#xE2C7;", name: t.folder.name };
      else {
        var n = $("<div />");
        (s = n), (l = n), (c = n);
      }
      e &&
        (P.html(_.template($("#parentContextTemplate").html())(e)),
        ...
        i
          ? (r.attr(
              "aria-label",
              Panopto.GlobalResources.Viewer_PlaylistButton
            ),
            s.addClass("playlist-icon"),
            l.addClass("ellipsis"))
          : t.folder.name && t.folder.id && M
          ? (r.attr("role", "link"),
          ...
          : r
              .removeAttr("tabindex")
              .addClass(Panopto.Core.Constants.DisabledClass));
    })();
    var B = [h, s, l, c, m, v, g, S, k, R, D, x, L, C, w, b, T, O, A, V],
      F = o
        ? [
            { elements: [h, s, l, c, v, k, R, D, x, L, C, T, O, A] },
            { elements: [h, s, c, v, k, R, D, x, L, C, T, O, A] },
            { elements: [h, s, c, v, k, R, D, x, L, O, A] },
            { elements: [h, s, c, v, k, R, D, x, L, A] },
            { elements: [h, s, c, v, k, R, D, x, L] },
            { elements: [h, s, k, R, D, x, L] },
            { elements: [h, s, R, D, x, L] },
            { elements: [h, s] },
          ]
        : [
            { elements: [h, s, l, c, m, g, S, C, w, b, T, A, V] },
            { elements: [h, s, c, m, g, S, C, w, b, T, A, V] },
            { elements: [h, s, c, m, S, C, w, b, T, A, V] },
            { elements: [h, s, c, m, A, V] },
            { elements: [h, s, c, m, A] },
            { elements: [h, s, A] },
            { elements: [h, s] },
          ],
      N = !1,
      z = Panopto.Core.StringHelpers.parseQueryString(
        window.location.search.slice(1)
      ),
      ...
      j = function () {
        ...
        (!e && t.title.length <= p.MaxMobileTitleCharacters)
          ...
          : ((K = e
              ? Math.floor(
                  (p.MaxDesktopTitleCharacters -
                    Panopto.GlobalResources.ViewerPlus_TitleEllipsis.length) /
                    2
                )
              : Math.floor(
                  (p.MaxMobileTitleCharacters -
                    Panopto.GlobalResources.ViewerPlus_TitleEllipsis.length) /
                    2
                )),
            (W =
              t.title.slice(0, K) +
              Panopto.GlobalResources.ViewerPlus_TitleEllipsis +
              t.title.slice(-K)),
            m.text(W),
    ...
    var W,
      ...
      Y =
        (Panopto.Core.TimeHelpers.utcDateToFormattedString(t.date, "LL"),
        f.find("#viewerSupportDropdown")),
      X = Y.find(".send-client-log"),
      Z = function (e) {
        e.width(0), e.css({ visibility: "hidden" });
      };
    if (
      (Panopto.Branding.createLogo(h, Panopto.branding.smallLogo, M),
      $(document).attr("title", t.title),
      o
        ? (y.attr(Panopto.Core.Constants.InitAttribute, t.title),
          (d = Panopto.Core.UI.Components.editableLabel(y, function (t) {
            var n = o.session();
            (n.name = t),
              Panopto.Core.ServiceInterface.Rest.Sessions.update(
                n,
                function () {
                  d.save(), e.updateSessionName(t, { fromHeader: !0 }), J();
                },
                function () {
                  d.revert(), (n.name = y.val());
                }
              );
          })),
          e.addSessionNameUpdateListener(function (e, t) {
            t.fromHeader || (d.resetValue(e), J());
          }))
        : j(),
      t.downloadUrl
        ...
        : Z(S),
      t.user.permissions[PanoptoTS.Core.Permission.SessionEditContent] && M
        ? (o &&
            ((Panopto.ModalPopup.defaultInstance.opener = o),
          ...
          t.isBroadcast || o
            ...
            : Panopto.Core.UI.Handlers.button(b, function () {
                var n = Panopto.Core.StringHelpers.setQueryParameters(
                  location.href,
                  { id: t.id, edit: !0, start: e.position() }
                );
                location.href = n;
              }))
        : Z(b),
      t.user.permissions[PanoptoTS.Core.Permission.SessionEditMetadata] && M
        ? Panopto.Core.UI.Handlers.button($("#settingsButton"), function () {
            e.toggleScreens(!1),
              Panopto.Application.defaultInstance.updateState({
        ...
        : Z(C),
      t.user.permissions[
        PanoptoTS.Core.Permission.SessionShareAccessControlPolicyEnumerate
      ] && M)
    )
      ...
      var ee = PanoptoReactComponents.bootstrapReactComponent(
        PanoptoReactComponents.Control.LinkShare
      )($("#linkShareModal"), {
        isDialogOpen: !1,
        startTime: 0,
        resources: Panopto.GlobalResources,
        formatLink: function (e) {
          return (
            ...
            Panopto.webServerFQDN +
            Panopto.appRoot +
            "/Pages/Viewer.aspx?id=" +
            t.id +
            (e ? "&start=" + e : "")
          );
        },
        onClose: function () {
          return ee.setProps({ isDialogOpen: !1 });
        },
      });
      Panopto.Core.UI.Handlers.button($("#shareButton"), function () {
        ee.setProps({ isDialogOpen: !0, startTime: e.getPosition().seconds() });
      });
    } else Z(w);
    if (
      (t.user.permissions[PanoptoTS.Core.Permission.SessionViewAnalytics] &&
      M &&
      !Panopto.features.disableFeaturesRequiringExternalNetworkAccess
        ? Panopto.Core.UI.Handlers.button(T, function () {
            var e =
                !o && t.isBroadcast ? { webcastId: t.id } : { sessionId: t.id },
      ...
      u = new PanoptoTS.Core.UI.Components.PlaylistOverlay(
        $("#playlistOverlay"),
        r,
        i.id,
        z.id,
        PanoptoTS.Core.UI.Components.PlaylistOverlaySkin.Interactive,
        { includeViewableOnly: !0 },
        te,
        n && !e.isDeliveryError(),
        new PanoptoTS.Core.API.Rest.PlaylistWithSessionsService()
      );
      var ne = function (t) {
      ...
      ne(te),
        ...
        u.onPlayItem(function (n) {
          if (n === t.id)
            e.activePrimary() &&
              e.setPlayState(Panopto.Viewer.PlayState.Playing, void 0, void 0);
          else {
            var o = Panopto.Core.StringHelpers.setQueryParameters(
              location.href,
              { id: n, advance: !0 }
            );
            location.replace(o);
    ...
    if (t.user.key && Panopto.features.areRatingsEnabled && !o)
      var oe = PanoptoReactComponents.bootstrapReactComponent(
        PanoptoReactComponents.Input.RatingSelector
      )(g, {
        currentRating: U,
        resources: Panopto.GlobalResources,
        onRatingSelected: function (e) {
          oe.setProps({ currentRating: e }),
            a.rateDelivery(
              t.id,
              e,
              function () {
    ...
    if (
      (!t.user.key &&
        Panopto.features.minimizeInteractiveViewerHeaderUX &&
        (Z(A), Z(I)),
    ...
    return (
      ...
      h.find("image").length || h.find("img").on("load error", Q),
      {
        ...
        toggleLiveNotes: function (e) {
          (N = e), f.toggleClass(p.LiveNotesClass, N), g.toggle(!N);
        },
      }
    );
  }),
    ...
    !(function (e) {
      !(function (e) {
        var t = (function () {
          function e() {}
          return (
            (e.getStreamIconCode = function (e) {
              var t;
              switch (e.type) {
                case Panopto.Core.ServiceInterface.Rest.Objects
                  .StreamContentType.Audio:
        ...
        var t = (function () {
          ...
          return (
            ...
            (e.prototype.insert = function (e, t) {
              ...
              i
                ? (this.sortedChildren.splice(
                    this.sortedChildren.indexOf(i),
                    0,
                    o
                  ),
                  i.childElement.before(o.childElement))
                : (this.sortedChildren.push(o),
            ...
            (e.prototype.remove = function (e, t) {
              ...
              n &&
                (this.sortedChildren.splice(this.sortedChildren.indexOf(n), 1),
            ...
            function t(e, o, i) {
              ...
              (this.pageStructureElements = e),
                ...
                (this.overlayShowingClickHandler = function (e) {
                  $(e.target).closest(t.sessionOverlaySelector).length ||
                    (a.overlayShown && a.closeOverlays());
                }),
                document.addEventListener(
                  "click",
                  this.overlayShowingClickHandler,
                  !0
                );
            }
            return (
              Object.defineProperty(t.prototype, "onShowOverlays", {
                get: function () {
              ...
              (t.prototype.setOverlaysStreamUploader = function (e) {
                this.overlayUploader.setStreamUploader(e),
                  this.overlayUploader.areUploadersSet() &&
                    this.setupUploadOverlays(this.pageStructureElements);
              }),
              ...
              (t.prototype.setupUploadOverlays = function (n) {
                ...
                $("#viewerContent").find(t.sessionOverlaySelector).remove(),
                  ...
                  (this.emptySessionOverlay = new e.Viewer.Controls.EmptySessionOverlay(
                    $("#viewerContent"),
                    this.overlayUploader,
                    r,
                    this.resources
                  )),
                  (this.primaryOrSecondaryOverlay = new e.Viewer.Controls.AddPrimaryOrSecondaryOverlay(
                    i,
                    this.overlayUploader,
                    r,
                    this.resources
                  )),
                  (this.primaryOverlay = new e.Viewer.Controls.AddPrimaryOverlay(
                    i,
                    this.overlayUploader,
                    r,
                    this.resources
                  )),
                  (this.secondaryPlaceholder = new e.Viewer.Controls.SecondaryPlaceholder(
                    a,
                    this.overlayUploader,
                    r,
                    this.resources
                  ...
                  this.overlayUploader.attachSlidesTargetHandler(
                    this.editSlidesTabAddButton
                  ),
                  this.ready.resolve();
              }),
              ...
              (t.prototype.showOverlays = function (t, n, o, i, a) {
                var r = (void 0 === a ? {} : a).secondaryOnly,
                  ...
                  c = this.filterPendingUploadsByType(o, 2).length > 0;
                t || l
                  ? (this.emptySessionOverlay.hide(),
                    i === e.Viewer.ViewMode.Primary
                      ? ((this.primaryOverlayCloseable = t),
                        this.primaryOrSecondaryOverlay.show(
                          this.primaryOverlayCloseable
                        ),
                        this.primaryOverlay.hide(),
                        this.secondaryOverlay.hide(),
                        this.secondaryPlaceholder.hide())
                      : i === e.Viewer.ViewMode.Secondary &&
                        ((this.primaryOverlayCloseable = t),
                        (this.primaryOverlayCloseable && s) ||
                          this.primaryOverlay.show(
                            this.primaryOverlayCloseable
                          ),
                        (this.secondaryOverlayCloseable = n || !c),
                        this.secondaryOverlay.show(
                          this.secondaryOverlayCloseable
                        ),
                        this.primaryOrSecondaryOverlay.hide()))
                  : ((this.primaryOverlayCloseable = !1),
              ...
              (t.prototype.toggleSecondaryPlaceholder = function (e) {
                this.secondaryPlaceholder &&
                  (e
                    ? this.secondaryPlaceholder.show()
                    : this.secondaryPlaceholder.hide());
              }),
              (t.prototype.updateOverlayProcessing = function (e) {
                this.primaryOrSecondaryOverlay.toggleProcessingStatus(e),
                  this.primaryOverlay.toggleProcessingStatus(
                    this.filterPendingUploadsByType(e, 1)
                  ),
                  this.secondaryOverlay.toggleProcessingStatus(
                    this.filterPendingUploadsByType(e, 2)
                  ),
                  this.secondaryPlaceholder.toggleProcessingStatus(
                    this.filterPendingUploadsByType(e, 2)
                  );
              }),
          ...
          return (
            ...
            (t.prototype.updateSelectedIcon = function () {
              this.selectedIconCode
                ? this.selectedContainer
                    .find("#selectedSecondaryIcon")
                    .html(this.selectedIconCode)
                    .attr("class", "material-icons")
                : this.selectedContainer
                    .find("#selectedSecondaryIcon")
                    .html("")
                    .attr("class", this.selectedIconClass);
            }),
            t
          );
        })();
  ...
  (function (e) {
    ...
    (i = e.Viewer || (e.Viewer = {})),
      ...
      (o = (function () {
        ...
        return (
          (e.prototype.getStreamStartTime = function () {
            var e;
            if (
              this.timelineState.absoluteStart() === 1 / 0 ||
              0 === this.timelineState.duration()
            )
              e = this.absoluteSessionStart;
            else {
              var t = this.timelineState.findNextTimeNotInSessionReference(
                  this.viewer.position()
                ),
                o = this.timeConverter.toWin32EpochRelative(new n(t));
              e = new Date(
                o.milliseconds() + PanoptoCore.Constants.Win32EpochDate
              );
            }
            return e;
          }),
  ...
  (Panopto.Viewer.PlayControls = function (e, t, n, o, i, a, r, s, l) {
    var c,
      d,
      u = PanoptoTS.Viewer.ViewMode,
      p = PanoptoTS.Viewer.Constants,
      f = Panopto.Viewer.Analytics,
      h = PanoptoTS.Viewer.MBRBitrate,
    ...
    s.onMaximize.add(function (e) {
      ...
      s.onSwap.add(function () {
        var t =
          a.getPrimaryPlayerIndex() === a.PrimaryDefaultIndex
            ? 0
            : a.PrimaryDefaultIndex;
        e.swapLeftToRight(t);
      });
    var le,
      ce,
      ...
      me = fe(p.CaptionsCookie),
      ve =
        "boolean" == typeof me ? me : Panopto.viewer.captionsEnabledByDefault,
      ye = fe(p.CaptionPlacementCookie),
      Pe = fe(p.CaptionSizeCookie),
      ge = fe(p.CaptionColorCookie),
      Se =
        null !== ye && null !== Pe && null !== ge
          ? new PanoptoCore.Models.Settings.CaptionStyles(ye, Pe, ge)
          : Panopto.Captions.selectedStyles,
      Ce = !1,
      we = !1,
      be = PanoptoViewer.PlaySpeed.Normal,
      ...
      Ie = function () {
        return (
          Se.placement === PanoptoCore.Models.Settings.CaptionPlacement.Docked
        );
      },
      ke = function () {
        ...
        U.add(H).css({
          ...
          M.css({ "max-height": 3 * Se.textSize }),
          H.css({
        ...
        var n = function (e, t) {
          e.children().each(function (e, n) {
            ...
            $(n)
              .toggleClass(Panopto.Core.Constants.SelectedClass, o)
              .attr("aria-checked", String(o));
          });
        };
        e.isFullscreen()
          ? n(ee, PanoptoCore.Models.Settings.CaptionPlacement.Overlay)
          : n(ee, Se.placement),
          n(te, Se.colorSchemeKey),
          n(ne, Se.textSize);
      },
      Re = function () {
        he(p.CaptionPlacementCookie, Se.placement),
          he(p.CaptionColorCookie, Se.colorSchemeKey),
          he(p.CaptionSizeCookie, Se.textSize),
          ke(),
          e.synchronize(),
          e.resize();
      },
      De = function () {
        return t.flowPlayerEnabled || be === PanoptoViewer.PlaySpeed.Normal;
      },
      xe = function () {
        return (De() && Ce) || we;
      },
      Le = function (e, t, o) {
        n.bitrate(e),
          ...
          _.each(
            PanoptoTS.Viewer.EnumHelpers.getNameValuePairs(
              PanoptoTS.Viewer.MBRBitrate
            ),
            function (t) {
              $("#" + t.key)
                .toggleClass(
                ...
                .attr("aria-checked", (t.value === e).toString());
            }
          ),
          t && he(o, e);
      },
      Oe = function (e) {
        var t = n.isMuted();
        D.toggleClass("muted", t),
          D.attr("title", t ? v.ViewerPlus_Unmute : v.ViewerPlus_Mute),
          e && R.slider("value", n.volume());
      },
      Ue = function (e, t, o) {
        (e = Panopto.Core.ElementHelpers.clampSliderValue(R, e)),
          o &&
            f.sendEvent({
              action:
                n.volume() < e ? f.Actions.VolumeUp : f.Actions.VolumeDown,
              label: o,
            });
      ...
      He = function (e, t, n) {
        var o;
        (e = "number" == typeof t ? Ee * (t / E.width()) : e),
          (e = Math.round(Panopto.Core.ElementHelpers.clampSliderValue(E, e)));
        try {
          o = J.is(":hover");
        } catch (e) {
          o = !1;
        ...
        var i =
            o || n
              ? v.ViewerPlus_Live
              : Panopto.Core.TimeHelpers.formatDuration(e, v.TimeSeparator),
          a = q.offset().left - q.parent().offset().left,
          r = a + q.outerWidth();
        W.text(i),
          W.show(),
          void 0 !== t
            ? ((t = Math.clamp(t, 0, E.width())),
              W.css("left", t >= a && t <= r ? r : t - W.width() / 2),
              K.show().css("left", t),
              K.toggleClass("accent-tick", K.offset().left < q.offset().left))
            : (W.css("left", (e / Ee) * E.width() + q.outerWidth(!0)),
              K.hide());
      },
      Be = function () {
        L.add(oe).toggleClass("safety-text", ve);
        var e = ve ? v.ViewerPlus_Captions_Hide : v.ViewerPlus_Captions_Show;
        L.attr({ title: e, "aria-label": e, "aria-pressed": ve });
      },
      Fe = function (o) {
          ...
          t.flowPlayerEnabled &&
            ...
            (o
              ? (0 === se.find(P).length &&
                ...
                o.container().find(Ve).parent().append(se))
              : (0 === y.find(P).length &&
                  (P.removeClass(ae).show(),
                  P.children().not("#transportControls").hide(),
        ...
        var i = void 0 !== o,
          a = o === n;
        s.updateFullscreenButtons({ allowFullscreen: !0, isFullscreen: i }),
          i
            ? (s.toggleSwap(!1),
              Se.placement ===
                PanoptoCore.Models.Settings.CaptionPlacement.Docked &&
                (ee.find(".Docked").removeClass("selected"),
                ee.find(".Overlay").addClass("selected")))
            : ke(),
          s.hide({ animate: !1 }),
          ue.css("z-index", a || !i ? "" : -1),
    ...
    if (
      ...
      S.attr(
        "title",
        PanoptoTS.StringHelpers.format(v.ViewerPlus_Rewind, p.EditJumpSeconds)
      ),
      ...
      w.attr(
        "title",
        PanoptoTS.StringHelpers.format(v.ViewerPlus_Forward, p.EditJumpSeconds)
      ),
      Panopto.Core.UI.Handlers.button(b, function () {
      ...
      z.attr(
        "title",
        PanoptoTS.StringHelpers.format(v.ViewerPlus_FastForward, 10)
      ),
      e.userSeekEnabled() || z.hide(),
      E.mousemove(function (t) {
        !ce &&
          e.userSeekEnabled() &&
          ((Ae = t.clientX - E.offset().left), He(0, Ae, !1), (de = !0));
      }).mouseleave(function () {
        ce || (W.hide(), K.hide(), (de = !1));
      }),
      q.mouseup(function (t) {
        if (e.userSeekEnabled()) {
          var n = t.clientX - E.offset().left;
          Math.abs(n - Ae) <= p.SliderDragThreshold &&
            ((c = t.clientX), e.setPosition((n / E.width()) * Ee));
        }
      }),
      I.addClass(Te),
      "vertical" === Te &&
        I.find(".ui-slider-handle").on("keydown keyup", function (e) {
          e.keyCode === Panopto.Core.Key.Home
            ? (e.keyCode = Panopto.Core.Key.End)
            : e.keyCode === Panopto.Core.Key.End &&
              (e.keyCode = Panopto.Core.Key.Home);
        }),
      Panopto.Core.UI.Handlers.hoverOrDrag(I, function (e) {
        e
          ? (I.toggleClass("active", !0), k.fadeIn(p.FadeInterval))
          : k.fadeOut(p.FadeInterval, function () {
      ...
      R.slider({
        ...
        change: function (e, t) {
          var n = e;
          Ue(t.value, !1, !!n.originalEvent && f.Labels.Normal);
        },
        slide: function (e, t) {
          Ue(t.value, !1, void 0);
        },
      }),
      Panopto.Core.UI.Accessibility.slider(
        R,
        function (e) {
          return PanoptoTS.StringHelpers.format(
            v.ViewerPlus_ARIA_PercentValue,
            e
          );
        },
      ...
      D.on("keydown keyup", function (e) {
        e.keyCode >= 33 &&
          e.keyCode <= 40 &&
          R.find(".ui-slider-handle").trigger(e);
      }),
      Ue("number" == typeof o ? o : p.InitialVolume, !0, void 0),
      E.slider({
        max: Ee,
        min: 0,
        value: 0,
        ...
        change: function (t, o) {
          ...
          if (((ce = !1), Me(r), a.originalEvent)) {
            if (
              (q.hide(),
              (i = $(
                document.elementFromPoint(a.clientX || 0, a.clientY || 0)
              )).is(".timeline-event"))
            )
              i.click();
            ...
            q.show(),
              ...
              K.hide(),
              W.hide(),
              f.sendEvent({ action: f.Actions.Seek, label: f.Labels.Normal });
          } else de && He(0, Ae, !1);
        },
        slide: function (e, t) {
      ...
      e.userSeekEnabled() ||
        (E.css("pointer-events", "none"), q.attr("tabindex", -1)),
      t.isBroadcast &&
        (Y.show(),
        J.show(),
        e.userSeekEnabled()
          ? (Panopto.Core.UI.Handlers.button(J.add(Y), function () {
              n.isLive() ||
                (e.setPlayState(m.Playing, void 0, void 0),
          ...
          : (Y.addClass("seek-disabled"), Y.add(J).attr("tabindex", -1))),
      ...
      Panopto.Core.UI.Components.flyout({
        ...
        showCallback: function () {
          O.hasClass($e) ||
            (O.addClass($e),
            $("#captionStylesPartialBorder").css("width", O.innerWidth()),
    ...
    if (
      (Panopto.Core.UI.Handlers.button(L, function () {
        (ve = !ve), he(p.CaptionsCookie, ve), Be(), e.synchronize();
      }),
      Z.find("li").attr("tabindex", O.attr("tabindex")),
      (t.requiresSilverlight &&
        !Silverlight.isInstalled(p.PlaySpeedSilverlightVersion)) ||
        !t.playSpeedEnabled)
    )
      G.hide();
    else {
      Panopto.Core.UI.Components.flyout({
        ...
        j.find(".flyout-close").before(
          _.template($("#playSpeedTemplate").html())({
            playSpeeds: PanoptoCore.mapEnum(
              PanoptoViewer.PlaySpeed,
              function (e, t) {
                return {
                  text: v[p.PlaySpeedResourceString.format(e)],
                  id: e,
                  speedClass:
                    (t > PanoptoViewer.PlaySpeed.Normal ? "fast" : "") +
                    (t === PanoptoViewer.PlaySpeed.Fastest ? " fastest" : ""),
                };
              }
            ),
          })
      ...
      Ne(be),
        Panopto.Core.UI.Handlers.button(j.find(".play-speed"), function (e) {
          (be = PanoptoViewer.PlaySpeed[e.id]),
            n.playSpeed(be),
            _.each(r, function (e) {
              _.each(e.getTabs(), function (e) {
                e.playSpeed(be);
            ...
            j.hide(),
            G.focus(),
            B.toggleClass("disabled", !De()),
            De() || B.attr("title", v.ViewerPlus_QualityDisabled),
            f.sendEvent({ action: f.Actions.Speed, label: be.toString() });
        }),
    ...
    if (t.multiBitrateEnabled) {
      Panopto.Core.UI.Components.flyout({
        ...
        $("#qualityOptionHeader").after(
          _.template($("#qualityOptionTemplate").html())({
            qualityOptions: _.map(
              PanoptoTS.Viewer.EnumHelpers.getNames(
                PanoptoTS.Viewer.MBRBitrate
              ),
              function (e) {
                return { text: v[p.BitrateResourceString.format(e)], id: e };
              }
            ),
          })
        ),
        Panopto.Core.UI.Handlers.button(
          X.find(".quality-option"),
          function (e) {
            var n = h[e.id];
            Le(
              n,
              !0,
              t.requiresSilverlight ? p.BitrateCookie : p.MBRBitrateCookie
            ),
              X.hide(),
              B.focus(),
              f.sendEvent({
      ...
      var ze = PanoptoTS.Viewer.Logic.InitialStateLogic.getBitrate(
        t.requiresSilverlight
      );
      Le(ze, void 0, void 0);
    } else B.hide();
    $(document).keydown(function (t) {
      $(t.target).closest("#detailsTab, #editDetailsTab, .MuiDialog-root")
        .length || e.hotkey(t.keyCode);
    }),
      $(document).on("dblclick", _e, function (e) {
        var t = a.getPlayerFromElement($(e.currentTarget));
        t.isFullscreen &&
          t.setIsFullscreen &&
          Fe(t.isFullscreen() ? void 0 : t);
      }),
      ...
      je = function (t) {
        ...
        if (Panopto.viewer.allowMultipleSecondaryDisplay) {
          var o = _.chain(r)
            ...
            .value();
          o
            ? (o.getTabControl().updateAvailableTabs(e.position()),
              s.showTabsFor(o))
            : s.showTabsFor(void 0);
        } else
          r.length &&
            (r[0].getCurrentPlayer() === n
    ...
    return (
      $(document).on("mousemove", _e, function (e) {
      ...
      a.onPlayerSwap(function (e, t) {
        ...
        if (n) {
          var o =
            0 !== n.closest("." + p.SecondaryPlayerClass).length
              ? i.getPrimaryPlayer()
              : $(i.getSecondaryPlayers().get(e));
          je(o.find(Ve));
        }
      }),
      ...
      Panopto.Core.Browser.fullscreenEvent(function (e) {
        t.flowPlayerEnabled && Panopto.Core.Browser.fullscreenEnabled && !e
          ? Fe(void 0)
          : e || (s.hide(), $(".fullscreen-controls").fadeOut(p.FadeInterval));
      }),
      Z.on("keydown", function (e) {
        var t = Z.find("li"),
          n = t.first()[0],
          o = t.last()[0];
        e.keyCode === Panopto.Core.Key.Tab &&
          (e.shiftKey
            ? document.activeElement === n && (o.focus(), e.preventDefault())
            : document.activeElement === o && (n.focus(), e.preventDefault()));
      }),
      A.toggle(!t.isBroadcast),
      ke(),
      Be(),
      Panopto.viewer.allowMultipleSecondaryDisplay &&
        !l &&
        (new PanoptoTS.Viewer.Controls.SecondaryLayoutSelector(
          $("#selectedSecondaryLayout"),
          $("#secondaryLayoutExpander"),
          a,
          v
        ),
        $("#selectedSecondary").hide()),
      {
        synchronize: function (e, o, i, a, r) {
          o > 0 &&
            o != Ee &&
            ((Ee = o),
            E.slider("option", "max", Ee),
            E.find(".ui-slider-handle").attr("aria-valuemax", Ee)),
            Math.abs(e - Ee) < 0.1 && (e = Ee),
            ce || E.slider("value", e),
            T.text(i),
            A.text(a),
            t.isBroadcast &&
              (Y.toggleClass("live", n.isLive()),
        ...
        synchronizeCaption: function (n) {
          var o = !!t.hasCaptions,
            i = U.is(":visible");
          L.toggle(o || (n && t.isBroadcast)),
            O.toggle(o && Panopto.viewer.userCaptionControlsEnabled),
            U.toggle(o && Ie() && ve),
            i !== U.is(":visible") && e.resize(),
            a
              .getLeftPlayerElement()
              .find(".letterbox")
              .toggleClass(
                "no-border-radius",
                U.is(":visible") && e.viewMode() === u.Primary
              ),
            a
              .getRightPlayerElements()
              .toggleClass(
                "no-border-radius",
                U.is(":visible") && e.viewMode() === u.Secondary
              );
        },
        synchronizeBitrate: function () {
          var o,
            i,
            a = _.map(r, function (e) {
              return e.getCurrentPlayer();
            }),
          ...
          (Ce = o.hasMBR()),
            (i = Math.max(
              p.BitrateLevels.length + o.bitrateLevelOffset() - 1,
              0
            )),
            F.attr("class", "bar-" + i),
            De() &&
              B.attr(
                ...
                Ce
                  ? PanoptoTS.StringHelpers.format(
                      v.ViewerPlus_YourConnection,
                      p.BitrateLevels[i]
                    )
                  : v.ViewerPlus_OnlyOneBitrate
              ),
            n.optimizationProvider() && !we
              ? ((we = !0),
                n.optimizationProvider() === p.Kollective
                  ? (!t.isBroadcast ||
                      t.flowPlayerEnabled ||
                      Panopto.viewer.kollectiveVideoJSWebcastDVREnabled ||
                      (N.hide(), z.hide(), C.hide()),
                    $("#qualityOptionHeader").text(
                      v.ViewerPlus_OptimizedStream_Kollective
                    ))
                  : n.optimizationProvider() === p.Hive &&
                    $("#qualityOptionHeader").text(
                      v.ViewerPlus_OptimizedStream_Hive
                    ))
              : we &&
                !n.optimizationProvider() &&
                $("#qualityOptionHeader").text(v.ViewerPlus_Quality),
            B.toggleClass(Panopto.Core.Constants.DisabledClass, !xe());
        },
        setBitrate: Le,
          ...
          i = (function () {
            function t(e) {
              ...
              (this._onMaximize = new o()),
                ...
                (this.selectSecondaryFlyout = $(
                  ".select-secondary-flyout",
                  this.element
                ).hide()),
                Panopto.Core.UI.Handlers.button(
                  this.fullScreenButton,
                ...
                null != e &&
                  e.onAddContentRequirementChanged.add(function (e) {
                    t.allowShowOverlayButton = e.canAddContent;
                  });
            }
            return (
              Object.defineProperty(t.prototype, "onMaximize", {
                get: function () {
              ...
              (t.prototype.updateFullscreenButtons = function (e) {
                ...
                this.fullScreenButton.toggle(!n && t),
                  ...
                  this.showOverlayButton.toggle(
                    this.allowShowOverlayButton && !n
                  ),
                  this.isFullscreen !== n &&
                    ((this.isFullscreen = n),
              ...
              (t.prototype.show = function (t) {
                ...
                if (this.currentTarget && this.currentTarget[0] === t[0])
                  ...
                  (o = this.isFullscreen
                    ...
                    this.element
                      .finish()
                      .fadeIn(e.Constants.FadeInterval, function () {
                        n.resolve();
                      }),
              ...
              (t.prototype.showTabsFor = function (e) {
                e !== this.attachedSecondaryContentContainer &&
                  (this.attachedSecondaryContentContainer &&
                    this.attachedSecondaryContentContainer
                      .getTabControlElements()
                      .detachTabs(),
                  (this.attachedSecondaryContentContainer = e),
                  this.attachedSecondaryContentContainer
                    ? (this.attachedSecondaryContentContainer
                      ...
                      this.attachedSecondaryContentContainer
                        .getTabControl()
                        .attachTabHandlers(),
                      this.selectSecondaryContainer.show())
                    : this.selectSecondaryContainer.hide());
              }),
              (t.prototype.hide = function (t) {
                ...
                return (
                  ...
                  i
                    ? this.element
                        .finish()
                        .fadeOut(e.Constants.FadeInterval, function () {
                          n.element.detach(), a.resolve();
                        })
                    : (this.element.finish().hide().detach(), a.resolve()),
                  a.promise()
                );
              }),
  ...
  (Panopto.Viewer.ScormData = function (e, t) {
    ...
    if ((a.info(t), t && (n = t.split("t"))[0].length === e)) {
      for (o = 0; o < e; o++)
        (r[o] = n[0].charAt(o)), (s += "x" === r[o] ? 1 : 0);
      c = parseFloat(n[1]) || 0;
    }
    if (!r.length) for (o = 0; o < e; o++) r[o] = " ";
    return {
      ...
      shouldUpdateSegments: function (e) {
        return d() || l >= 10 || l * e >= i.ScormMaxUpdateDelay;
      },
      shouldUpdatePosition: function (e, t, n, o) {
        return (
          Math.abs(e - t) >
            Math.min(i.ScormOffsetMultiplier * n, i.ScormMaxUpdateDelay) ||
          e === o
        );
      },
  ...
  (Panopto.Viewer.ScormControl = function (e, t) {
    ...
    try {
      var d = (n = Panopto.Viewer.ScormData(
        a,
        SD.GetBookmark()
      )).lastPosition();
      d && (e.position(d || 0), (l = d));
        ...
        c((100 * d) / t),
        {
          updateProgress: function (e) {
            if (0 !== e || 0 === l) {
              ...
              if (
                (i && n.shouldUpdateSegments(r)) ||
                n.shouldUpdatePosition(e, l, r, t)
              )
                try {
                  SD.SetBookmark(n.serialize(e)),
                    SD.LMSSetValue(
                      o.ScormTimeKey,
                      Math.floor(1e3 * (n.segmentsWatched() * r - s))
                    ),
      ...
      !(function (t) {
        var n = Panopto.Viewer.Tabs,
          o = (function () {
            ...
            return (
              (t.prototype.getTabControlElements = function () {
              ...
              (t.prototype.updateTabs = function (t, o, i) {
                ...
                if (t.secondaryStreams.length && !this.streamPlayer) {
                  ...
                  this.streamPlayer = PanoptoLegacy.Viewer.Players.SecondaryStreamPlayer(
                    this.tabControlElements.getContent(),
                    r,
                    this.viewer
                  );
                }
                _.each(t.secondaryStreams, function (r) {
                  ...
                  s
                    ? s.setContent(r)
                    : l < t.broadcastRefreshInterval &&
                      setTimeout(function () {
                        var t = n.SecondaryTab(
                          a.tabControlElements,
                          a.streamPlayer,
                          r,
                          e.Viewer.Controls.MaterialDesignIconHelpers.getStreamIconCode(
                            r
                          )
                        );
                        a.tabs.push(t),
              ...
              (t.prototype.initializeTabs = function (t, o) {
                ...
                if (
                  ...
                  _.each(t.slideDecks, function (e) {
                    ...
                    i.tabs.push(
                      n.SecondaryTab(
                        i.tabControlElements,
                        t,
                        e,
                        Panopto.Core.Constants.SlideIconCode
                      )
                    );
                  }),
                  ...
                  _.each(t.secondaryStreams, function (t) {
                    ...
                    this.tabs.sort(function (e, t) {
                      ...
                      return (
                        0 === n &&
                          (n = e.absoluteStartTime() - t.absoluteStartTime()),
                        n
                      );
                    }),
                    _.each(s, function (e) {
                ...
                _.each(t.documents, function (e) {
                  ...
                  (this.tabControl = Panopto.Viewer.SecondaryTabControl(
                    this.tabControlElements,
                    o,
                    this.tabs,
                    this.index
                  ));
              ...
              (t.prototype.addDocumentPlayer = function (e, t) {
                var o = PanoptoLegacy.Viewer.Players.DocumentPlayer(
                  e,
                  t,
                  this.viewer
                );
                this.tabs.push(
                  n.SecondaryTab(this.tabControlElements, o, t, t.iconCode)
                );
              }),
              t
            );
    ...
    !(function (t) {
      !(function (n) {
        var o = (function () {
          ...
          return (
            (n.prototype.onSecondaryLayoutChanged = function (e) {
            ...
            (n.prototype.render = function () {
              ...
              var n = _.map(
                this.model.getAllowedSecondaryLayouts(),
                function (t) {
              ...
              _.each(n, function (t) {
                ...
                Panopto.Core.UI.Handlers.button(
                  this.expanderContainer.find(".player-tab-header"),
                  function (t) {
            ...
            (n.prototype.renderNewSelection = function (e) {
              this.selectedContainer.empty(),
                this.selectedContainer.append(
                  this.optionTemplate(this.getOptionTemplateModel(e))
                );
            }),
  ...
  (Panopto.Viewer.SecondaryTabControl = function (e, t, n, o) {
          ...
          if (
            (_.each(n, function (e) {
              e !== o
                ? e.setSelected(!1, i)
                : ((a = !e.selected()),
                  PanoptoCore.Logging.Logger.info(
                    "Secondary player started playing stream " + e.id()
                  ));
            }),
            o)
          ) {
            ...
            o.getPlayer().setStartPosition(r),
              ...
              o.content().isSecondaryPaneOnly
                ? t.interruptLayoutChanges(void 0)
                : t.restoreLayoutChanges(),
              t.resize();
          } else
            e.setSelectedText(
              Panopto.GlobalResources.ViewerPlus_SecondarySources
            ),
              e.setSelectedIcon("", "");
        }),
      r = function () {
    ...
    return {
      ...
      selectTabById: function (e, o) {
        ...
        !l ||
          !l.available(t.position()) ||
          (o && s.id() === i.SlideDeckId) ||
          a(l, !1);
      },
        ...
        if (o) {
          ...
          Panopto.Core.UI.Handlers.button(r, function (e) {
            ...
            if (o && o.enabled()) {
              ...
              (r || s) &&
                ("number" == typeof o.seekTime() && t.setPosition(o.seekTime()),
                a(o, !0),
                (i = !0));
            }
            i && l();
          ...
          n = (function () {
            function e(e, n, o, i) {
              ...
              (this.params = e),
                ...
                this.sessionUploadManagementService.setHost(
                  window.location.origin
                ),
                $(window).on("beforeunload", function () {
                  return a.multipartUploadManagerService.isRunning()
                    ? Panopto.GlobalResources.ViewerPlus_Edit_WaitForUpload
                    : void 0;
                });
            }
            return (
              Object.defineProperty(e.prototype, "onReady", {
                get: function () {
              ...
              (e.prototype.getCurrentUploads = function () {
                var e = this;
                this.sessionUploadManagementService.getUploads(
                  this.params.sessionId,
                  function (t) {
                    _.each(t.ProcessingUploads, function (t) {
                      if (
                        _.some(e.params.supportedStreamTypes, function (e) {
                        ...
                        if (!e.pendingUploads.hasOwnProperty(t.ID)) {
                          var n = {
                            ...
                            errorMessage: void 0,
                            startTime: e.params.showStartTime
                              ? Panopto.Util.dateFromJSON(t.StreamStartTime)
                              : null,
              ...
              (e.prototype.startUpload = function (e, t, n) {
                ...
                _.contains(this.params.supportedExtensions, r)
                  ? Panopto.features.uploadByteLimit &&
                    e.size > Panopto.features.uploadByteLimit
                    ? ((s.state = 4),
                      (s.uploadId = _.uniqueId("file")),
                      this._onUpdate.fire(s))
                    : (i = this.sessionUploadManagementService.openUpload(
                        {
                        ...
                        function (t) {
                          (s.state = 1),
                            ...
                            o.multipartUploadManagerService.queueUpload(
                              {
                                file: e,
                                fileId: s.uploadId,
                              ...
                              function () {
                                return (function (e) {
                                  a = o.sessionUploadManagementService.closeUpload(
                                    e,
                                    function () {
                            ...
                            o.multipartUploadManagerService.upload();
                        },
                        c
                      ))
                  : ((s.state = 3),
              ...
              (e.prototype.cancelUpload = function (e) {
                ...
                e.request.cancel(),
                  ...
                  e.uploadId
                    ? this.sessionUploadManagementService.deleteUpload(
                        e.uploadId,
                        function () {
                          t._onDelete.fire(e);
                        },
              ...
              (e.prototype.startProcessing = function (e) {
                ...
                var n = setInterval(function () {
                  t.sessionUploadManagementService.getUpload(
                    e.uploadId,
                    function (o) {
                      o.State === Panopto.Core.UploadStatus.Complete
                        ? (clearInterval(n),
                          (e.isComplete = !0),
                          t._onUpdate.fire(e),
                          t._onComplete.fire(e))
                        : o.State ===
                            Panopto.Core.UploadStatus.ProcessingError &&
                          (clearInterval(n),
                ...
                var t = this,
                  ...
                  o = Panopto.Core.ServiceInterface.Objects.ServiceTaskQuery({
                    filters: {
                      ...
                      serviceTaskTypeIDs: [
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskTypes
                          .UnisonPackaging,
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskKinds
                          .UnisonEncode,
                      ],
                      mostRecentServiceTaskTypeIDs: [
                        ...
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskKinds
                          .ViewerEncode,
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskKinds
                          .FastPathViewerEncode,
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskKinds
                          .PodcastEncode,
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskTypes
                          .LegacyRecorderUpload,
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskKinds
                          .TransferUpload,
                        Panopto.Core.ServiceInterface.Objects.ServiceTaskKinds
                          .CompleteUpload,
                      ...
                      taskStates: [
                        Panopto.Core.ServiceInterface.Objects.TaskState
                          .PermanentFailure,
                      ],
                    },
                  });
                return (
                  Panopto.Util.callWebMethod({
                    ...
                    onSuccess: function (o) {
                      var i,
                        a = _.map(o.ServiceTaskStatuses.Results, function (e) {
                          return Panopto.Core.ServiceInterface.Objects.ServiceTaskStatus(
                            e
                          );
                        });
                      _.each(a, function (n) {
                        n.sourceFilename === e.filename &&
                          (i = t.createMessage(n));
                      }),
                        n.resolve(i);
                    },
              ...
              (e.prototype.createMessage = function (e) {
                var t = _.invert(
                  ...
                  o = (
                    Panopto.GlobalResources[n] ||
                    Panopto.GlobalResources.SessionList_MissingStatusString
                  ).format(void 0, e.sourceFilename);
                if (e.subState) {
                  var i =
                      "SubStatus_" +
                      Panopto.Core.ServiceInterface.Objects.ServiceTaskResourceMapping(
                        e
                      ),
                    a =
                      Panopto.GlobalResources[i] ||
                      Panopto.GlobalResources.SubStatus_MissingStatusString;
...
!(function (e) {
  !(function (e) {
    !(function (t) {
        ...
        i = (function (e) {
          function t(t, i, a, l) {
            ...
            return (
              ((c =
                e.call(this, t, i, d, u) ||
                this).mockSessionUploadManagement = d),
              document.addEventListener(n, function (e) {
                if (e instanceof CustomEvent) {
                  var t = e.detail.streamType,
                    n = new Date();
                  c.startUpload({ name: "FakeFile.wmv", size: 1e7 }, t, n);
                }
              }),
              c
            );
      ...
      var a = (function () {
        ...
        return (
          (e.prototype.getAllStreams = function (e, t, n) {
            var i = this;
            o.verbose(
              "MockSessions.getAllStreams (" + this.streams.length + ")"
            ),
              this.streams.length > 0
                ? setTimeout(function () {
                    t(i.streams);
                  }, 0)
                : this.sessionsService.getAllStreams(e, t, n);
          }),
          ...
          return (
            ...
            (e.prototype.getUploads = function (e, t, n) {
              ...
              this.pendingUploads.length > 0
                ...
                : this.sessionUploadManagementService.getUploads(e, t, n);
            }),
              ...
              return (
                ...
                setTimeout(function () {
                  (i.State = Panopto.Core.UploadStatus.Complete),
                    o.sessionsService.addMockStream &&
                      o.sessionsService.addMockStream(i);
                }, 2e3),
  ...
  (Panopto.Viewer.Controls.ThumbnailStrip = function (e, t, n, o, i) {
    var a,
      ...
      c = Panopto.Core.UI.Components.scrollingHighlight(
        e,
        !1,
        s.ThumbnailScrollTimeout
      ),
      d = function (r) {
        var d,
          u = a,
          p = [],
          f = 0,
          h = Panopto.cacheRoot + "/Images/no_thumbnail.svg",
          m = function () {
            f++, r && f === p.length && r();
          };
        (a = _.map(t, function (t) {
          ...
          return (
            (t.id = t.id || _.uniqueId()),
            {
              time: n,
              timestamp: Panopto.Core.TimeHelpers.formatDuration(
                n,
                Panopto.GlobalResources.TimeSeparator
              ),
              ...
              thumbnailId: t.id,
              src: t.queryParams
                ? Panopto.Core.StringHelpers.addQueryParameter(
                    s.ThumbUrl,
                    t.queryParams
                  )
                : t.thumbnailUrl || h,
              tabId:
                t.tabId ||
                (t.type === Panopto.Core.EventTargetType.PowerPoint
          ...
          _.each(a, function (e) {
            ...
            t ? t.time !== e.time && (p.push(e), d.push(t)) : p.push(e);
          }),
          _.each(d, function (e) {
            $("#" + e.id).remove();
          });
        ...
        _.each(p, function (e) {
          ...
          _.each(d, function (e) {
            ...
            d
              ...
              .on("error", function (e) {
                $(e.currentTarget).attr("src") !== h
                  ? $(e.currentTarget).attr("src", h)
                  : (t.width(t.height()), t.show(), m());
              }),
            Panopto.Core.UI.Handlers.button(t, function (t) {
              n.userSeekEnabled() &&
                c.highlight(e, function (e) {
                  n.setPosition(e.time),
                    e.tabId && n.selectSecondaryTab(e.tabId, e.isSlide),
                    l.sendEvent({
            ...
            o &&
              (i
                ? a.show()
                : Panopto.Core.UI.Handlers.hoverableParent(t, a, function (e) {
                    a.toggle(e);
                  }),
              Panopto.Core.UI.Handlers.button(r, function () {
        ...
        var t = (function () {
          ...
          return (
            (e.prototype.render = function () {
              var e = Panopto.Core.TextHelpers.displayLineBreaks(
                  _.escape(this.delivery.description)
                ),
                t = {
          ...
          o = (function () {
            function t() {
              ...
              (this._onClick = new n()),
                ...
                (this.playerLayoutControlsElement = this.element.find(
                  ".player-layout-controls"
                )),
                (this.showOverlayElement = this.element.find(
                  ".show-overlay-button"
                )),
            ...
            return (
              ...
              (t.prototype.setAutoHideTimeout = function () {
                ...
                clearTimeout(this.autoHideTimeout),
                  (this.autoHideTimeout = window.setTimeout(function () {
                    t.playerLayoutControlsElement.is(":hover") ||
                      t.playerLayoutControlsElement.hide();
                  }, 1e3 * e.Constants.FullScreenControlInterval));
              }),
              (t.template =
  ...
  (PanoptoLegacy.Viewer.Players.DocumentPlayer = function (e, t, n) {
    ...
    return (
      e.append(_.template($("#documentPlayerTemplate").html())(t)),
      (o = e.find("#" + t.id)),
      (i = o.find(".document-frame")),
      t.isPdf
        ? window.PluginDetect.onDetectionDone(
            PanoptoTS.Viewer.Constants.PluginDetectPDFReader,
            function (e) {
              e.isMinVersion(
                PanoptoTS.Viewer.Constants.PluginDetectPDFReader,
                0
              ) < 0
                ? o.find(".adobe-reader-install").show()
                : (r(), i.attr("src", t.url));
            },
            PanoptoTS.Viewer.Constants.DummyPDFUrl,
            !0
          )
        : r(),
      ...
      (a.toggle = function (e) {
        ...
        o.toggle(e),
          i.attr("src") !== a &&
            ...
            e &&
              -1 !==
                t.url.indexOf(PanoptoViewer.Constants.YouTubeEmbedBaseUrl) &&
              PanoptoViewer.ensureYouTubeIframeApiIsReady(function () {
    ...
    return {
      ...
      resize: function (o, i, a, r) {
        ...
        var s = o / i,
          l = o,
          c = i;
        t.add(e).css({ left: "", position: "" }),
          isNaN(a)
            ? ((l = o = Math.max(o, n.AudioOnlyMinimumWidth)),
              r &&
                (0 === i
                  ? e.css({ left: -l + "px", position: "absolute" })
                  : t.css({ left: -l / 2 + "px" })),
              (c = i = Math.max(i, n.AudioOnlyMinimumWidth)))
            : s <= a
            ? ((l = Math.max(o, n.AudioOnlyMinimumWidth)),
              (c = Math.max(o / a, n.AudioOnlyMinimumWidth)))
            : ((c = Math.max(i, n.AudioOnlyMinimumWidth)),
              (l = Math.max(i * a, n.AudioOnlyMinimumWidth))),
          t.width(l),
          t.height(c),
          t.css({ "margin-top": -c / 2 + "px", "margin-left": -l / 2 + "px" }),
          e.width(o),
          e.height(i);
      },
      content: function (e) {},
  ...
  ((Panopto = Panopto || {}).Viewer = Panopto.Viewer || {}),
  (Panopto.Viewer.Players = Panopto.Viewer.Players || {}),
  (PanoptoLegacy.Viewer.Players.PrimaryPlayer = function (e, t, n, o, i, a) {
    var r,
      s,
      l,
      c,
      ...
      b = 0,
      T = function (e, t, n) {
        var r = Panopto.Core.StringHelpers.parseQueryString(
          e.url.slice(e.url.indexOf("?") + 1)
        );
        if (((s = e), !h)) {
          if (Panopto.features.quotasEnabled) {
            var l = Panopto.Core.StringHelpers.parseQueryString(
                window.location.search.slice(1)
              ).tid,
              c = i.user.email || "null";
            (m = new PanoptoTS.Controls.QuotaPlaybackTracker(
              PanoptoCore.CookieHelpers,
              $("body"),
              Panopto.GlobalResources,
              i.id,
              i.ownerId,
              ...
              l
                ? Panopto.Core.StringHelpers.format(
                    Panopto.freeTrialSignUpUrl +
                      Panopto.Core.Constants.SignUpUrlParams,
                    l,
                    c
                  )
                : Panopto.freeTrialSignUpUrl
            )).onToggle.add(function (e) {
              o.setPlayState(
                e
                  ? Panopto.Viewer.PlayState.Paused
                  : Panopto.Viewer.PlayState.Playing,
                void 0,
                void 0
              );
            });
          ...
          if (
            ...
            Panopto.SignupBanner($("#proLoginBanner"), {
              imageLocation:
                Panopto.cacheRoot + "/Styles/Less/Application/Images/Header",
              signupUrl: Panopto.freeTrialSignUpUrl,
              isEmbed: !1,
              tokenId: l,
              userEmail: c,
          ...
          (h = Panopto.Core.Analytics.PlaybackLogger(
            y,
            r.InvocationID,
            Panopto.Core.ServiceInterface.AnalyticsIngest.addStreamRequests,
            {
        ...
        e.isAudioOnly
          ? a.toggle({ showOrHide: !0, allowShowOverlayButton: !1 })
          : a.toggle({ showOrHide: !1, allowShowOverlayButton: !1 }),
          g.content(s, t, function () {
            s.isBroadcast && u && u(),
              n && n(),
              m && m.initialize(i.ownerIsOverQuota);
          });
      },
      A = function (e) {
    ...
    return (
      (P.setPrimaryContent = function (e, t, n, o) {
        b > 0 &&
          _.chain(e)
            .filter(function (e) {
            ...
            .forEach(function (e) {
              e.id in w &&
                (0 !== e.relativeEnd
                  ? (delete w[e.id], b--)
                  : ((e.relativeEnd = w[e.id]),
                    v.info(
                      "Primary player with stream id " +
                        e.id +
                        " had its relative end patched to " +
                        e.relativeEnd
                    )));
            }),
          (r = e),
          ...
          b > 0 && (t = A(y.position())),
          !s && t.isBroadcast && g.position(1 / 0),
          (s && !n) || T(s || t, n, o);
      }),
      (P.content = P.setPrimaryContent),
        ...
        if (void 0 === e)
          return (
            ...
            o &&
              ...
              i.id !== s.id &&
              (T(i, !1, null),
              g.position(o - i.relativeStart),
              P.setPlayStateWithLogging(Panopto.Viewer.PlayState.Playing, !0)),
            n + s.relativeStart
          );
        (i = A(e)).id !== s.id && T(i, !1, null),
          s.isBroadcast &&
          !C &&
          e &&
          e !== d &&
          e !== 1 / 0 &&
          e >= S - PanoptoTS.Viewer.Constants.LivePositionTolerance
            ? P.setIsLive(!0, t)
            : ((e -= s.relativeStart),
              g.position(e, function () {
                a(), t && t();
              }),
              a());
      }),
      (P.position = P.setPosition),
      (P.setIsLive = function (e, t) {
        if (void 0 === e) return C;
        e && !C
          ? (c && window.clearInterval(c),
            y.setPosition(d || 1 / 0, t),
            y.playState(Panopto.Viewer.PlayState.Playing),
            (C = !0))
          : !e &&
            C &&
            ((S = d || y.position()),
            (c = window.setInterval(function () {
              d && S >= d
                ...
                : (S += PanoptoTS.Viewer.Constants.TimedSyncRate / 1e3);
            }, PanoptoTS.Viewer.Constants.TimedSyncRate)),
            (C = !1));
      }),
      (P.isLive = P.setIsLive),
      (P.updateMaxPosition = function (e) {
        e || C || ((C = !0), P.setIsLive(!1)), (d = e) && S > d && (S = d);
      }),
      (y.streamLength = function () {
        return s.isBroadcast ? (C ? y.position() : S) : g.streamLength();
      }),
      (y.ended = function () {
        var e = A(s.relativeEnd),
          t = g.ended(),
          n = null;
        return (
          t &&
            s.isBroadcast &&
            0 === s.relativeEnd &&
            ((w[s.id] = g.streamLength() + s.relativeStart),
            b++,
            (s.relativeEnd = w[s.id]),
            (n = w[s.id]),
            (e = A(s.relativeEnd)),
            v.info(
              "Ended: Primary player with stream id " +
                s.id +
                " had its relative end patched to " +
                w[s.id]
            )),
          t && e.id !== s.id
            ? ((t = !1),
              y.setPosition(n || s.relativeEnd),
              y.playState(Panopto.Viewer.PlayState.Playing))
            : d && y.position() >= d && (t = !0),
          t && s.isBroadcast && (C = !0),
          t && f && f(void 0, Panopto.Viewer.PlayState.Stopped),
          t && m && m.fadeInModalForAnonymous(),
          t
        );
      }),
      (P.isEndedBy = y.ended),
      (P.activePrimary = function () {
        return s;
      }),
      (P.onSeek = function (e) {
        u = e;
      ...
      (P.playState = function (e, t) {
        g.playState(e), t && e !== l && f && f(l, e), (l = e);
      }),
      (P.setPlayStateWithLogging = y.playState),
      (P.streamId = function () {
        return s.id;
      }),
      P
  ...
  ((Panopto = Panopto || {}).Viewer = Panopto.Viewer || {}),
  (Panopto.Viewer.Players = Panopto.Viewer.Players || {}),
  (PanoptoLegacy.Viewer.Players.PrimarySegmentPlayer = function (
    e,
    t,
    n,
    o,
    ...
    var r,
      ...
      p,
      f = PanoptoCore.Logging.Logger,
      h = PanoptoLegacy.Viewer.Players.StreamPlayer(e, t, n, !0, o),
      m = h,
      v = Panopto.Core.Extensions.base(h),
      y = !1,
      P = $("#primaryTabHeaders"),
      g = [],
      S = function (e) {
        ...
        return (
          p &&
            (t = _.find(e.element.streams(), function (e) {
              return e.stream.id === p;
            })),
          (t =
            t ||
            _.find(e.element.streams(), function (e) {
      ...
      C = function (e, t) {
        ...
        if ((t && n && n.start < c.start && (n = c), n && n !== c)) {
          var o = S(n);
          if (o) {
            var i =
              o.stream.url !== d.stream.url ||
              o.stream.vrType !== d.stream.vrType ||
              o.offset !== d.offset;
            (d = o),
              (c = n),
              _.each(g, function (t) {
              ...
              i &&
                (w(
                  _.find(g, function (e) {
                    return e.id() === d.stream.id;
                  })
                ),
                m.setPrimaryContent(void 0, d.stream, void 0, void 0),
                f.verbose(
                  "[PrimarySegmentPlayer] Choosing segment " +
                    d.stream.id +
                    ", seeking to " +
                    e
                ),
    ...
    return (
      (m.setPrimaryContent = function (e, t, n, o) {
        t.isAudioOnly
          ? a.toggle({ showOrHide: !0, allowShowOverlayButton: !0 })
          : a.toggle({ showOrHide: !1, allowShowOverlayButton: !0 }),
          v.content(t);
      }),
            ...
            : (_.each(f, function (e) {
                if (i.getStream(e)) {
                  var t,
                    ...
                    o = !1;
                  _.each(s, function (i) {
                    (t = i.element.getStreamById(e))
                      ? o || (n.push(i.start), (o = !0))
                      : o && (n.push(i.start), (o = !1));
                  }),
                    P.append(
                      _.template($("#playerTabHeaderTemplate").html())({
                        content: {
                          id: e,
                    ...
                    g.push(
                      Panopto.Viewer.Tabs.PlayerTabHeader(
                        P.find("#primary" + e),
                        e,
                        n,
                        !0,
                        t && t.stream
                          ? PanoptoTS.Viewer.Controls.MaterialDesignIconHelpers.getStreamIconCode(
                              t.stream
                            )
                          : Panopto.Core.Constants.ObjectVideoIconCode
                      )
                    );
                }
              }),
              Panopto.Core.UI.Handlers.button(
                P.find("." + PanoptoTS.Viewer.Constants.PrimaryTabHeaderClass),
                function (e) {
        ...
        if (c) {
          if (void 0 !== e) {
            ...
            var t =
              e -
              c.start +
              d.offset / Panopto.Core.Constants.TimelineChunkMultiplier;
            v.position(t);
          } else
            (e =
              v.position() +
  ...
  (PanoptoLegacy.Viewer.Players.SecondaryStreamPlayer = function (e, t, n) {
      ...
      p = function (e) {
        ...
        return (
          r.segments && r.segments.length
            ? ((t =
                (t = _.find(r.segments, function (t) {
                  return e >= t.timelineStart && e < t.relativeEnd;
                })) ||
                (e < r.segments[0].timelineStart
                  ? r.segments[0]
    ...
    return (
      (o.content = function (e, t, n) {
        if (void 0 === e) return r;
        r = e;
        var o = void 0 !== l;
        if (o) {
          var a = p(l);
          i.setStartPosition(a.offset + c.SecondaryStreamOffset);
        }
      ...
      (o.position = function (e, t, n, a) {
        ...
        if (d.segment) {
          if (!t && d.segment !== s) {
            var f = u(e, s);
            n = l = d.offset - f > c.ContiguousSegmentThreshold;
          }
          s = d.segment;
        }
        if (!l) return o.ended(d.offset) ? 0 : d.offset - i.position();
        var h = d.offset + (n ? c.SecondaryStreamOffset : 0),
          m = i.position();
        n || m !== d.offset + c.SecondaryStreamOffset || (h = m),
          i.setPosition(
            r.length ? Math.clamp(h, 0, r.length) : Math.max(0, h),
            a
          );
      }),
      ...
      (o.toggle = function (e) {
        (d = e), a.toggleClass("hidden-screen", !e);
      }),
      (o.minimizeIfHidden = function () {
        d || i.setIsFullscreen(!1);
      }),
      (o.ended = function (e) {
        var t = i.streamLength();
        return (
          i.ended() ||
          (!(!t || r.isBroadcast) && e >= t - c.EndPositionThreshold)
        );
      }),
      o
    );
  ...
  (PanoptoLegacy.Viewer.Players.SlidePlayer = function (e, t, n) {
    var o,
      ...
      c = 1;
    return (
      e.append(_.template($("#slidePlayerTemplate").html())({ id: t.id })),
      (o = e.find("#" + t.id + "-image")),
      ...
      (r.position = function (e, r) {
        !(function (e) {
          ...
          (s = s || t.slides[0]) &&
            ...
            Panopto.Core.ImageHelpers.bufferAndReplaceImageUrl(
              o,
              i,
              r,
              function (e) {
                c = e.width / e.height || 0;
              }
            ),
  ...
  (PanoptoLegacy.Viewer.Players.StreamPlayer = function (e, t, n, o, i) {
    var a,
      ...
      s,
      l,
      c = PanoptoCore.Logging.Logger,
      d = PanoptoTS.Viewer.Constants,
      u = Panopto.Viewer.PlayState,
      p = Panopto.Viewer.Players.PlayerBase(e, t),
      f = Panopto.Core.Extensions.base(p),
      h = n.create(o, t),
    ...
    return (
      (l = h.onReady ? h.onReady : $.Deferred().resolve()),
      (p.resize = function (n, o) {
        ...
        var a =
          Panopto.Core.Browser.isIE11 ||
          Panopto.Core.Browser.isSafari ||
          (h.canMoveAudioPlayerOffscreen && h.canMoveAudioPlayerOffscreen());
        f.resize(n, o, i, a), h.showShadow(e.height() === t.height());
      }),
      ...
      (p.playState = function (e) {
        h.playState(e),
          s !== e &&
            ((P = h.position()),
            c.info(y + " player changed play state to " + e)),
          (s = e);
      }),
      (p.position = function (e, t) {
        if (void 0 === e)
          return (
            (e = Math.max(h.position() || 0, 0)),
            a && e === a && e !== P && s === u.Playing
              ? (e +=
                  Math.min(
                    g * (new Date().getTime() - r),
                    d.MaxPositionInterpolation
                  ) / 1e3)
              : ((a = e), (r = new Date().getTime())),
            e
          );
        h.position(e, t), (P = e), c.info(y + " player set position to " + e);
      }),
      ...
      (p.playSpeed = function (e) {
        ...
        h.playSpeed(e),
          g !== e && c.info(y + " player changed playback speed to " + e),
          (g = e);
      }),
      ...
      (p.volume = function (e) {
        ...
        0 !== e ? (h.volume(e), (m = e), p.muted(!1)) : p.muted(!0);
      }),
  ...
  (Panopto.Viewer.Players.ThumbnailPlayer = function (e, t, n) {
    ...
    return (
      Panopto.Core.UI.Handlers.button(r, function () {
        var e;
        (e = void 0 === (e = void 0) ? !a.is(":visible") : e)
          ? (s.text("keyboard_arrow_down"),
            a.slideDown({
              step: function () {
                t.resize && t.resize();
              },
              complete: function () {
                (c = !1), i.position(t.position(), !0);
              },
            }),
            r.attr(
              Panopto.Core.Constants.AriaExpandedAttribute,
              (!0).toString()
            ),
            o.sendEvent({
          ...
          n
            ? _.filter(e, function (e) {
                return !(
                  ...
                  e.link ||
                  (e.type !== Panopto.Core.EventType.Label &&
                    e.type !== Panopto.Core.EventType.SmartOcrToc &&
                    e.type !== Panopto.Core.EventType.SlideChange)
                );
              })
            : e
        );
      ...
      !(function (e) {
        var t = Panopto.Viewer.PlayState,
          ...
          o = (function () {
            ...
            return (
              (o.prototype.synchronize = function (e, n, o, i) {
                this.logSynchronize(o), o && this.clearSyncTimeout();
                var a,
                  r = !1;
                return (
                  this.prepareForSync(e),
                  i ||
                    (a = this.getBlockingPosition(e, n, o, this.secondaryTabs)),
                  _.isNumber(a) && a !== e
                    ? (this.viewer.setPlayState(t.Paused, !1, !1),
                      this.viewer.setPosition(a))
                    : (r = this.doRemediation(e, n, o, i)),
                  (this.wasPrimaryFullscreen = this.primaryPlayer.isFullscreen()),
                  (this.wasBackgrounded =
              ...
              (o.prototype.logSynchronize = function (e) {
                ...
                t &&
                  (e && n.info("User-initiated sync of primary " + t.id),
                  this.previousPrimaryId !== t.id &&
                    ((this.previousPrimaryId = t.id),
                    n.info("Primary player started playing stream " + t.id)),
                  this.wasPrimaryFullscreen !==
                    this.primaryPlayer.isFullscreen() &&
                    n.info(
                      "Primary player changed fullscreen to " +
                        this.primaryPlayer.isFullscreen()
                    ));
              }),
              o
    ...
    !(function (e) {
      !(function (e) {
        var t = (function () {
          function e() {}
          return (
            (e.getBlockingContent = function (e, t) {
              ...
              (this.config = n),
                (this.FlowplayerMachineFactory = {
                  create: function (n, i) {
                    var a;
                    return (
                      Panopto.viewer.isHiveEnabled && !o.config.isEditor
                        ? (t.log("HiveFlowplayerMachine"),
                          (a = new e.Viewer.Players.HiveFlowplayerMachine(
                            n,
                            i,
                            o.config.playerHelpers
                          )))
                        : Panopto.viewer.pureHlsJsPlayback ||
                          Panopto.viewer.isKollectiveEnabled ||
                          Panopto.viewer.flowplayerSSP
                        ? (Panopto.viewer.isKollectiveEnabled &&
                            !o.config.isEditor &&
                            PanoptoViewer.PrimitivePlayerFactory.enableKollective(),
                          Panopto.viewer.flowplayerSSP &&
                            PanoptoViewer.PrimitivePlayerFactory.useFlowplayer(),
                          t.log("SingleStreamMediaPlayer"),
                          (a = new e.Viewer.Players.SingleStreamMediaPlayer(
                            n,
                            i,
                            o.config.playerHelpers
                          )))
                        : (t.log("FlowplayerMachine"),
                          (a = new e.Viewer.Players.FlowplayerMachine(
                            n,
                            i,
                            o.config.playerHelpers
                          ))),
                ...
                (this.VideoJsFactory = {
                  create: function (e, n) {
                    return (
                      t.log("VideoJsPlayer"),
                      PanoptoLegacy.Viewer.Players.VideoJsPlayer(
                        e,
                        n,
                        o.config.playerHelpers
                      )
    ...
    !(function (t) {
      !(function (t) {
        var n = (function () {
          ...
          return (
            (t.prototype.createTabs = function (t, n, o) {
              var i,
                a,
                r,
                s,
                l = e.Viewer.Tabs.ViewerEventTabHelpers.create(
                  this.viewer,
                  t,
                  n,
                  o
                ...
                c = [];
              (i = PanoptoLegacy.Viewer.Tabs.Editor.EditDetailsTab(
                $("#editDetailsTabHeader"),
                $("#editDetailsTabPane"),
                this.viewer,
                l,
                this.editor,
                this.editor.timeConverter,
                this.delivery.id,
                this.delivery.title,
                this.delivery.description,
                this.delivery.tags,
                this.delivery.ownerId,
                this.delivery.ownerFullName,
                this.delivery.ownerBio,
                ...
                c.push(i),
                c.push(
                  PanoptoLegacy.Viewer.Tabs.Editor.EditContentsTab(
                    $("#editContentsTabHeader"),
                    $("#editContentsTabPane"),
                    l,
                    this.editor,
                    this.delivery.user.canCreateQuestionLists,
                    this.editor.eventService,
                    this.editor.timeConverter,
                    this.deliveryService
                  )
                ),
                c.push(
                  PanoptoLegacy.Viewer.Tabs.Editor.EditTranscriptTab(
                    $("#editTranscriptTabHeader"),
                    $("#editTranscriptTabPane"),
                    l,
                    this.editor,
                    this.editor.timeConverter,
                    this.delivery.availableLanguages,
                    this.deliveryService
                  )
                ),
                window.slidesTab
                  ? (window.slidesTab.setTimelineEditor(this.editor),
                    window.slidesTab.setReadyStreamUploader())
                  : (window.slidesTab = PanoptoLegacy.Viewer.Tabs.Editor.EditSlidesTab(
                      $("#editSlidesTabHeader"),
                      $("#editSlidesTabPane"),
                      l,
                      this.editor,
                ...
                c.push(window.slidesTab),
                (r = PanoptoLegacy.Viewer.Tabs.Editor.EditCutTab(
                  $("#editCutTabHeader"),
                  $("#editCutTabPane"),
                  l,
                  this.editor,
                ...
                window.streamTab
                  ? (window.streamTab.setTimelineEditor(this.editor),
                    window.streamTab.setReadyStreamUploader())
                  : ((window.streamTab = PanoptoLegacy.Viewer.Tabs.Editor.EditStreamTab(
                      $("#editStreamTabHeader"),
                      $("#editStreamTabPane"),
                      l,
                      this.editor,
                      this.clientParams,
                      window.streamUploader,
              ...
              return (
                ...
                d.push(a),
                this.delivery.user.canCreateQuestionLists &&
                  ((s = PanoptoLegacy.Viewer.Tabs.Editor.EditQuestionListTab(
                    $("#editQuestionListTabHeader"),
                    $("#editQuestionListTabPane"),
                    l,
                    this.editor,
                    this.editor.timeConverter,
                    this.editor.eventService,
        ...
        var n = (function () {
          ...
          return (
            (t.prototype.getDuration = function () {
              var e =
                ((this.lastLevelLoadTime
                  ? new Date().getTime() - this.lastLevelLoadTime
                  : 0) +
                  this.lastLevelAgeMillis) /
                1e3;
            ...
            (t.prototype.attach = function (e, t) {
              ...
              if (
                (e.engine.hls &&
                  e.engine.hls.on("hlsLevelLoaded", function (e, t) {
            ...
            (t.prototype.attachXhrSetup = function (t) {
              ...
              t.xhrSetup = function (t, i) {
                if (
                  _.any(e.Viewer.Constants.HlsLevelFileNames, function (e) {
            ...
            (t.prototype.updateLevelAge = function (t) {
              var n = t.getResponseHeader(e.Viewer.Constants.HttpHeaders.Date),
                o = t.getResponseHeader(
                  e.Viewer.Constants.HttpHeaders.LastModified
                );
              if (n && o) {
                var i = Date.parse(n),
                  a = Date.parse(o);
    ...
    !(function (t) {
      !(function (t) {
        var n = (function () {
          function t() {}
          return (
            (t.getBitrate = function (t) {
              var n = PanoptoCore.CookieHelpers.getUserCookieField(
                Panopto.user.userKey,
                t
                  ? e.Viewer.Constants.BitrateCookie
                  : e.Viewer.Constants.MBRBitrateCookie
              );
              return null !== n
                ? parseInt(n, 10)
                : t
                ? Panopto.viewer.defaultSSFBitrate
    ...
    !(function (t) {
      !(function (t) {
        var n = (function () {
          ...
          return (
            (t.prototype.createTabs = function (t, n, o) {
              var i = e.Viewer.Tabs.ViewerEventTabHelpers.create(
                  this.viewer,
                  t,
                  n,
                  o
              ...
              return (
                a.push(
                  PanoptoLegacy.Viewer.Tabs.NotesTab(
                    $("#notesTabHeader"),
                    $("#notesTabPane"),
                    i,
                    this.delivery.id,
                    ...
                    this.delivery.allowPublicNotes,
                    !0,
        ...
        var n = Panopto.Viewer.PlayState,
          o =
            ...
            (function () {
              ...
              return (
                (t.prototype.synchronizePlayPositions = function (t, n) {
                  if (void 0 === this.synchronizingSecondaryTabControls) {
                    var o = this.getPositionDifferences(t, n),
                      i =
                        e.Constants.SecondarySyncThreshold *
                        this.playControls.playSpeed();
                ...
                (t.prototype.stopSynchronization = function () {
                  ...
                  return (
                    this.synchronizingInterval &&
                      (clearInterval(this.synchronizingInterval),
                ...
                (t.prototype.getPositionDifferences = function (e, t) {
                  ...
                  return {
                    list: _.map(t, function (t) {
                      var i = t.selectedTab()
                        ? t.selectedTab().setPosition(e, !1, void 0, $.noop)
                        : 0;
                ...
                (t.prototype.beginSynchronization = function (t, n) {
                  ...
                  this.viewer.logDesync(
                    ...
                    (this.synchronizingInterval = setInterval(function () {
                      o.synchronizingSecondaryTabControls
                        ? o.runSynchronization(
                            o.synchronizingSecondaryTabControls,
                            o.getPositionDifferences(
                              o.viewer.position(),
                              o.synchronizingSecondaryTabControls
                            )
                          )
                ...
                (t.prototype.runSynchronization = function (t, o) {
                  var i,
                    a =
                      o.range >
                      PanoptoViewer.Constants.SecondarySyncTargetSeconds
                        ? e.Constants.SecondarySynchronizingUpdateRateMillis /
                          1e3
                        : PanoptoViewer.Constants.SecondarySyncTargetSeconds;
                  _.each(t, function (e, t) {
                    e.selectedTab() &&
                      ((i = o.max - o.list[t] > a ? n.Paused : n.Playing),
      ...
      var n = e.Viewer.Constants,
        ...
        r = (function (e) {
          function r(n, o, i, a) {
            ...
            return (
              (r.defaultTabMap = {}),
              (r.positionSynchronization = new t.MultipleSecondaryPositionSynchronization(
                n,
                o,
                i
              )),
          ...
          return (
            ...
            (r.prototype.prepareForSync = function (e) {
              (this.secondaryTabControls = _.map(
                this.secondaryContentContainers,
                function (e) {
            ...
            (r.prototype.doRemediation = function (e, t, n, o) {
              return (
                this.checkAllSecondaryTabs(
                  e,
                  n,
                  o,
                  this.availableTabs,
                  this.secondaryTabs,
                  this.secondaryTabControls
                ),
                !0
              );
            }),
            ...
            (r.prototype.synchronizeSecondaryTabs = function (e, t, n) {
              ...
              (this.wasBackgrounded && "hidden" !== document.visibilityState)
                ? (this.primaryPlayer.setPlayStateWithLogging(
                    this.viewer.playState(),
                    t
                  ),
                  _.each(n, function (t) {
                    t.selectedTab() &&
                      t.selectedTab().setPosition(e, !0, void 0, function () {
                        t.selectedTab() &&
                          t.selectedTab().playState(i.viewer.playState());
                      });
                  }))
                : this.primaryPlayer.isFullscreen() ||
                  "hidden" === document.visibilityState
                ...
                : this.viewer.playState() === o.Playing &&
                  this.positionSynchronization.synchronizePlayPositions(e, n);
            }),
            ...
            (r.prototype.checkAllSecondaryTabs = function (e, t, n, o, a, r) {
              var s = this,
                ...
                c = this.getUnusedAvailableTabs(o, r),
                d = !1,
                u = c.pop();
              _.each(l, function (i) {
                ...
                if (u) {
                  ...
                  if (!r || (f && l > i.selectedPriority)) {
                    ...
                    s.setSecondaryTab(a, e, h),
                      ...
                      (u = c.pop()),
                      (d = !0);
                  } else f || (s.defaultTabMap[p] = void 0);
                } else r || (s.clearSecondaryTab(a, e, t, n) && (d = !0));
              });
              var p = 0 !== o.length,
                f = p,
            ...
            (r.prototype.setSecondaryTab = function (e, t, n) {
              a.info(
                "Secondary_" +
                  e.getIndex() +
                  " player started playing stream " +
                  n.id()
              ),
                e.selectSecondaryTab(n, !1),
                n.pauseWhenAvailable() &&
                  (this.viewer.setPlayState(o.Paused, !1, !1),
            ...
            (r.prototype.clearSecondaryTab = function (e, t, n, o) {
              ...
              return (
                e.selectSecondaryTab(void 0, n),
                e.updateSecondaryTabEnabledState(!0, t),
                i &&
                  a.info(
                    "Secondary_" +
                      e.getIndex() +
                      " player no longer has a stream"
                  ),
                i
              );
            }),
            (r.prototype.shouldShowInitialSecondaries = function (e, t, o) {
              ...
              return (
                !t &&
                a < n.InitialSecondaryThreshold &&
                i.length &&
                i[0] < n.InitialSecondaryThreshold
              );
            }),
            r
          );
        ...
        o = (function () {
          ...
          return (
            ...
            (o.getRequestedVersion = function () {
              var t,
                n =
                  null !== (t = Panopto.viewer.playerSyncLogicVersion) &&
                  void 0 !== t
                    ? t
                    : "",
                o = e.StringHelpers.parseQueryString(
                  window.location.search,
                  !1,
                  !0
                );
              return (
                Panopto.Core.Browser.isSafari && (n = "allowprimarypause"),
            ...
            (o.createImpl = function (e, n, i, a) {
              ...
              switch (o.getRequestedVersion()) {
                case "multiplesecondary":
                  return new t.MultipleSecondarySynchronizationLogic(
                    e,
                    n,
                    i,
                    a
                ...
                case "noop":
                  return new t.TwoPlayerSynchronizationLogic(
                    e,
                    n,
                    i,
                    a,
                ...
                case "allowprimarypause":
                  return new t.TwoPlayerSynchronizationLogic(
                    ...
                    i,
                    a,
                    t.Mode.AllowPrimaryPause
                  );
                case "hybrid":
                  var r = e.isActiveBroadcast()
                    ? t.Mode.AllowPrimaryPause
                    : t.Mode.NoPausePrimary;
            ...
            (this.actualRelativeEnds = {}),
              ...
              (this.handleReady = function (e) {
                (t.playingStream = e.content),
                  t.updateEdgeValuesFromHlsjs(
                    e.maxSeekablePosition + t.playingStream.relativeStart,
                    e.totalDuration + t.playingStream.relativeStart
                  );
              }),
              ...
              (this.handleFinish = function () {
                t.updatePrimaryStreamRelativeEndFromHlsjs(
                  t.playingStream,
                  t.playingPosition
                );
              }),
              ...
              e.onDurationUpdate &&
                e.onDurationUpdate.add(this.handleDurationUpdate),
              e.onDurationFinalized &&
                e.onDurationFinalized.add(this.handleDurationFinalized),
              e.onProgress && e.onProgress.add(this.handleProgress),
              e.onFinish && e.onFinish.add(this.handleFinish);
          }
          return (
            (e.prototype.updatePrimaryStreamsFromDeliveryInfo = function (e) {
              (this.streams = _.map(e, function (e) {
                ...
                0 !== this.streamAtLive.relativeEnd
                  ? (this.serverDeterminedDuration = this.streamAtLive.relativeEnd)
                  : (this.serverDeterminedDuration = void 0);
            }),
            (e.prototype.findPrimary = function (e, n) {
              ...
              if (
                (o ||
                  (o = _.max(this.primaryStreams, function (e) {
                ...
                void 0 === e
                  ? ((n = o.relativeStart),
                    (i = 0 === o.relativeStart ? t.NotReady : t.Interrupted))
                  : (n = Math.clamp(n, o.relativeStart, this.seekableDuration));
              }
              return (
                o.relativeEnd > 0 &&
                  n >= o.relativeEnd &&
                  ((n = Math.min(n, o.relativeEnd)), (i = t.Ended)),
                {
                  stream: o,
              ...
              get: function () {
                ...
                return (
                  this.serverDeterminedDuration &&
                    (e = e
                      ? Math.min(e, this.serverDeterminedDuration)
                      : this.serverDeterminedDuration),
                  e
                );
              },
            ...
            (e.prototype.updatePrimaryStreamRelativeEndFromHlsjs = function (
              e,
              t
            ) {
              (0 === e.relativeEnd || e.relativeEnd > t) &&
                (this.actualRelativeEnds[e.id] = t),
                this.patchPrimaryStreamsWithActualRelativeEnd();
            }),
            (e.prototype.updateEdgeValuesFromHlsjs = function (e, t) {
              this.playingStream.id === this.streamAtLive.id &&
                (this.maxSeekablePositionClient > e &&
                  n.warning(
                    "Updating maxSeekablePositionClient to a lower value: " +
                      this.maxSeekablePositionClient +
                      " -> " +
                      e
                  ),
                (this.maxSeekablePositionClient = e),
            ...
            (e.prototype.patchPrimaryStreamsWithActualRelativeEnd = function () {
              for (var e = 0, t = this.streams; e < t.length; e++) {
                ...
                o &&
                  (0 === n.relativeEnd || n.relativeEnd > o) &&
                  (n.relativeEnd = o);
              }
            }),
            e
    ...
    !(function (t) {
      ...
      var s = (function (e) {
        function s(t, o, i, a, s) {
          var l =
            e.call(this, t, o, i, a, s === n.NoAdjust ? "Noop" : "TwoPlayer") ||
            this;
          return (
            (l.mode = s),
            1 !== a.length &&
              r.error(
                "(TwoPlayer) Expected a single secondary container. Received " +
                  a.length +
                  "."
              ),
            s !== n.NoAdjust &&
              r.info(
                "(TwoPlayer) " +
                  (s === n.AllowPrimaryPause
                    ? "Allow secondaries to catch up by pausing primaries (original)"
                    : "Seek secondaries to catch up with primary (new)")
              ),
        ...
        return (
          ...
          (s.prototype.doRemediation = function (e, t, n, o) {
            var i = _.chain(this.secondaryTabs)
              .filter(function (t) {
                return t.available(e);
              })
              .last()
            ...
            return (
              i
                ? (this.setSecondaryTab(e, i, this.secondaryTabs),
                  this.synchronizeSecondaryTab(
                    e,
                    n,
                    this.secondaryTabControl.selectedTab()
                  ))
                : this.clearSecondaryTab(e, n, o, this.secondaryTabs),
              ...
              if (
                ...
                this.primaryPlayer.setPlayStateWithLogging(
                  ...
                  a.setPosition(e, !0, void 0, function () {
                    return a.playState(c.viewer.playState());
                  });
              else if (
                this.primaryPlayer.isFullscreen() ||
                "hidden" === document.visibilityState
                ...
                if (
                  (r = (d = a.setPosition(e, !1, void 0, $.noop))
                    ? Math.abs(d)
                    : 0) >
                  o.SecondarySyncThreshold * this.playControls.playSpeed()
                ) {
                  var p = d > 0;
                  if (p && this.mode == n.NoPausePrimary)
                    return void (
                      this.primaryPlayer.isFullscreen() ||
                      (a.setPosition(e, !0, void 0, $.noop),
                      this.logDesync(d, "seeking secondary", !0))
                    );
                  (s = p ? this.primaryPlayer : a),
                    (l = p ? a : this.primaryPlayer),
                    this.logDesync(
                      d,
                      "pausing " + (p ? "primary" : "secondary"),
                      !0
                    ),
                    ...
                    (this.synchronizeTimeout = setTimeout(function () {
                      s.playState(i.Playing), c.clearSyncTimeout();
                    }, (1e3 * r) / this.playControls.playSpeed()));
                } else this.logDesync(d, "delta within tolerance", !1);
          }),
          (s.prototype.logDesync = function (e, t, n) {
            this.synchronizeTimeout ||
              this.viewer.logDesync(e, this.getName(), t, n);
          }),
          (s.prototype.setSecondaryTab = function (e, t, n) {
            var o = !1,
              r = this.secondaryTabControl.selectedTab();
            r && !r.available(e) && ((o = !0), r.setSelected(!1, !1)),
              this.viewer.viewMode(a.Secondary),
              (o =
                o ||
                !this.previousDefaultSecondary ||
                _.indexOf(n, t) >
                  _.indexOf(n, this.previousDefaultSecondary)) &&
                (this.secondaryTabControl.selectSecondaryTab(t, !1),
                this.viewer.resize()),
              o &&
                t.pauseWhenAvailable() &&
                (this.viewer.setPlayState(i.Paused, !1, !1),
                this.viewer.setFullscreenPlayer(void 0)),
              this.secondaryTabControl.updateSecondaryTabEnabledState(
                !t.hiddenTab(),
                e
              ),
              this.viewer.toggleSecondaryPlaceholder(!1);
          ...
          (s.prototype.clearSecondaryTab = function (e, t, n, o) {
            ...
            this.viewer.viewMode(l ? a.Secondary : a.Primary),
              ...
              this.previousDefaultSecondary &&
                r.info("Secondary player no longer has a stream to play");
          }),
          (s.prototype.getBlockingOrPausingPosition = function (e, n, o, i, a) {
            ...
            if (l) r = l.timeline[0];
              ...
              var c = t.ContentLogic.getPausingContent(s, n, e),
                d = i && i.content();
              c && c !== d && (r = c.timeline[0]);
            }
            return r;
          }),
          (s.prototype.shouldShowInitialSecondaries = function (e, t, n) {
            ...
            return (
              !t &&
              a < o.InitialSecondaryThreshold &&
              i.length &&
              i[0] < o.InitialSecondaryThreshold
            );
          }),
          s
        );
        ...
        var n = (function () {
          ...
          return (
            (t.prototype.createTabs = function (t, n, o) {
              ...
              if (
                (this.delivery.isBroadcast ||
                  ((a = PanoptoLegacy.Viewer.Tabs.SearchTab(
                    $("#searchTabHeader"),
                    $("#searchTabPane"),
                    l,
                    this.delivery.id,
                  ...
                  c.push(a)),
                (this.delivery.description ||
                  (null === (i = this.delivery.tags) || void 0 === i
                    ? void 0
                    : i.length) ||
                  this.delivery.ownerFullName) &&
                  ((r = PanoptoLegacy.Viewer.Tabs.DetailsTab(
                    $("#detailsTabHeader"),
                    $("#detailsTabPane"),
                    l,
                    this.delivery.id,
                  ...
                  c.push(r)),
                this.delivery.contents.length &&
                  c.push(
                    PanoptoLegacy.Viewer.Tabs.ContentsTab(
                      $("#contentsTabHeader"),
                      $("#contentsTabPane"),
                      l,
                      this.delivery.id,
                      this.delivery.contents,
                      this.deliveryService
                    )
                  ),
                this.delivery.hasCaptions &&
                  c.push(
                    PanoptoLegacy.Viewer.Tabs.TranscriptTab(
                      $("#transcriptTabHeader"),
                      $("#transcriptTabPane"),
                      l,
                      this.delivery,
                ...
                this.delivery.hasAnyLinks &&
                  c.push(
                    PanoptoLegacy.Viewer.Tabs.AttachmentTab(
                      $("#attachmentTabHeader"),
                      $("#attachmentTabPane"),
                      l,
                      this.delivery.id,
                ...
                Panopto.features.areSocialFeaturesEnabled &&
                  this.delivery.discussionEnabled)
              ) {
                var d =
                  this.delivery.user.role > Panopto.Data.AclRoleType.Viewer;
                s = PanoptoLegacy.Viewer.Tabs.CommentsTab(
                  $("#commentsTabHeader"),
                  $("#commentsTabPane"),
                  l,
                  this.delivery.id,
                  ...
                  this.delivery.user,
                  this.delivery.isBroadcast,
                  this.delivery.discussionCacheSeconds,
                  d,
                  this.deliveryService
                );
              }
              return (
                ...
                this.delivery.user.key &&
                  c.push(
                    PanoptoLegacy.Viewer.Tabs.BookmarksTab(
                      $("#bookmarksTabHeader"),
                      $("#bookmarksTabPane"),
                      l,
                      this.delivery.id,
                ...
                s &&
                  !Panopto.viewer.displayViewerDiscussionAboveNotes &&
                  c.push(s),
                { tabs: c, searchTab: a, detailsTab: r, commentsTab: s }
              );
            }),
            t
          );
  ...
  (Panopto.Viewer.Controls.Timeline.TimelineConverter = function (e, t) {
    var n,
            ...
            _.each(o, function (t) {
              ...
              n &&
                (e.segments.push({
                  ...
                  relativeEnd: t.end,
                  streamOffset:
                    n.offset / Panopto.Core.Constants.TimelineChunkMultiplier,
      ...
      r = function () {
        ...
        i.length
          ? (e = i[i.length - 1].end)
          : (e = n.duration() / Panopto.Core.Constants.TimelineChunkMultiplier);
        return e;
      };
    return {
      ...
      computeSegments: function (t, r) {
        ...
        var s,
          l,
          c = r ? n.createTimeline(!0) : n.timeline(),
          d = c.elements(),
          u = c.firstPrimaryIndex(),
          p = c.lastPrimaryIndex(),
          f = 0,
          h =
            n.firstPrimaryOffset() /
            Panopto.Core.Constants.TimelineChunkMultiplier;
        for (o = [], i = [], s = 0; s <= d.length - 1; s++)
          s >= u &&
            s <= p &&
            ((l = new PanoptoTS.Viewer.Controls.Timeline.TimelineSegment(
              d[s],
              f,
              f + d[s].length()
            )),
            o.push(l),
            d[s].containsPrimary() && i.push(l)),
            (f += d[s].length());
        _.each(o, function (e) {
          (e.start -= h), (e.end -= h);
        }),
          e.setPrimarySegments(
            o,
            i,
            n.duration() / Panopto.Core.Constants.TimelineChunkMultiplier,
            !r
          ),
          a();
      },
...
((Panopto = Panopto || {}).Viewer = Panopto.Viewer || {}),
  (Panopto.Viewer.Controls = Panopto.Viewer.Controls || {}),
  (Panopto.Viewer.Controls.Timeline = Panopto.Viewer.Controls.Timeline || {}),
  (Panopto.Viewer.Controls.Timeline.TimelineEditor = function (
    e,
    t,
    n,
    o,
    ...
    var x,
      ...
      Y = K.add(J),
      X =
        o.availableLanguages && o.availableLanguages.length > 0
          ? o.availableLanguages[0]
          : null,
      Z = function (e) {
        var t = $.Deferred(),
          n = $.Deferred(),
        ...
        return (
          ...
          Panopto.Core.ServiceInterface.Rest.Sessions.getAllCuts(
            e.referencedSessionId,
            function (t) {
              (e.cuts = t), o.resolve();
            },
          ...
          Panopto.Core.ServiceInterface.Rest.Sessions.getAllEvents(
            e.referencedSessionId,
            {
              eventTypes: [
                Panopto.Core.EventType.Label,
                Panopto.Core.EventType.SmartOcrToc,
              ],
          ...
          Panopto.Core.ServiceInterface.Rest.Sessions.getAllSlideEvents(
            e.referencedSessionId,
            { pageSize: Panopto.viewer.timelineEditorEventsPageSize },
            function (t) {
          ...
          Panopto.Core.ServiceInterface.Rest.Sessions.getAllCaptions(
            e.referencedSessionId,
            {
              pageSize: Panopto.viewer.timelineEditorEventsPageSize,
              Language: X,
          ...
          $.when
            ...
            .then(function () {
              var n = []
                .concat(e.events)
                .concat(e.slideEvents)
                .concat(e.captions);
              (e.timelineState = new PanoptoTS.Core.UI.Components.Editor.TimelineState(
                e.streams,
                e.cuts,
                n,
                void 0,
                ...
                _.chain(e.cuts).each(function (t) {
                  var o =
                      t.start / Panopto.Core.Constants.TimelineChunkMultiplier,
                    i =
                      (t.start + t.duration) /
                      Panopto.Core.Constants.TimelineChunkMultiplier;
                  if (
                    t.targetType ===
                    Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Stream
                  ) {
                    var a =
                      (_.find(e.timelineState.streams(), function (e) {
                        return e.id === t.targetId;
                      }).absoluteStart -
                        e.timelineState.absoluteStart()) /
                      Panopto.Core.Constants.TimelineChunkMultiplier;
                    (o += a), (i += a);
                  }
                  _.each(__spreadArray([], n), function (e) {
                    (t.targetType ===
                      Panopto.Core.ServiceInterface.Rest.Objects.TypeName
                        .Session ||
                      e.streamId === t.targetId) &&
                      e.editorTime >= o &&
                      e.editorTime < i &&
                      ((e.editorTime = -1),
                      n.splice(
                        _.findIndex(n, function (t) {
                          return t.id === e.id;
                        }),
                        1
                      ));
      ...
      ne = function (e) {
        var t;
        switch (e.type) {
          case Panopto.Core.ServiceInterface.Rest.Objects.StreamContentType
            .Audio:
      ...
      oe = function (e, t, n, o) {
        ...
        return (
          ...
          n
            ? o
              ? Panopto.GlobalResources.ViewerPlus_Edit_StreamNameAndType.format(
                  i,
                  e.isPrimary
                    ? Panopto.GlobalResources.ViewerPlus_Edit_Primary.toLowerCase() +
                        " " +
                        o
                    : Panopto.GlobalResources.ViewerPlus_Edit_Secondary.toLowerCase() +
                        " " +
                        o
                )
              : Panopto.GlobalResources.ViewerPlus_Edit_StreamNameAndType.format(
        ...
        c.computeSegments(p, b),
          ...
          e ||
            ...
            _.each(p.questionLists(), function (e) {
              var t = R.toUneditedFirstPrimaryRelative(
                e.firstStreamRelativeTicks
              ).seconds();
              o.documents.push({
                title: e.name,
                id: "urlTab" + e.id,
                timeline: [t, t + PanoptoViewer.Constants.UrlEventDuration],
                url: PanoptoTS.Viewer.Constants.QuizEditUrlTemplate.format(
                  e.id
                ),
            ...
            _.each(i, function (e) {
              var t =
                  -1 !==
                  e.link.indexOf(PanoptoViewer.Constants.YouTubeEmbedBaseUrl),
                n =
                  t && e.sessionId === o.id
                    ? PanoptoTS.Viewer.Constants.YouTubeEditUrlTemplate.format(
                        e.id
                      )
                    : e.link;
              o.documents.push({
                ...
                timeline: [
                  e.viewerTime,
                  e.viewerTime + PanoptoViewer.Constants.UrlEventDuration,
                ],
                url: n,
                pauseWhenAvailable: !0,
                iconClass: t
                  ? PanoptoTS.Viewer.Constants.YouTubeIconClass
                  : void 0,
            ...
            a.length &&
              o.slideDecks.push({
                ...
                slides: _.map(a, function (e) {
                  return { time: e.viewerTime, url: e.slideUrl };
                }),
            ...
            r.length &&
              ((o.captions = []),
              _.each(r, function (e) {
                o.captions.push({ time: e.viewerTime, text: _.escape(e.name) });
              })),
            _.each(p.sessionReferences, function (e) {
              _.chain(e.streams)
                ...
                .each(function (e) {
                  var t = [],
                    n = [];
                  _.each(c.getSegments(), function (o) {
                  ...
                  var i = {
                      ...
                      tabClass:
                        e.type ===
                          Panopto.Core.ServiceInterface.Rest.Objects
                            .StreamContentType.Audio ||
                        e.type ===
                          Panopto.Core.ServiceInterface.Rest.Objects
                            .StreamContentType.Screen
                  ...
                  a > -1
                    ? o.secondaryStreams.splice(a, 1, i)
                    : o.secondaryStreams.push(i);
                });
            }),
            _.each(o.primaryStreams.concat(o.secondaryStreams), function (e) {
              (e.title = void 0 !== e.title ? e.title : oe(void 0, e.id)),
                (e.vrType = void 0 !== e.vrType ? e.vrType : te(e.id).vrType);
            }),
            t.refreshPlayers()),
          t.synchronize(!e),
      ...
      re = function (e) {
        ie(),
          e
            ? d.applyStateWhenChangeIsTimelineViewTriggered(p)
            : d.applyState(p),
          ae(e),
          ve();
      },
      se = function () {
        ie(), d.applyState(p), ae();
      },
      le = function () {
        var e = T.indexOf(p);
        if (e) {
      ...
      de = function () {
        var e = T.indexOf(p);
        N.toggleClass(Panopto.Core.Constants.DisabledClass, !e),
          z.toggleClass(
            Panopto.Core.Constants.DisabledClass,
            e === T.length - 1
          );
        var t = p !== u && s.id;
        j.toggleClass(Panopto.Core.Constants.DisabledClass, !t);
        var n =
          window.streamUploader && window.streamUploader.hasActiveUploads();
        G.toggleClass(Panopto.Core.Constants.DisabledClass, !t || n),
          G.attr(
            "title",
            n
              ? Panopto.GlobalResources.ViewerPlus_Edit_ApplyBlockedByNewStreams
              : Panopto.GlobalResources.ViewerPlus_Edit_ApplyButtonTooltip
          );
      },
      ue = function () {
        var e = T.indexOf(p),
      ...
      fe = function (e) {
        (A = !0),
          ...
          B.show(),
          B.text(e),
          B.removeClass(Panopto.Core.Constants.ErrorClass),
          G.add(j).toggleClass(Panopto.Core.Constants.DisabledClass, !0),
          F.hide();
      },
      he = function (e, t, n) {
        (A = !1),
          ...
          t
            ? (B.text(
                e.format(
                  Panopto.Core.TimeHelpers.utcDateToFormattedString(
                    Panopto.Core.TimeHelpers.toLocalPanoptoTime(
                      Date.now(),
                      Panopto.timeZone
                    ),
                    "LT"
            ...
            : (B.text(e),
              B.addClass(Panopto.Core.Constants.ErrorClass),
              F.toggle(!!n),
              Panopto.Core.UI.Handlers.button(F, n));
      },
      me = function (e) {
        ("SessionChangeSet Update can't change the owner of the change set" !==
          e.responseJSON &&
          "Object not found" !== e.responseJSON &&
          "Session already has an uncommitted change set." !==
            e.responseJSON) ||
          ((s.id = void 0),
          N.add(z).add(G).add(j).toggleClass("disabled", !0),
      ...
      ve = function () {
        V.hasQueuedJobs() ||
          V.queueJob({
            attempt: function (e) {
              var t = function () {
                  he(Panopto.GlobalResources.ViewerPlus_Edit_SavedAt, !0),
                    e(!0);
                },
                n = function (t) {
                  he(
                    Panopto.GlobalResources.ViewerPlus_Edit_SaveFailure,
                    !1,
                    ve
                  ),
                    me(t),
              ...
              p === u
                ? Panopto.Core.ServiceInterface.Rest.SessionChangeSets.deleteChangeSet(
                    s.id,
                    function () {
                ...
                : (!(function () {
                    var e = _.object(
                      ...
                      o = _.object(
                        _.map(p.questionLists(), function (e) {
                          return e.id;
                        }),
                        p.questionLists()
                      ),
                      ...
                      a = _.object(
                        _.map(p.sessionReferences, function (e) {
                          return e.id;
                        }),
                        p.sessionReferences
                      );
                    (s.cutsToReplace = _.map(p.cuts(), function (e) {
                      ...
                      (s.questionListRevisions = _.chain(p.questionLists())
                        .filter(function (e) {
                        ...
                        .value()),
                      (s.questionListIdsToDelete = _.map(
                        _.filter(h, function (e) {
                          return !o[e.id];
                        }),
                        function (e) {
                          return e.id;
                      ...
                      (s.sessionReferences.toAdd = _.chain(p.sessionReferences)
                        .filter(function (e) {
                          return !i[e.id];
                        })
                        .map(function (e) {
                          ...
                          return (
                            (t.referencedSessionId = e.referencedSessionId),
                            (t.order = e.order),
                            (t.start = e.start),
                            (t.cuts = []),
                            _.chain(p.cuts())
                              ...
                              .each(function (e) {
                                ...
                                (n.start =
                                  e.start /
                                  Panopto.Core.Constants
                                    .TimelineChunkMultiplier),
                                  (n.duration =
                                    e.duration /
                                    Panopto.Core.Constants
                                      .TimelineChunkMultiplier),
                        ...
                        .value()),
                      (s.sessionReferences.toUpdate = _.chain(
                        p.sessionReferences
                      )
                        .filter(function (e) {
                        ...
                        .value()),
                      (s.sessionReferences.toDelete = _.chain(m)
                        .filter(function (e) {
                          return !a[e.id];
                        })
                        .map(function (e) {
                        ...
                        .value()),
                      p.addedStreams.length &&
                        ((s.streamChanges = new AutoClientModels.StreamChanges()),
                        (s.streamChanges.toAdd = _.map(
                          p.addedStreams,
                          function (e) {
                  ...
                  fe(Panopto.GlobalResources.ViewerPlus_Edit_Saving),
                  Panopto.Core.ServiceInterface.Rest.SessionChangeSets.save(
                    s,
                    function (e) {
                      (s.id = e.id), t();
                    },
      ...
      ye = function () {
        V.queueJob({
          attempt: function (e) {
            p !== u &&
              s.id &&
              (fe(Panopto.GlobalResources.ViewerPlus_Edit_Applying),
              Panopto.Core.ServiceInterface.Rest.SessionChangeSets.commitChanges(
                s,
                function () {
                  he(Panopto.GlobalResources.ViewerPlus_Edit_ApplySuccess, !0),
                    (s.id = void 0),
                    e(!0),
                    confirm(
                      Panopto.GlobalResources.ViewerPlus_Edit_ContinueEditing
                    )
                      ? Q.click()
                      : window.location.reload();
                },
                function (t) {
                  he(
                    Panopto.GlobalResources.ViewerPlus_Edit_ApplyFailure,
                    !1,
                    ye
                  ),
                    me(t),
      ...
      Pe = function () {
        confirm(Panopto.GlobalResources.ViewerPlus_Edit_ConfirmRevert) &&
          (V.emptyQueue(),
          V.queueJob({
            attempt: function (e) {
              p !== u &&
                s.id &&
                (fe(Panopto.GlobalResources.ViewerPlus_Edit_Reverting),
                Panopto.Core.ServiceInterface.Rest.SessionChangeSets.deleteChangeSet(
                  s.id,
                  function () {
                    he(Panopto.GlobalResources.ViewerPlus_Edit_RevertedAt, !0),
                      (s = Panopto.Core.ServiceInterface.Rest.Objects.SessionChangeSet(
                        { sessionId: o.id }
                      ));
                    var n = t.getPosition(),
                    ...
                    (T.length = 0),
                      ...
                      se(),
                      t.setPosition(
                        p.calculateEditorTimeFromAbsolute(i.ticks())
                      ),
                      e(!0);
                  },
                  function (t) {
                    he(
                      Panopto.GlobalResources.ViewerPlus_Edit_RevertFailure,
                      !1,
                      Pe
                    ),
                      me(t),
      ...
      Se = function (e, t, n, i, a) {
        ...
        t <= e
          ? C.error(
              "Could not create cut. Operation will create a negative cut. relativeStart: " +
                e +
                " relativeEnd: " +
                t
            )
          : (l.addCut(e, t, n || o.id, i, a),
            (r = Panopto.Core.Logic.Timeline.Timeline(p.streams(), p.cuts())),
            i !== Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Session ||
              _.some(r.elements(), function (e) {
                return e.containsPrimary();
              }) ||
              (l.removeAll(
                o.id,
                Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Session
              ),
              d.applyState(p),
      ...
      Ce = function (e, t, n) {
        ...
        switch (n) {
          ...
          case Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Stream:
            ...
            break;
          case Panopto.Core.ServiceInterface.Rest.Objects.TypeName
            .SessionReference:
            i = e;
        }
        l.removeCut(i, t, n);
      ...
      we = function (e, t, n, o, i) {
        n <= t
          ...
          : (Ce(e, o, i), Se(t, n, o, i, !1));
      },
      be = function () {
        var e = new AutoClientModels.QuestionOption();
        (e.id = _.uniqueId("questionOption")),
          (e.name =
            Panopto.GlobalResources.ViewerPlus_Edit_QuestionList_DefaultOption1),
          (e.isCorrect = !0);
        var t = new AutoClientModels.QuestionOption();
        (t.id = _.uniqueId("questionOption")),
          (t.name =
            Panopto.GlobalResources.ViewerPlus_Edit_QuestionList_DefaultOption2),
          (t.isCorrect = !1);
        var n = new AutoClientModels.Question();
        return (
          (n.id = _.uniqueId("question")),
          (n.name =
            Panopto.GlobalResources.ViewerPlus_Edit_QuestionList_DefaultQuestionName),
      ...
      Te = function (e) {
        ...
        if (p.isTimeInSessionReference(o)) {
          ...
          if (a >= p.duration())
            alert(
              Panopto.GlobalResources.ViewerPlus_EventTab_EventDuringClipAtEnd
            ),
              (i = !1);
          else
            confirm(Panopto.GlobalResources.ViewerPlus_EventTab_EventDuringClip)
              ? (n = a)
              : (i = !1);
        ...
        if ((s <= n && (n = s), i)) {
          ue();
          var l = t.getPosition(),
            c = new PanoptoTS.Models.Editor.EditableQuestionList();
          (c.id = _.uniqueId("questionList")),
            (c.name =
              e ||
              Panopto.GlobalResources.ViewerPlus_Edit_QuestionList_DefaultName),
            (c.sessionId = r.id),
            (c.firstStreamRelativeTicks = R.toFirstStreamRelative(l)),
            (c.isEdited = !0),
            (c.isSessionPlaybackBlocking = !0),
            (c.allowRetake = !0),
            (c.showFinalGrade = !0),
            (c.allowReview = !0),
            (c.questions = [be()]),
            p.questionLists().push(c),
            p.refreshTimeline(),
            re(!1);
        }
      },
      ...
      Ve = function (e) {
        ...
        return (
          (t.sessionRelativeTime = p.calculateEditorTimeTicksFromAbsolute(
            t.timelineTime
          )),
          t
        );
      },
      _e = function (n, s, m, v, P, S, V) {
        var x = _.min(
          ...
          U = function (e, t) {
            ...
            switch (e.targetType) {
              case Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Session:
              case Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Stream:
                (n = p.calculateRelativeTimeFromRelativeEditorTime(
                  e.relativeEditorStart,
                  e.targetId
                )),
                  (o = p.calculateRelativeTimeFromRelativeEditorTime(
                    e.relativeEditorEnd,
                    e.targetId
                  ));
                break;
            ...
            o <= n
              ? C.error(
                  "Could not create cut from CutView. Operation will create a negative cut. relativeStart: " +
                    n +
                    " relativeEnd: " +
                    o +
                    " cutView:",
              ...
              : Se(n, o, e.targetId, e.targetType, t);
          },
          B = function (e) {
            var t = p.calculateEditorTimeFromRelativeEditorTime(
              e.relativeEditorStart,
              e.targetId
            );
        ...
        _.each(o.primaryStreams.concat(o.secondaryStreams), function (e) {
          ...
          t &&
            ((e.length =
              t.duration / Panopto.Core.Constants.TimelineChunkMultiplier),
            (e.url = t.url),
            (e.httpUrl = t.httpUrl));
        }),
        ...
        if (
          ((function (e, t, n, o) {
            ...
            t.forEach(function (e) {
              ...
              _.each(i.elements(), function (e) {
                e.streams().length ||
                  a.push({ start: r, end: r + e.length(), length: e.length() }),
                  (r += e.length());
              }),
              a.reverse(),
              _.each(a, function (i) {
                ...
                _.each(t, function (e) {
                  ...
                  _.each(n, function (t) {
                    t.targetType ===
                      Panopto.Core.ServiceInterface.Rest.Objects.TypeName
                        .Session &&
                      t.start + e.absoluteStart >= i.end &&
                      (t.start -= i.length);
                  }),
                  _.each(o, function (e) {
                    var t;
                    e.timelineTime > i.start &&
                    e.timelineTime < i.end &&
                    e.type === Panopto.Core.EventType.SlideChange
                      ? (t = _.find(o, function (t) {
                          return (
                            t.type === Panopto.Core.EventType.SlideChange &&
                            t.timelineTime > e.timelineTime
                          );
                        })) && t.timelineTime <= i.end
                        ? a.push(e)
                        : ((e.timelineTime = i.start), (e.edited = !0))
                      : e.timelineTime >= i.end &&
                        ((e.timelineTime -= i.length), (e.edited = !0));
                  }),
                  _.each(a, function (e) {
          ...
          (c = Panopto.Viewer.Controls.Timeline.TimelineConverter(t, o)),
          (d = Panopto.Core.UI.Components.Editor.TimelineView(
            o.id,
            o.folder.id,
            {
              positionChanged: function (e) {
                t.setPosition(
                  e / Panopto.Core.Constants.TimelineChunkMultiplier
                );
              },
              ...
              cutResized: function (e, t) {
                ...
                o <= n
                  ...
                  : (ue(), we(e, n, o, t.targetId, t.targetType), re(!0));
              },
              ...
              stackExpanded: function (e, n) {
                ...
                _.every(I, function (t) {
                  ...
                  ? (Y.hide(), (I = []))
                  : ((I = e),
                    (o = Panopto.Viewer.Controls.ThumbnailStrip(
                      K,
                      e,
                      t,
                      w,
                    ...
                    o.render(function () {
                      K.show()
                        .toggleClass(
                          "no-scroll",
                          K[0].scrollWidth === K.innerWidth()
                        )
                        .css({
                          left: Math.clamp(
                            i - K.outerWidth() / 2,
                            0,
                            $(window).width() - K.outerWidth()
                          ),
                          top: a - K.outerHeight(),
                        }),
                        J.show().css({ left: i, top: a }),
                        $(document).on("mousedown.expanded-view", function (e) {
                          K.is(e.target) ||
                            J.is(e.target) ||
                            0 !== K.find(e.target).length ||
                            (Y.hide(),
              ...
              sessionReferenceAdded: function (e) {
                var n = p.calculateRelativeTime(
                  t.position() * Panopto.Core.Constants.TimelineChunkMultiplier
                );
                n >
                  p.hostDuration() -
                    0.1 * Panopto.Core.Constants.TimelineChunkMultiplier &&
                  (n = p.hostDuration());
                var o = _.chain(p.sessionReferences)
                  .filter(function (e) {
                    return e.start === n;
                  })
                  .size()
              ...
              sessionReferenceEdited: function (e, t) {
                E.forEach(function (n) {
                  n.handleSessionReferenceEdit &&
                    n.handleSessionReferenceEdit(e, t);
                });
              },
            ...
            },
            {
              ...
              millisecondPrecision:
                Panopto.Core.Constants.DisplayTimeMillisecondPrecision,
              ViewerPlus_Edit_Expand:
                Panopto.GlobalResources.ViewerPlus_Edit_Expand,
              ViewerPlus_Edit_Collapse:
                Panopto.GlobalResources.ViewerPlus_Edit_Collapse,
              ...
              addContentButton:
                Panopto.GlobalResources.ViewerPlus_Edit_AddContent,
              thumbnailButton:
                Panopto.GlobalResources.ViewerPlus_Edit_SetDefaultThumbnail,
              setPrimaryAsDefaultThumbnail:
                Panopto.GlobalResources
                  .ViewerPlus_Edit_SetPrimaryAsDefaultThumbnail,
              setSecondaryAsDefaultThumbnail:
                Panopto.GlobalResources
                  .ViewerPlus_Edit_SetSecondaryAsDefaultThumbnail,
              uploadCustomDefaultThumbnail:
                Panopto.GlobalResources
                  .ViewerPlus_Edit_UploadCustomDefaultThumbnail,
              ...
              presentationName:
                Panopto.GlobalResources.ViewerPlus_Edit_PresentationViewTitle,
              noThumbnailUrl: Panopto.cacheRoot + "/Images/no_thumbnail.svg",
            }
          )),
          (u = p = new PanoptoTS.Core.UI.Components.Editor.TimelineState(
            n,
            s,
            v,
            [],
            F,
            r.referencedSessions,
            []
          )),
          T.push(p),
          ge(),
          (function () {
            var e = p.cuts(),
              t = [],
              n =
                PanoptoTS.Viewer.Constants.BoundaryCutTolerance *
                Panopto.Core.Constants.TimelineChunkMultiplier;
            _.each(e, function (e) {
          ...
          var X = e.debug
            ? PanoptoTS.Viewer.Controls.StreamUploaderDebug
            : PanoptoTS.Viewer.Controls.StreamUploader;
          window.slideUploader = new X(
            {
              sessionId: o.id,
              supportedExtensions: [".ppt", ".pptx"],
              supportedStreamTypes: [
                Panopto.Core.StreamType.SecondaryPresentation,
              ],
              showStartTime: !1,
            },
            i,
            Panopto.Core.ServiceInterface.SessionUploadManagement,
        ...
        window.streamUploader.onUploaded.add(L),
          window.streamUploader.onUpdate.add(O),
          Ie(m),
          (g = Panopto.Viewer.Players.ThumbnailPlayer(v, t, w)),
          Panopto.Core.UI.Handlers.button(N, le),
          Panopto.Core.UI.Handlers.button(z, ce),
          Panopto.Core.UI.Handlers.button(G, function () {
          ...
          Panopto.viewer.enableSilverlightEditor &&
            q
              .show()
              .find("a")
              .attr(
                "href",
                PanoptoTS.Viewer.Constants.SilverlightEditorUrlTemplate.format(
                  o.id
                )
              ),
          W.show(),
          Panopto.Core.UI.Handlers.button(W, function () {
            (k = !k),
              ...
              W.text(
                k
                  ? Panopto.GlobalResources.ViewerPlus_Edit_PreviewButtonText
                  : Panopto.GlobalResources.ViewerPlus_Edit_TimelineButtonText
              )
                .attr(
                  "title",
                  k
                    ? Panopto.GlobalResources.ViewerPlus_Edit_PreviewButtonTitle
                    : Panopto.GlobalResources
                        .ViewerPlus_Edit_TimelineButtonTitle
                )
                .toggleClass("previewing", !k),
              t.resize();
          }),
          $(window).on("beforeunload", function () {
            return A
              ? Panopto.GlobalResources.ViewerPlus_Edit_UnsavedChanges
              : void 0;
          }),
      ...
      Ie = function (e) {
        window.slidesTab
          ? (e && window.slidesTab.setSlideDecks(e),
            window.slidesTab.setTimelineEditor(w))
          : (S = e),
      ...
      ke = function (e) {
        ...
        if (
          ...
          _.each(s.eventsToAdd, function (e) {
            e.type === Panopto.Core.EventType.SpeechRecognition &&
              (e.forceShow = !0),
              p.events().push(e);
          }),
          _.each(s.eventsToUpdate, function (e) {
            var t = p.events()[
              _.findIndex(p.events(), function (t) {
                return e.id === t.id;
              })
            ];
            t
              ? ((t.edited = !0),
                ...
                (t.timelineTime = e.timelineTime),
                (t.link = e.link),
                (t.isDefaultThumbnail = e.isDefaultThumbnail))
              : i.push(e);
          }),
          _.each(i, function (e) {
          ...
          _.each(s.questionListRevisions, function (e) {
            ...
            n.copyFromClientModel(e),
              t >= 0
                ? ((n.isEdited = !0), (p.questionLists()[t] = n))
                : ((n.id = _.uniqueId("questionList")),
                  p.questionLists().push(n));
          }),
          _.each(s.questionListIdsToDelete, function (e) {
            p.questionLists().splice(
              _.findIndex(p.questionLists(), function (t) {
                return e === t.id;
              }),
              1
            );
          ...
          _.each(s.sessionReferences.toAdd, function (e) {
            t.push(
              (function (e) {
                return ee(e.referencedSessionId, e.start, e.order).done(
                  function (t) {
                    p.sessionReferences.push(t),
                      _.each(e.cuts, function (e) {
                        p.cuts().push(
                          Panopto.Core.ServiceInterface.Rest.Objects.Cut({
                            TargetType:
                              Panopto.Core.ServiceInterface.Rest.Objects
                                .TypeName.SessionReference,
                            TargetId: t.id,
          ...
          s.streamChanges.toDelete &&
            s.streamChanges.toDelete.forEach(function (e) {
          ...
          function (n) {
            n.results.length > Panopto.viewer.spliceHostReprocessLimit
              ? t.toggleMessage(
                  Panopto.Core.StringHelpers.format(
                    Panopto.GlobalResources
                      .ViewerPlus_Edit_MaxReferencedSessionsExceeded,
                    Panopto.viewer.spliceHostReprocessLimit
                  )
                )
              : (n.results.length &&
                  (alert(
                    Panopto.Core.StringHelpers.format(
                      1 === n.results.length
                        ? Panopto.GlobalResources
                            .ViewerPlus_Edit_HasReferencedSession
                        : Panopto.GlobalResources
                            .ViewerPlus_Edit_HasReferencedSessions,
                      n.results.length
                    )
                  ),
                  d.setCanAddClip(!1)),
      ...
      xe = function (e) {
        var n = function () {
          ...
          i = function (n) {
            Panopto.Core.ServiceInterface.Rest.SessionChangeSets.updateOwner(
              n.id,
              void 0,
              function (n) {
                (s = n),
        ...
        Panopto.Core.ServiceInterface.Rest.SessionChangeSets.get(
          o.id,
          function (e) {
            var o = e.results[0];
            o
              ? o.ownerId !== Panopto.user.userId
                ? (t.toggleMessage(
                    _.template($("#pendingEditsMessageTemplate").html())({
                      message: Panopto.GlobalResources.ViewerPlus_Edit_PendingChanges.format(
                        o.ownerName,
                        Panopto.Core.TimeHelpers.utcDateToFormattedString(
                          Panopto.Core.TimeHelpers.toLocalPanoptoTime(
                            o.updateDate,
                      ...
                      claim: Panopto.GlobalResources.ViewerPlus_Edit_TakeOver.format(
                        o.ownerName
                      ),
                      discard: Panopto.GlobalResources.ViewerPlus_Edit_Discard.format(
                        o.ownerName
                      ),
                    })
                  ),
    ...
    (n.eventPane.onTabSetChanged = function (e) {
      ...
      Panopto.Core.ServiceInterface.Rest.Sessions.getOne(
        o.id,
        function (e) {
          var t,
            n = [];
          ...
          n.push(f),
            Panopto.Core.ServiceInterface.Rest.Sessions.getAllEvents(
              o.id,
              {
                eventTypes: [
                  Panopto.Core.EventType.Label,
                  Panopto.Core.EventType.SpeechRecognition,
                  Panopto.Core.EventType.SmartOcrToc,
                  Panopto.Core.EventType.CandidateSmartOcrToc,
                  Panopto.Core.EventType.DefaultThumbnail,
                ],
                pageSize: Panopto.viewer.timelineEditorEventsPageSize,
              },
              function (e) {
          ...
          var g = $.Deferred();
          n.push(g),
            Panopto.Core.ServiceInterface.Rest.Sessions.getAllQuestionLists(
              o.id,
              function (e) {
                (y = e), g.resolve();
              },
    ...
    var Le = new PanoptoTS.Viewer.Controls.OverlayUploader(t, R);
    Le.setAbsoluteSessionStart(o.date);
    var Oe = new PanoptoTS.Viewer.Controls.OverlayController(
      t.pageStructureElements(),
      Le,
      Panopto.GlobalResources
    );
    return (
      Oe.onShowOverlays.add(function () {
      ...
      (w.synchronize = function (e, n) {
        ...
        d.synchronize(e * Panopto.Core.Constants.TimelineChunkMultiplier, {
          playing: n,
          primaryAudioOnly:
            o &&
            o.type ===
              Panopto.Core.ServiceInterface.Rest.Objects.StreamContentType
                .Audio,
      ...
      (w.timelinePosition = function (e, t) {
        return c && b && !e ? c.timelinePosition(t) : t;
      }),
      (w.timelineEndPosition = function () {
        return c && b
          ? c.timelineEndPosition()
          : p.duration() / Panopto.Core.Constants.TimelineChunkMultiplier;
      }),
      (w.pushEdit = ue),
      (w.applyState = re),
      ...
      (w.resizeCut = we),
      (w.addQuestionList = Te),
      (w.applyPrimaryHeuristicCuts = ge),
      (w.validateEventTime = function (e) {
        ...
        return p.isTimeInSessionReference(t)
          ? {
              valid: !1,
              nextValidTime:
                p.findNextTimeNotInSessionReference(t) /
                Panopto.Core.Constants.TimelineChunkMultiplier,
            }
          : { valid: !0, nextValidTime: void 0 };
      }),
      (w.getQuestionList = function (e) {
        var t = _.find(p.questionLists(), function (t) {
          ...
          n = t.toClientModel();
        return (
          (n.sessionRelativeTime = R.toUneditedFirstPrimaryRelative(
            t.firstStreamRelativeTicks
          ).ticks()),
          n
        );
      }),
      (w.updateQuestionList = function (e) {
        ...
        var i = new PanoptoTS.Core.Logic.Time.UneditedFirstPrimaryRelative(
          n.sessionRelativeTime
        );
        ...
        var r =
          a.firstStreamRelativeTicks.ticks() !==
          o.firstStreamRelativeTicks.ticks();
        return (
          p.refreshTimeline(),
          re(a.name === o.name && !r),
      ...
      (w.updateEvent = function (e) {
        ...
        n.edited = !0;
        var o = new PanoptoTS.Core.Logic.Time.UneditedFirstPrimaryRelative(
          e.sessionRelativeTime
        );
      ...
      (w.deregisterCallbacks = function () {
        window.streamUploader.onUploaded.remove(L),
          window.streamUploader.onUpdate.remove(O);
      }),
      (w.toggleSecondaryPlaceholder = function (e) {
        Oe.toggleSecondaryPlaceholder(e);
      }),
      (w.onAddContentRequirementChanged = U),
      (w.overlayController = Oe),
      (w.eventService = D),
      (w.timeConverter = R),
      w
    );
...
!(function (e) {
          ...
          function s(o, l, c) {
            ...
            (this.helpers = c),
              ...
              (this.playerEvents = {
                ...
                stopped: { name: "stop" },
                finish: { name: "finish" },
                qualityChange: { name: "quality" },
                speedChange: { name: "speed" },
                volumeChange: { name: "volume" },
                muteChange: { name: "mute" },
              }),
              (this.triggers = {
                load: { name: "load" },
                ready: { name: "ready" },
                ...
                updateBitrate: { name: "updateBitrate" },
                updateSpeed: { name: "updateSpeed" },
                updateVolume: { name: "updateVolume" },
                updateMuted: { name: "updateMuted" },
              }),
              (this.states = {
                uninitialized: { name: "uninitialized" },
                loaded: { name: "loaded", triggerOnEnter: this.triggers.ready },
              ...
              (this.transitions = {
                play: {
                  ...
                  action: function (e, t) {
                    d.component.playing
                      ? t()
                      : (d.component.play(), d.setBufferingTimeout(!0));
                  },
                ...
                pause: {
                  ...
                  action: function (e, t) {
                    d.component.playing
                      ? (d.component.pause(), d.clearBufferingTimeout())
                      : t();
                  },
                ...
                ready: {
                  ...
                  action: function (e, t) {
                    (d.qualityReporter = i.QualityReporter({
                      ...
                      e.onLoad && e.onLoad(),
                      _.each(d.video.textTracks, function (e) {
                        e.mode = "disabled";
                      }),
                      (d.video.textTracks.onaddtrack = function (e) {
                        e.track.mode = "disabled";
                      }),
                      d.isPrimary || d.component.mute(!0),
                      e.playSpeed && d.component.speed(e.playSpeed),
                      d.setHlsJsEngineEvents(),
                      d.component.video.width && d.component.video.height
                        ? d.helpers.resize()
                        : d.component.one("progress", function () {
                            d.helpers.resize();
                          }),
                      (d.isMediaReady = !0),
                      t();
                ...
                initialLoad: {
                  ...
                  action: function (t, o) {
                    (d.isBroadcast = t.content.isBroadcast),
                      (d.broadcastSegmentDuration =
                        t.content.broadcastSegmentDuration),
                      (d.broadcastSegmentBackoff =
                        t.content.broadcastSegmentBackoff);
                    var i = d.generatePlayerConfiguration(t);
                    t.startPosition &&
                      (i.hlsjs.startPosition = t.startPosition);
                    var s = o;
                    d.isBroadcast &&
                      a.isHiveOptimized(t.content.optimizationToken) &&
                      (s = function () {
                        o(),
                          (d.webcastDurationEstimator = new e.Viewer.Logic.HlsJsWebcastDurationEstimator(
                            d.component,
                            Panopto.viewer.enableWebcastServerAgeFactor
                          ));
                      }),
                      (d.component = d.initializeFlowplayerComponent(i, t, s)),
                      d.isBroadcast &&
                        !a.isHiveOptimized(t.content.optimizationToken) &&
                        (d.webcastDurationEstimator = new e.Viewer.Logic.HlsJsWebcastDurationEstimator(
                          d.component,
                      ...
                      (d.video = d.$container.find("video")[0]);
                    var l,
                      c,
                      u = d.isPrimary ? "primary" : "secondary",
                      p = function (e) {
                        return r.verbose(
                          "[<video/>] [" + u + "] > " + e.type + " event"
                        );
                      };
                    [
                      "durationchange",
                      ...
                      return d.video.addEventListener(e, p);
                    }),
                      d.$container
                        .find(".fp-ui")
                        .click(function () {
                        ...
                        .mouseup(function (e) {
                          1 === e.which &&
                            l === e.pageX &&
                            c === e.pageY &&
                            d.helpers.togglePlaying();
                        }),
                      d.component.on("progress", function () {
                        d.component.playing && d.setBufferingTimeout(!0);
                      }),
                      setInterval(function () {
                        return d.checkForBuffering;
                ...
                load: {
                  ...
                  toState: this.states.loaded,
                  action: function (e, t) {
                    e.clip.sources[0].src !==
                      d.component.video.sources[0].src ||
                    e.clip.vr !== d.component.video.vr
                      ? (d.hlsjs &&
                          (d.hlsjs.config.startPosition =
                            e.startPosition || -1),
                        d.loadClipIntoComponent(e))
                      : t();
                  },
                ...
                stop: {
                  trigger: this.triggers.load,
                  action: function (e, t) {
                    d.flushQualityReport(), d.component.stop();
                  },
                ...
                activeSet: [
                  {
                    trigger: this.triggers.updatePosition,
                    action: function (t, n) {
                      if (t === d.requestedPosition) {
                        var o = d.clampPosition(t);
                        d.requestedPosition = o;
                        var i = function () {
                          d.requestedPosition === o &&
                            (d.requestedPosition = void 0),
                            n();
                        };
                        if (
                          (!Panopto.Core.Browser.isChrome &&
                            d.component.video.time !== o) ||
                          Math.abs(o - d.component.video.time) >
                            e.Viewer.Constants.BadSeekThreshold ||
                          0 === o
                        ) {
                          var a = i;
                          if ("html5" === d.component.engine.engineName) {
                            a = function () {
                              return setTimeout(i, 0);
                            };
                            var s = !1;
                            $(d.video).one("progress", function () {
                              s ||
                                t !== d.requestedPosition ||
                                d.component.seek(o, a);
                            }),
                              $(d.video).one("seeking", function () {
                                s = !0;
                              });
                          }
                          var l,
                            c = $.Deferred();
                          c.then(function () {
                            "html5" === d.component.engine.engineName
                              ? setTimeout(a, 0)
                              : a();
                          }),
                            d.isBroadcast &&
                              ...
                              (l = setTimeout(function () {
                                r.warning(
                                  "WARN: forcing callback after seek timeout elapsed. Checking seek correctness. " +
                                    d.component.video.time +
                                    " vs. " +
                                    o
                                ),
                                  0 === d.component.video.time &&
                                    0 !== o &&
                                    (r.warning(
                                      "ERROR: Repeating seek request."
                                    ),
                                    d.position(o + 0.01, void 0)),
                                  c.resolve();
                              }, e.Viewer.Constants.MissingSeekedEventTimeout)),
                            d.component.seek(o, function () {
                              clearTimeout(l), c.resolve();
                            });
                        } else i();
                      } else n();
                    },
                  },
                  {
                    trigger: this.triggers.updateBitrate,
                    action: function (e, n) {
                      var o = t.HlsHelpers.getHlsJsQualityLevel(
                        d.hlsjs.levels.length,
                        e
                      );
                      o !=
                      (d.hlsjs && d.hlsjs.autoLevelEnabled
                        ? -1
                        : d.hlsjs.currentLevel)
                        ? d.component.quality(o)
                        : n();
                    },
                  ...
                  },
                  {
                    trigger: this.triggers.updateVolume,
                    action: function (e, t) {
                      d.component.volumeLevel != e
                        ? d.component.volume(e)
                        : t();
                    },
            ...
            (this.machine = new e.Logic.StateMachine.Machine(
              u,
              this.states.uninitialized
            )),
              (this.machine.attachEvent = function (e, t, n) {
                return d.attachEvent(e, t, n);
              }),
              (this.machine.detachEvent = function (e) {
                return d.detachEvent(e);
              }),
              (this.$bufferingIndicator = $(
                "#" + (o ? "primaryBuffering" : "secondaryBuffering")
              )),
              o || s.secondaryPlayerCount++;
          }
          return (
            (s.prototype.attachEvent = function (e, t, n) {
            ...
            (s.prototype.initializeTransitions = function () {
              (this.states.uninitialized.transitions = this.transitions.inactiveSet.slice()),
                this.states.uninitialized.transitions.push(
                  this.transitions.initialLoad
                ),
            ...
            (s.prototype.setBufferingTimeout = function (e) {
              ...
              e && this.clearBufferingTimeout(),
                (this.bufferingTimeout = window.setTimeout(function () {
                  t.component.playing &&
                    (t.$bufferingIndicator.show(),
                    t.$bufferingIndicator.css({
                      top:
                        t.$container.offset().top +
                        (t.$container.height() -
                          t.$bufferingIndicator.height()) /
                          2,
                      left:
                        t.$container.offset().left +
                        (t.$container.width() - t.$bufferingIndicator.width()) /
                          2,
                    }));
                }, n.BufferingTimeoutThreshold));
            }),
            (s.prototype.checkForBuffering = function () {
              this.machine.getCurrentState() !== this.states.paused
                ? this.component &&
                  this.component.video &&
                  this.lastBufferingCheckPosition !== this.component.video.time
                  ? (this.$bufferingIndicator.hide(),
                    (this.lastBufferingCheckPosition = this.component.video.time))
                  : (this.$bufferingIndicator.show(),
                    this.$bufferingIndicator.css({
                      top:
                        this.$container.offset().top +
                        (this.$container.height() -
                          this.$bufferingIndicator.height()) /
                          2,
                      left:
                        this.$container.offset().left +
                        (this.$container.width() -
                          this.$bufferingIndicator.width()) /
                          2,
                    }))
            ...
            (s.prototype.flushQualityReport = function () {
              this.qualityReporter &&
                this.qualityReporter.flushQualityReport(
                  this.hlsjs && this.component.playing,
                  this.component.video.time,
                  this.currentLevel,
                  this.hlsjs && this.hlsjs.levels && this.hlsjs.levels.length,
                  this.hlsjs &&
                    this.hlsjs.levels &&
                    this.hlsjs.levels.length &&
                    this.hlsjs.levels[this.currentLevel].bitrate,
                  this.hlsjs && this.hlsjs.autoLevelEnabled
                );
            }),
            (s.prototype.equalsLoadedContent = function (e) {
              ...
              if (e.vrType !== this.requestedVrType) t = !1;
                ...
                this.requestedContentUri.split("?")[0] !==
                  e.url.split("?")[0] && (t = !1);
              }
              return t;
            }),
            ...
            (s.prototype.initialize = function () {
              if (!flowplayer.conf.hlsjs) {
                (flowplayer.conf.fullscreen = !0),
                  ...
                  Panopto.Core.Browser.isFirefox &&
                    (flowplayer.conf.hlsjs.maxBufferHole =
                      PanoptoViewer.Constants.FirefoxMaxBufferHole);
                var e = {};
                try {
                ...
                _.extend(flowplayer.conf.hlsjs, e),
                  _.extend(
                    flowplayer.conf.hlsjs,
                    PanoptoViewer.Data.getHlsConfigQueryParams(
                      window.location.search.slice(1)
                    )
                  ),
                  r.info(
                    "[FlowplayerMachine] hls config: " +
                      JSON.stringify(flowplayer.conf.hlsjs)
                  );
              }
            }),
            (s.prototype.clampPosition = function (e) {
              ...
              if (
                (n === this.states.finished ||
                  n === this.states.loaded ||
                  n === this.states.paused ||
                  n === this.states.playing) &&
                this.component &&
                this.component.video &&
                (this.component.video.duration || Panopto.Core.Browser.isSafari)
              ) {
                var o =
                  this.isBroadcast && this.webcastDurationEstimator
                    ? this.webcastDurationEstimator.getDuration() -
                      this.broadcastSegmentBackoff *
                        this.broadcastSegmentDuration
                    : this.component.video.duration;
            ...
            (s.prototype.generatePlayerConfiguration = function (e) {
              ...
              return (
                this.isBroadcast &&
                  ((this.broadcastSegmentBackoff &&
                    3 !== this.broadcastSegmentBackoff) ||
                    !Panopto.viewer.enableServerBasedBackoffCalculation) &&
                  _.extend(flowplayer.conf.hlsjs, {
                  ...
                  }),
                {
                  ...
                  clip: e.clip,
                  chromecast: !Panopto.features
                    .disableFeaturesRequiringExternalNetworkAccess,
                  vrvideo: {
                    mode:
                      e.content.vrType === PanoptoViewer.MediaVRType.Full
                        ? "full"
                        : e.content.vrType === PanoptoViewer.MediaVRType.Half
                        ? "half"
                        : void 0,
                    renderOnPause: !0,
                  },
            ...
            (s.prototype.generatePlayerLoadData = function (e, t) {
              return {
                ...
                onLoad: t,
                playSpeed: this.component
                  ? this.component.currentSpeed
                  : void 0,
            ...
            (s.prototype.initializeFlowplayerComponent = function (e, t, n) {
              ...
              return (
                r.info(
                  "[FlowplayerMachine] > configuration:",
                  JSON.stringify(e)
                ),
            ...
            (s.prototype.setHlsJsEngineEvents = function () {
              ...
              if (!this.hlsjs) {
                ...
                this.hlsjs &&
                  (this.hlsjs.on("hlsManifestLoaded", function () {
                    var o = e.Viewer.Logic.InitialStateLogic.getBitrate(!1),
                      i = t.HlsHelpers.getHlsJsQualityLevel(
                        n.hlsjs.levels.length,
                        o
                      );
                      ...
                      void (
                        ...
                        r.info(
                          (n.isPrimary ? "Primary" : "Secondary") +
                            " player started playing segment at quality level " +
                            n.currentLevel +
                            " of " +
                            n.hlsjs.levels.length +
                            " (" +
                            n.hlsjs.levels[n.currentLevel].bitrate +
                            ")"
                        ),
              ...
              if (void 0 === t) {
                ...
                if (void 0 === o)
                  if (this.component && this.component.video) {
                    ...
                    this.video &&
                      (0 === o ||
                        o === this.video.duration ||
                        (o > i && this.video.currentTime < i)) &&
                      (o = this.video.currentTime);
                  } else o = 0;
                return isFinite(o) ? o : this.clampPosition(o);
              }
              this.requestedPosition !== t &&
                ((this.requestedPosition = t),
                this.machine.handleTrigger(
                  this.triggers.updatePosition,
            ...
            (s.prototype.playState = function (e) {
              e == o.Playing
                ? this.machine.handleTrigger(this.triggers.play)
                : this.machine.handleTrigger(this.triggers.pause);
            }),
            ...
            (s.prototype.volume = function (e) {
              this.isPrimary &&
                this.machine.handleTrigger(this.triggers.updateVolume, e / 100);
            }),
            (s.prototype.muted = function (e) {
              this.isPrimary &&
                this.machine.handleTrigger(this.triggers.updateMuted, e);
            }),
            (s.prototype.isFullscreen = function (e) {
              if (void 0 === e)
                return this.component && this.component.isFullscreen;
              this.component &&
                e !== this.component.isFullscreen &&
                ((this.component.disabled = !1), this.component.fullscreen());
            }),
            (s.prototype.width = function () {
              return this.isMediaReady
                ? this.component.video.width || this.video.videoWidth
                : 16;
            }),
            (s.prototype.height = function () {
              return this.isMediaReady
                ? this.component.video.height || this.video.videoHeight
                : 9;
            }),
            (s.prototype.ended = function () {
              return (
                this.machine.getCurrentState() === this.states.finished &&
                void 0 === this.machine.getCurrentTransition()
              );
            }),
            ...
            (s.prototype.bitrateOptions = function () {
              return this.isMediaReady &&
                ...
                this.hlsjs.levels &&
                this.hlsjs.levels[this.currentLevel]
                ? _.map(this.hlsjs.levels, function (e) {
                    return e.bitrate;
                  })
                : [];
            }),
        ...
        return (
          ...
          (n.prototype.clampPosition = function (e) {
            ...
            if (this.isBroadcast && this.webcastDurationEstimator && 0 === n) {
              ...
              (o -=
                this.broadcastSegmentBackoff * this.broadcastSegmentDuration),
                (n = Math.min(e, o));
            }
            return n;
          }),
          (n.prototype.generatePlayerConfiguration = function (e) {
            ...
            return (
              a.isHiveOptimized(e.content.optimizationToken) &&
                ((n.hive = a.createFlowplayerPlugin(e.content, this.isPrimary)),
          ...
          (n.prototype.generatePlayerLoadData = function (e, n) {
            ...
            return (
              a.isHiveOptimized(e.optimizationToken) &&
                ((o.optimizationToken = e.optimizationToken),
                (this.relativeStart = e.relativeStart)),
              o
            );
          }),
          (n.prototype.loadClipIntoComponent = function (e) {
            a.isHiveOptimized(e.optimizationToken)
              ? this.loadHiveTicketIntoPlayer(e, null)
              : t.prototype.loadClipIntoComponent.call(this, e);
          }),
    ...
    !(function (e) {
      !(function (t) {
        var n = (function () {
          function t() {}
          return (
            (t.getHlsJsQualityLevel = function (t, n) {
              if (t <= 0) return -1;
              var o;
              switch (n) {
  ...
  (PanoptoLegacy.Viewer.Players.SilverlightPlayer = function (e, t) {
    var n,
      ...
      s,
      l = PanoptoTS.Viewer.Constants,
      c = Panopto.Viewer.PlayState,
      d = 0,
      u = function (e, t) {
        (n.Position = e), (d = void 0), t && t();
      },
      p = function (e) {
        switch (e) {
          case c.Playing:
        ...
        content: function (c) {
          try {
            ...
            Silverlight.createObjectEx({
              ...
              events: {
                onLoad: function (e) {
                  ((n = e.getHost().content.SilverlightPlayer).ContentUrl =
                    c.url),
                    c.httpUrl && (n.HttpUrl = c.httpUrl),
                    d && u(d, void 0),
                    o && p(o),
                    i && h(i),
                    void 0 !== r && m(r),
              ...
              initParams: Panopto.Core.StringHelpers.serializeObjectToInitParams(
                {
                  ...
                  accentColor: Panopto.Core.UI.Color.parse(
                    Panopto.branding.accentColor
                  ).toHex(),
                  safetyAccent: Panopto.Core.UI.Color.parse(
                    Panopto.branding.accentColor
                  )
                    .getSafety()
                    .toHex(),
                  exitFullScreenText:
                    Panopto.GlobalResources.ViewerPlus_ExitFullScreen,
                }
              ),
            });
          }
          ...
          i = (function () {
            ...
            return (
              (e.prototype.width = function () {
                return this.streamPlayer && this.streamPlayer.isInitialized
                  ? this.videoElement.videoWidth || this.$container.width()
                  : this.$container.width() || 16;
              }),
              (e.prototype.height = function () {
                return this.streamPlayer && this.streamPlayer.isInitialized
                  ? this.videoElement.videoHeight || this.$container.height()
                  : this.$container.height() || 9;
              }),
              (e.prototype.ended = function () {
                var e;
                return (
                  (null === (e = this.streamPlayer) || void 0 === e
                    ? void 0
                    : e.isEnded) || !1
                );
              }),
              ...
              (e.prototype.isFullscreen = function (e) {
                return (
                  !!this.streamPlayer &&
                  (void 0 !== e &&
                    e !== this.streamPlayer.fullscreen &&
                    (this.streamPlayer.fullscreen = e),
              ...
              (e.prototype.content = function (e, t, n) {
                var i = this,
                  a = this.streamPlayer;
                if (a)
                  if ((a.isPlaying && a.pause(), a.id === e.id))
                    o.info(
                      "[SingleStreamMediaPlayer.content] Same ID we are currently viewing"
                    );
                  else if (void 0 !== this.cache[e.id]) {
                    o.info(
                      "[SingleStreamMediaPlayer.content] Pulling player out of the cache"
                    );
                ...
                this.streamPlayer &&
                  (t
                    ? (this.streamPlayer.dispose(),
                      (this.streamPlayer = null),
                      o.info(
                        "[SingleStreamMediaPlayer.content] Forcing reload"
                      ))
                    : n && n()),
                  this.streamPlayer ||
                    ((this.streamPlayer = new PanoptoViewer.SingleStreamPlayer(
                      e,
                      this.containerDiv,
                      this.videoElement,
                      this.startPosition,
                      function () {
                        if (
                          ...
                          if (
                            i.videoElement.videoWidth &&
                            i.videoElement.videoHeight
                          )
                            i.helpers.resize();
                          else {
                            o.info(
                              "[SingleStreamMediaPlayer] Deferring resize until dimensions are available"
                            );
                            var e = function () {
                              i.videoElement.videoWidth &&
                                i.videoElement.videoHeight &&
                                (i.helpers.resize(),
                                i.videoElement.removeEventListener(
                                  "progress",
                                  e
                                ));
                            };
                          ...
                          o.error(
                            "[SingleStreamMediaPlayer] this.helpers.resize() is missing"
                          );
                      }
                    )),
                    ...
                    this.isPrimary
                      ? ((this.streamPlayer.volume = this.playerVolume),
                        (this.streamPlayer.muted = this.playerMuted),
                        (this.streamPlayer.playbackRate = this.playerSpeed))
                      : (this.streamPlayer.muted = !0));
              }),
              (e.prototype.position = function (e, t) {
                return void 0 !== e
                  ? (this.streamPlayer &&
                      this.streamPlayer.setStreamPosition(e, t),
                    e)
                  : this.streamPlayer
                  ? this.streamPlayer.anticipatedPosition
                  : 0;
              }),
              ...
              (e.prototype.playState = function (e) {
                this.streamPlayer
                  ...
                  : o.error(
                      "[SingleStreamMediaPlayer.playState] setting playstate before initialized!"
                    );
              }),
              ...
              (e.prototype.bitrate = function (e) {
                this.streamPlayer &&
                  (this.streamPlayer.bitrateIndex = t.HlsHelpers.getHlsJsQualityLevel(
                    this.streamPlayer.bitrateOptions.length,
                    e
                  ));
              }),
              (e.prototype.volume = function (e) {
                var t = this;
                this.isPrimary
                  ? ((this.playerVolume = e / 100),
                    this.applyToPlayers(function (e) {
                      e.volume = t.playerVolume;
                    }))
                  : o.error(
                      "[SingleStreamMediaPlayer] Setting volume on a secondary. Ignoring."
                    );
              }),
              (e.prototype.muted = function (e) {
                ...
                this.isPrimary
                  ...
                  : o.error(
                      "[SingleStreamMediaPlayer] Setting muted on a secondary. Ignoring."
                    );
              }),
              (e.prototype.syncPlayState = function (e) {}),
              (e.prototype.syncTimes = function (e, t) {}),
              ...
              (e.prototype.optimizationProvider = function () {
                var e;
                return (
                  (null === (e = null == this ? void 0 : this.streamPlayer) ||
                  void 0 === e
                    ? void 0
                    : e.optimizationProvider) || ""
                );
              }),
              (e.prototype.applyToPlayers = function (e) {
                for (
                  var t = 0, n = Object.keys(this.cache);
                  t < n.length;
                  t++
                ) {
                  var o = n[t];
  ...
  (PanoptoLegacy.Viewer.Players.VideoJsPlayer = function (e, t, n) {
    var o,
      ...
      R = [],
      D =
        (Panopto.Viewer.KollectiveFP,
        Panopto.Core.StringHelpers.parseQueryString(
          window.location.search.slice(1),
          !0,
          !0
        ).p2poptimization,
        $("#" + (e ? "primaryBuffering" : "secondaryBuffering"))),
      x = function (e) {
        return e ? "loadedmetadata" : V;
      },
      L = function (e) {
        f &&
          f.flushQualityReport(
            "Flash" === o.techName && e,
            o.currentTime(),
            "Flash" === o.techName && o.level(),
            "Flash" === o.techName && o.numberOfLevels(),
            "Flash" === o.techName && R[o.level()],
      ...
      H = function () {
        return !(
          "Flash" === o.techName && -1 !== o.currentSrc().indexOf(".m3u8")
        );
      },
      B = function (e) {
        var t,
        ...
        ((d &&
          ...
          H()) &&
          (1 === (H() ? o.playbackRate() : 1) && 1 !== e
            ? "Flash" === o.techName &&
              ((t = [d[1]]),
              o.options({ techOrder: ["html5", "flash"] }),
              (T = !0),
              L(!1))
            : 1 === e &&
              T &&
              ((t = d),
              o.options({ techOrder: ["flash", "html5"] }),
              (T = !1),
      ...
      F = function (t) {
        e && o.volume(t / PanoptoTS.Viewer.Constants.MaxVolume), (c = void 0);
      },
      N = function (t) {
      ...
      j = function () {
        "Flash" === o.techName &&
          (o.brandingColors(
            Panopto.Core.UI.Color.parse(Panopto.branding.accentColor).toHex(),
            Panopto.Core.UI.Color.parse(Panopto.branding.accentColor)
              .getSafety()
              .toHex()
          ),
      ...
      Q = function (t, i) {
        ...
        o.src(d),
          e &&
            p.deliveryTitle &&
            Panopto.viewer.ooyalaProviderCode &&
            Ooyala.Analytics.VideojsReporter(
              Panopto.viewer.ooyalaProviderCode,
              o,
              {
                mediaId: PanoptoTS.StringHelpers.format(
                  "{0} ({1})",
                  p.deliveryTitle,
                  p.id
                ),
      ...
      q = function (t) {
        if (o) t();
          ...
          (b = !0),
            Panopto.viewer.detectFlashCrashAndFallBackToHTML &&
              setTimeout(X, 1e3);
          videojs(
            g,
            {
              techOrder: Panopto.Core.Browser.flashEnabled()
                ? ["flash", "html5"]
                : ["html5", "flash"],
              controls: !1,
              preload: "auto",
              autoplay: !1,
              flash: { swf: Panopto.viewer.swfLocation },
              plugins: {},
            },
            function () {
              var i, a;
      ...
      K = function () {
        W ||
          ((window.location.search += PanoptoTS.StringHelpers.format(
            "&{0}=true",
            Panopto.Core.Constants.IgnoreFlashParamKey
          )),
          (W = !0));
      },
      J = function () {
        ...
        var e = D.outerWidth(!0),
          t = D.outerHeight(!0);
        return D.hide(), { bufferingWidth: e, bufferingHeight: t };
      },
      Y = function (e) {
    ...
    return (
      (videojs.options.flash.flashVars = { hls_debug: !1, hls_debug2: !1 }),
      {
        content: function (e, t, o) {
          (d && !t && d[0].src === e.url) ||
            ...
            (d = []),
            Panopto.Core.Browser.isEdge &&
              e.url.indexOf(".m3u8") >= 0 &&
              e.httpUrl &&
              (e.url = ""),
            _.each(
              _.filter([e.url, e.httpUrl], function (e) {
                return e;
              }),
              function (t) {
              ...
              ? (function (e, t) {
                  var o = function (e) {
                    var o = new RegExp("RESOLUTION=(\\d*)x(\\d*)", "i"),
                      ...
                      a = o.exec(e);
                    a && 3 === a.length
                      ? ((I = parseFloat(a[1])), (k = parseFloat(a[2])))
                      : ((I = 0), (k = 0)),
                      (R.length = 0);
                    do {
                      (a = i.exec(e)) &&
                  ...
                  if (
                    ...
                    (window.location.protocol ===
                      Panopto.Core.UrlHelpers.getProtocol(e.url) &&
                      window.location.hostname ===
                        Panopto.Core.UrlHelpers.getHost(e.url))
                  )
                    $.ajax({ url: e.url, success: o });
                  else {
          ...
          var t = (function () {
            function t(e) {
              (this.params = e),
                ...
                (this.animationSpeed =
                  void 0 !== e.animationSpeed ? e.animationSpeed : "fast"),
                this.setEventData(e.commentEvent);
            }
            return (
              (t.prototype.setAsTopLevelComment = function (e) {
              ...
              (t.prototype.updateEvent = function (e) {
                this.eventDataChanged(e) &&
                  (this.setEventData(e), this.render(this.element, !0));
              }),
              ...
              (t.prototype.setEventData = function (t) {
                (this.commentEvent = _.clone(t)),
                  ...
                  (this.sessionTime = e.DiscussionUtils.roundSessionTime(
                    t.time
                  )),
                  (this.text = t.text),
                  (this.id = t.id),
                ...
                var n = this.params.panoptoGlobal.Core.TimeHelpers.toLocalPanoptoTime(
                    this.params.panoptoGlobal.Core.TimeHelpers.formatWin32EpochTimeToDate(
                      this.creationTimeInMillis
                    ),
                    this.params.panoptoGlobal.timeZone
                  ),
                  o = this.params.panoptoGlobal.GlobalResources
                    .ViewerPlus_CommentTimestamp;
                (this.commentTimestamp = o.format(
                  ...
                  (this.creationDateString = this.params.panoptoGlobal.Util.displayDate(
                    n,
                    { format: "long", local: !0 }
                  )),
                  (this.sessionTimestampString = this.params.panoptoGlobal.Core.TimeHelpers.formatDuration(
                    this.sessionTime,
                    this.params.panoptoGlobal.GlobalResources.TimeSeparator
                  ));
              }),
              (t.prototype.render = function (e, n) {
                ...
                if (
                  ...
                  a.show(),
                    this.params.panoptoGlobal.Core.UI.Handlers.button(
                      a,
                      function () {
          ...
          var t = (function () {
            function t(e) {
              ...
              (this.params = e),
                ...
                (this.animationSpeed =
                  void 0 !== e.animationSpeed ? e.animationSpeed : "fast"),
                (this.groupedComments = this.transformEventsToGroupedModel(
                  e.events
                ));
            }
            return (
              (t.prototype.render = function () {
                ...
                for (
                  var e = 0,
                    n = this.groupedCommentsToSortedArray(this.groupedComments);
                  e < n.length;
                  e++
                ) {
                ...
                this.target.append(this.container),
                  $("#commentsTabPane")
                    .find(".event-input")
                    .wrap("<div class='reply-to-hook'></div>");
              }),
              ...
              (t.prototype.scrollCommentIntoView = function (t) {
                ...
                if (o) {
                  ...
                  i.length > 0 &&
                    ...
                    i.animate({ backgroundColor: "transparent" }, "slow"));
                }
              }),
              ...
              (t.prototype.focusNextComment = function (e) {
                var t = $(".threaded-discussion").find(
                  ...
                  n.keydown(function (e) {
                    if (!e.ctrlKey || e.keyCode !== Panopto.Core.Key.UpArrow)
                      if (
                        ...
                        o &&
                          (t.params.onSubmit(o, t.params.event.time),
                          t.remove());
                      }
                  }),
                  this.params.panoptoGlobal.Core.UI.Handlers.button(
                    this.element.find(".cancel-link"),
                    function () {
                      t.remove();
                    }
                  ),
      ...
      !(function (e) {
        !(function (e) {
          var t = (function () {
            function e() {}
            return (
              (e.eventsMatchById = function (e, t) {
                var n = !1;
                return (
                  (e.id || t.id) && e.id === t.id && (n = !0),
                  (e.eventId || t.eventId) &&
                    e.eventId === t.eventId &&
                    (n = !0),
                  n
          ...
          var t = (function () {
            function t(t) {
              ...
              (this.params = t),
                ...
                (this.animationSpeed =
                  void 0 !== t.animationSpeed ? t.animationSpeed : "fast");
              ...
              (this.comment = o[0]),
                (this.nestedComments = []),
                o.length > 1 &&
                  ((this.nestedComments = o.slice(1, o.length)),
                  (this.nestedComments = _.sortBy(
                    this.nestedComments,
            ...
            return (
              (t.prototype.render = function (e, n) {
                ...
                var i = this.params.panoptoGlobal.Core.StringHelpers.format(
                    this.params.panoptoGlobal.GlobalResources
                      .ViewerPlus_Discussion_ReplyCountArialabel,
                    this.nestedComments.length
                  ),
                  a = t.screenreaderOnlyReplyCountTemplate({ replyString: i });
                ...
                _.each(this.nestedComments, function (e) {
                  ...
                  o
                    .find(".reply-expander")
                    .toggle(this.nestedComments.length > 0),
                ...
                if (this.comment.isForEvent(t)) this.comment.updateEvent(t);
                  ...
                  if (n) n.updateEvent(t);
                    ...
                    var o = new e.CommentViewModel({
                        ...
                        eventClickedCallback: this.params.eventClickedCallback,
                        editClickedCallback: this.params.editClickedCallback,
                        deleteClickedCallback: this.params
              ...
              (t.prototype.removeComment = function (e) {
                var t = this,
                  n = !1;
                return (
                  this.comment.isForEvent(e)
                    ? this.nestedComments.length > 0
                      ? ((this.comment = this.nestedComments[0]),
                        this.nestedComments.length > 1
                          ? (this.nestedComments = this.nestedComments.slice(
                              1,
                              this.nestedComments.length
                            ))
                          : (this.nestedComments = []),
              ...
              (t.prototype.removeChildComment = function (e) {
                ...
                void 0 !== t &&
                  (this.nestedComments[t].remove(),
                  this.nestedComments.splice(t, 1),
                  0 === this.nestedComments.length &&
                    this.element.find(".reply-expander").hide(),
                  this.updateReplyCountString());
              }),
              (t.prototype.remove = function () {
                var e = this;
              ...
              (t.prototype.expandComments = function (e) {
                ...
                this.nestedComments.length > 0 &&
                  !this.element.find(".threaded-comments").is(":visible") &&
                  (this.setToggleText(this.element, !0),
                  this.element.find(".threaded-comments").slideToggle(t));
              }),
              (t.prototype.collapseComments = function () {
                this.nestedComments.length > 0 &&
                  this.element.find(".threaded-comments").is(":visible") &&
                  (this.setToggleText(this.element, !1),
                  this.element.find(".threaded-comments").slideToggle("fast"),
                  this.element
                    .find(".top-level-comment .comment-block")
                    .focus());
              }),
              (t.prototype.updateReplyCountString = function () {
                var e = this.params.panoptoGlobal.Core.StringHelpers.format(
                  this.params.panoptoGlobal.GlobalResources
                    .ViewerPlus_ViewReplies,
                  this.nestedComments.length
                );
              ...
              (t.prototype.attachToggleHandlers = function (e) {
                ...
                this.params.panoptoGlobal.Core.UI.Handlers.button(
                  e.find(".expandable"),
                  function () {
                    e.find(".threaded-comments").slideToggle(
                      "fast",
                      function () {
  ...
  (Panopto.viewer = Panopto.viewer || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditContentsTab = function (
    e,
    t,
    n,
    o,
    ...
    var l = PanoptoLegacy.Viewer.Tabs.Editor.EditTOCEventTab(
        e,
        t,
        n,
        Panopto.Viewer.Analytics.EditContents,
        o,
        r,
        [
          Panopto.Core.EventType.Label,
          Panopto.Core.EventType.SlideChange,
          Panopto.Core.EventType.SmartOcrToc,
          Panopto.Core.EventType.CandidateSmartOcrToc,
        ],
        Panopto.GlobalResources.ViewerPlus_Edit_AddTOC,
        s
      ),
      c = Panopto.Core.Extensions.base(l),
      d = t.find(".event-input"),
    ...
    a.eventAdded.add(function (e) {
      var t =
        void 0 !== e.link &&
        -1 !== e.link.indexOf(PanoptoViewer.Constants.YouTubeEmbedBaseUrl);
      e.type !== Panopto.Core.EventType.Label || t || l.openEditDialog(e);
    }),
      (l.addEvent = function (e) {
        c.addEvent(e, Panopto.Core.EventType.Label, { preferSecondary: !0 });
      }),
      (l.position = function (e) {
        u
          ...
          .toggleClass(
            Panopto.Core.Constants.DisabledClass,
            !a.isValidTimeForEmbeddedEvent(e)
          ),
          f.toggleClass(
            Panopto.Core.Constants.DisabledClass,
            !a.isValidTimeForEvent(e)
          ),
          c.position(e);
      }),
      (l.filterForRender = function () {
        var e = c.filterForRender();
        return _.filter(e, function (e) {
      ...
      (l.render = function () {
        var e = o.activeState();
        S(e.sessionReferences), T(l.filterForRender()), E(e.questionLists());
      }),
      (l.openEditDialog = function (e) {
        c.openEditDialog(
          _.find(l.events(), function (t) {
            return t.id === e.id;
          })
        );
      });
    var S = function (e) {
        _.each(e, function (e) {
          v.hasOwnProperty(e.id) || (v[e.id] = C());
          var t = v[e.id];
          t.render(e),
            h.insert(
              t.element,
              e.editorStartTime / Panopto.Core.Constants.TimelineChunkMultiplier
            );
        }),
          _.each(Object.keys(v), function (t) {
            _.some(e, function (e) {
              return e.id === t;
            }) || (h.remove(v[t].element), delete v[t]);
          });
      },
      C = function () {
        var e = new PanoptoTS.Viewer.Tabs.Editor.SessionReferenceRow();
        return (
          e.seekCallbacks.add(function (e) {
            n.setPosition(
              e.editorStartTime / Panopto.Core.Constants.TimelineChunkMultiplier
            );
          }),
          ...
          e.deleteCallbacks.add(function (e) {
            ...
            if (-1 !== a) {
              ...
              _.each(s, function (e) {
                o.activeState()
                  .cuts()
                  .splice(o.activeState().cuts().indexOf(e), 1);
              });
            }
            o.activeState().refreshTimeline(),
              o.applyState(),
              n.setPosition(
                o.activeState().calculateEditorTimeFromAbsolute(t.ticks())
              );
          }),
      ...
      w = function (e, t) {
        o.pushEdit();
        var n = o.activeState().sessionReferences;
        if (
          -1 !==
          _.findIndex(n, function (t) {
            return t.id === e.id;
          ...
          var i,
            a = t.order;
          if (t.start == -1 / 0) i = 0;
          else if (t.start == 1 / 0) i = o.activeState().hostDuration();
          else {
            for (var r = !1, s = 0, l = 0, c = n; l < c.length; l++) {
              var d = c[l],
                u = d.editorStartTime;
              if (u < t.start) {
                var p = d.getTimelineDuration();
                if (((s += p), u + p >= t.start)) {
                  (i = d.start),
                    (r = !0),
                    (a = t.start - u < u + p - t.start ? d.order : d.order + 1),
                    e.start === d.start && e.order < a && a--;
                  break;
                }
              }
            }
          ...
          var f = n.filter(function (t) {
            ...
            y = n
              ...
              .map(function (n) {
                return n.id === e.id
                  ? t.copy(!0, { start: i, order: h })
                  : n.start === i
                  ? (v === h && v++,
                    n.order !== v ? n.copy(!0, { order: v++ }) : (v++, n))
                  : n;
              });
          (n.length = 0),
            n.push.apply(n, y),
    ...
    l.handleSessionReferenceEdit = w;
    var b = function (e) {
        var t = o.activeState().duration();
        (m = new PanoptoTS.Viewer.Dialogs.SessionReferenceEditorDialog(
          0,
          t,
          Panopto.GlobalResources,
          Panopto.ModalPopup.defaultInstance
        )).saveCallbacks.add(function () {
          return w(e);
        }),
          n.toggleScreens(!1),
          m.showDialog(e);
      ...
      T = function (e) {
        _.each(e, function (e) {
          ...
          var t = y[e.id];
          t.render(e), h.insert(t.element, e.editorTime);
        }),
          _.each(Object.keys(y), function (t) {
            _.some(e, function (e) {
              return e.id === t;
            }) || (h.remove(y[t].element), delete y[t]);
          });
      },
      A = function () {
      ...
      E = function (e) {
        _.each(e, function (e) {
          P.hasOwnProperty(e.id) || (P[e.id] = V());
          var t = P[e.id],
            n = r.toUneditedFirstPrimaryRelative(e.firstStreamRelativeTicks);
          t.render(
            { id: e.id, name: e.name, editorTime: n.seconds() },
            { isQuestionList: !0 }
          ),
          ...
          _.each(Object.keys(P), function (t) {
            _.some(e, function (e) {
              return e.id === t;
            }) || (h.remove(P[t].element), delete P[t]);
          });
      },
      V = function () {
        var e = new PanoptoTS.Viewer.Tabs.Editor.EditableEventRow();
    ...
    i &&
      (Panopto.Core.UI.Handlers.button(u, function () {
        var e = l.startTime();
        void 0 === e && (e = n.position()),
          a.isValidTimeForEmbeddedEvent(e) &&
            (o.addQuestionList(g()), l.clearInput());
      }),
      u.show()),
      Panopto.features.disableFeaturesRequiringExternalNetworkAccess &&
        p.hide(),
      Panopto.Core.UI.Handlers.button(p, function () {
        var e =
            g() || Panopto.GlobalResources.ViewerPlus_Edit_YouTubeDefaultName,
          t = l.startTime();
        void 0 === t && (t = n.position()),
          a.isValidTimeForEmbeddedEvent(t) &&
            (a.addYouTubeEvent(e, t), l.clearInput());
      }),
      Panopto.Core.UI.Handlers.button(f, function () {
        var e =
            g() || Panopto.GlobalResources.ViewerPlus_Edit_UrlEventDefaultName,
          t = l.startTime();
        void 0 === t && (t = n.position()),
          a.isValidTimeForEvent(t) && (a.addUrlEvent(e, t), l.clearInput());
      });
    var I = $("#reactSmartChapterControls"),
      k = PanoptoReactComponents.bootstrapReactComponent(
        PanoptoReactComponents.Control.SmartChapterControls
      )(I, {
        toggleEnabled: !0,
        resources: Panopto.GlobalResources,
        statusText: "",
      ...
      R = function (e) {
        k.setProps({ toggleState: e }),
          L(
            e
              ? Panopto.GlobalResources.ViewerPlus_Edit_SmartChapters_Hide
              : Panopto.GlobalResources.ViewerPlus_Edit_SmartChapters_Show
          ),
          o.pushEdit();
        var t = o
            .activeState()
            ...
            .filter(function (t) {
              return e
                ...
                : t.type === Panopto.Core.EventType.SmartOcrToc;
            }),
          n = t.map(function (t) {
            var n = t.copy();
            return (
              (n.id = _.uniqueId("event")),
              (n.name = t.name.substring(
                0,
                PanoptoTS.Viewer.Constants.TOCMaxLength
              )),
              (n.type = e
                ? Panopto.Core.EventType.SmartOcrToc
                : Panopto.Core.EventType.CandidateSmartOcrToc),
      ...
      D = function () {
        L(Panopto.GlobalResources.ViewerPlus_Edit_SmartChapters_Processing),
          x.requestSmartChapters(
            o.session().id,
            function (e) {
              return U();
            },
      ...
      x = new PanoptoTS.API.Rest.SessionService(
        Panopto.Core.ServiceInterface.Rest.Api
      ),
      L = function (e, t) {
        k.setProps({ statusText: e });
      },
      O = function () {
        k.setProps({
          displayState: PanoptoReactComponents.Control.DisplayState.Available,
        }),
          o.activeState().filterEvents(Panopto.Core.EventType.SmartOcrToc)
            .length > 0
            ? (k.setProps({ toggleState: !0 }),
              L(Panopto.GlobalResources.ViewerPlus_Edit_SmartChapters_Hide))
            : o
                .activeState()
                .filterEvents(Panopto.Core.EventType.CandidateSmartOcrToc)
                .length > 0
            ? (k.setProps({ toggleState: !1 }),
              L(Panopto.GlobalResources.ViewerPlus_Edit_SmartChapters_Show))
            : M();
      },
      U = function () {
        L(Panopto.GlobalResources.ViewerPlus_Edit_SmartChapters_Processing),
          k.setProps({
            displayState:
              PanoptoReactComponents.Control.DisplayState.Processing,
          }),
          window.setTimeout(function () {
            x.getSmartChaptersState(
              o.session().id,
              function (e) {
                return H(e.state);
              },
      ...
      M = function () {
        k.setProps({
          ...
          L(Panopto.GlobalResources.ViewerPlus_Edit_SmartChapters_Error);
      },
      H = function (e) {
        (e === AutoInternal.SmartChaptersState.NotProcessed &&
          !0 !== Panopto.viewer.isSmartChapteringEnabled) ||
          (I.show(),
          e === AutoInternal.SmartChaptersState.NoSmartChapters
            ? (k.setProps({
                displayState:
                  PanoptoReactComponents.Control.DisplayState.Ineligible,
                toggleEnabled: !1,
              }),
              L(
                Panopto.GlobalResources
                  .ViewerPlus_Edit_SmartChapters_NoSmartChapters
              ))
            : e === AutoInternal.SmartChaptersState.Available
            ? 0 ===
                o
                  .activeState()
                  .filterEvents(Panopto.Core.EventType.CandidateSmartOcrToc)
            ...
            ? (L(
                Panopto.GlobalResources
                  .ViewerPlus_Edit_SmartChapters_NotProcessed
              ),
              k.setProps({
                displayState:
                  PanoptoReactComponents.Control.DisplayState.NotProcessed,
              }),
              L(
                Panopto.GlobalResources
                  .ViewerPlus_Edit_SmartChapters_NotProcessed
              ))
            : e === AutoInternal.SmartChaptersState.Processing
            ? U()
            : M());
      };
    return (
      (l.refreshSmartChapters = function () {
        var e;
        if (
          o
            .activeState()
          ...
          var t = o.savedEvents().filter(function (e) {
            return (
              e.type === Panopto.Core.EventType.CandidateSmartOcrToc ||
              e.type === Panopto.Core.EventType.SmartOcrToc
            );
          });
          if (
            ...
            (e = o.activeState().events()).push.apply(e, n), I.show(), O();
          } else
            Panopto.viewer.isSmartChapteringEnabled &&
              x.getSmartChaptersState(
                o.session().id,
                function (e) {
                  return H(e.state);
  ...
  (PanoptoLegacy.Viewer.Tabs.Editor.EditCutTab = function (e, t, n, o, i) {
    var a = PanoptoLegacy.Viewer.Tabs.Editor.EditorTab(
        e,
        t,
        n,
        Panopto.Viewer.Analytics.Labels.EditCut,
        o,
        Panopto.GlobalResources.ViewerPlus_Edit_Modal_EditCutTitle,
        i
      ),
      r = Panopto.Core.Extensions.base(a);
    return (
      (a.templateDialog = function (e, t) {
        var n,
          i,
          r,
          s,
        ...
        switch (t.targetType) {
          case Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Session:
            (r = c.calculateEditorTimeForCut(t.start, void 0)),
              (s = c.calculateEditorTimeForCut(t.end(), void 0)),
              (l = Panopto.Core.Constants.SessionIconCode);
            break;
          case Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Stream:
            var d = o.getStream(t.targetId),
              u = c.calculateEditorTimeFromAbsolute(d.absoluteStart),
              p = c.calculateEditorTimeFromAbsolute(d.absoluteEnd());
            (n = o.getStreamName(d, d.id, !0)),
              (i = a.formatTime(u) + " - " + a.formatTime(p, !0)),
              (r = c.calculateEditorTimeForCut(t.start, t.targetId)),
              (s = c.calculateEditorTimeForCut(t.end(), t.targetId)),
              (l = PanoptoTS.Viewer.Controls.MaterialDesignIconHelpers.getStreamIconCode(
                d
              ));
            break;
          case Panopto.Core.ServiceInterface.Rest.Objects.TypeName
            .SessionReference:
            var f = _.find(c.sessionReferences, function (e) {
                return e.id === t.targetId;
              }),
              h =
                c.calculateSessionReferenceEditorStartTime(f) /
                Panopto.Core.Constants.TimelineChunkMultiplier,
              m = h + f.referencedSessionDuration;
            (n = f.name),
              (i = a.formatTime(h) + " - " + a.formatTime(m)),
              (r = c.calculateEditorTimeForCutInClip(t.start, t.targetId)),
              (s = c.calculateEditorTimeForCutInClip(t.end(), t.targetId)),
              (l = Panopto.Core.Constants.SessionIconCode);
        }
        e.html(
          _.template($("#editCutTemplate").html())({
            cut: {
              streamName: n,
              streamLength: i,
              startTime: a.formatTime(
                r / Panopto.Core.Constants.TimelineChunkMultiplier
              ),
              endTime: a.formatTime(
                s / Panopto.Core.Constants.TimelineChunkMultiplier
              ),
              streamIconCode: l,
            },
          })
      ...
      (a.hasChanges = function (e, t) {
        var n = o.activeState(),
          i =
            n.calculateEditorTimeForCut(t.start, t.targetId) /
            Panopto.Core.Constants.TimelineChunkMultiplier,
          r =
            n.calculateEditorTimeForCut(t.end(), t.targetId) /
            Panopto.Core.Constants.TimelineChunkMultiplier;
        return (
          e.find(".edit-cut-start-time").val() !== a.formatTime(i) ||
          e.find(".edit-cut-end-time").val() !== a.formatTime(r)
        );
      }),
      (a.validate = function (e, t) {
        ...
        if (
          (e.find(".edit-cut-start-time-error").text(i || ""),
          e.find(".edit-cut-end-time-error").text(r || ""),
          (n = !i && !r))
        ) {
          var s = Panopto.Core.TimeHelpers.durationFromFormattedString(
            e.find(".edit-cut-start-time").val(),
            Panopto.GlobalResources.TimeSeparator
          );
          (n =
            Panopto.Core.TimeHelpers.durationFromFormattedString(
              e.find(".edit-cut-end-time").val(),
              Panopto.GlobalResources.TimeSeparator
            ) > s),
            e
              .find(".edit-cut-end-time-error")
              .text(
                n
                  ? ""
                  : Panopto.GlobalResources.ViewerPlus_Edit_Modal_CutEndError
              );
        }
        return n;
      }),
      (a.populateEvent = function (e, t) {
        var n =
          ...
          c = s.calculateRelativeTimeForCut(r, t.targetId);
        o.resizeCut(i, l, c, n, t.targetType);
      }),
      (a.render = function () {
        var e = _.map(a.events(), function (e) {
          ...
          switch (e.targetType) {
            case Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Session:
              ...
              break;
            case Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Stream:
              var c = o.getStream(e.targetId);
              (t = l.calculateEditorTimeForCut(e.start, e.targetId)),
                (n = l.calculateEditorTimeForCut(e.end(), e.targetId)),
                (i = o.getStreamName(c, e.targetId, !0)),
                (a = !c.isPrimary),
                (r = !c.isPrimary),
                (s = PanoptoTS.Viewer.Controls.MaterialDesignIconHelpers.getStreamIconCode(
                  c
                ));
              break;
            case Panopto
              .Core.ServiceInterface.Rest.Objects.TypeName.SessionReference:
              var d = _.find(l.sessionReferences, function (t) {
                return t.id === e.targetId;
              });
  ...
  (Panopto.Viewer.Tabs.Editor = Panopto.Viewer.Tabs.Editor || {}),
  (Panopto.viewer = Panopto.viewer || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditDetailsTab = function (
    e,
    t,
    n,
    o,
    ...
    var y = Panopto.features.tagsEnabled
        ? PanoptoTS.Viewer.Data.TagHelper.convertDeliveryToModel(c)
        : [],
      P = Panopto.DetailsTab($("#editDetailsTab"), {
        ...
        onSessionNameUpdate: function (e) {
          return n.updateSessionName(e, { fromHeader: !1 });
        },
      });
    n.addSessionNameUpdateListener(function (e) {
      return P.setProps({ name: e });
    });
    var g = PanoptoLegacy.Viewer.Tabs.Editor.EditTOCEventTab(
        e,
        t,
        o,
        Panopto.Viewer.Analytics.EditContents,
    ...
    return (
      (g.onSelectChangeRendered = function (e) {
        var t = e.selected;
        return P.setProps({ isVisible: t });
      }),
      (g.resize = function (e, t) {
        S.resize(e, t), P.setProps({ tabWidth: e, tabHeight: t });
      }),
      g
    );
  }),
  ...
  (Panopto.Viewer.Tabs = Panopto.Viewer.Tabs || {}),
  (Panopto.Viewer.Tabs.Editor = Panopto.Viewer.Tabs.Editor || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditEventTab = function (
    e,
    t,
    n,
    o,
    ...
    var d,
      u,
      p,
      f = PanoptoLegacy.Viewer.Tabs.Editor.EditorTab(e, t, n, o, i, s, c),
      h = f,
      m = Panopto.Core.Extensions.base(f),
      v = t.find(".event-input"),
      y = t.find(".event-input-options"),
      P = {},
      g = function (e) {
        e.keyCode === Panopto.Core.Key.Space &&
          e.shiftKey &&
          (e.preventDefault(), n.hotkey(e.keyCode));
      },
      S = function (e, t) {
      ...
      C = function () {
        (d = n.position()), (u = n.activePrimary().id);
        var e = n.activeSecondary();
        e &&
          _.find(i.activeState().streams(), function (t) {
            return t.id === e.id;
          }) &&
          (p = e.id);
      },
      w = function () {
        var e = $.trim(v.val());
        e && void 0 === d ? C() : e || h.clearStartTime();
      };
    (h.clearStartTime = function () {
      (d = void 0), (u = void 0), (p = void 0);
    }),
      (h.filterForRender = function (e) {
        return _.filter(f.events(), function (t) {
          return (
            _.contains(r, t.type) && e == t.language && !t.isDefaultThumbnail
          );
        });
      }),
      ...
      (h.eventTimeFromFormattedString = function (e) {
        var t = Panopto.Core.TimeHelpers.durationFromFormattedString(
            e,
            Panopto.GlobalResources.TimeSeparator
          ),
          n = new PanoptoTS.Core.Logic.Time.UneditedFirstPrimaryRelative(
            t * Panopto.Core.Constants.TimelineChunkMultiplier
          );
      ...
      (h.clearInput = function () {
        v.val(""), h.clearStartTime(), v.attr("placeholder", l);
      }),
      (h.addEvent = function (e, t, n) {
        ...
        void 0 === d && C();
        var m = !0;
        if (i.activeState().isTimeInSessionReference(d)) {
          var v = i.activeState().findNextTimeNotInSessionReference(d);
          if (v >= i.activeState().duration())
            ...
            o = v;
            var y = new PanoptoTS.Core.Logic.Time.UneditedFirstPrimaryRelative(
                v
              ),
        ...
        } else o = d * Panopto.Core.Constants.TimelineChunkMultiplier;
        if (m) {
      ...
      (f.resize = function (e, t) {
        v.width(e - PanoptoTS.Viewer.Constants.InputMargin),
          ...
          m.resize(
            e,
            t -
              (v.length ? v.outerHeight(!0) : 0) -
              (y.length ? y.outerHeight(!0) : 0)
          );
      }),
      ...
      v.length &&
        ...
        v.keydown(function (e) {
          e.keyCode === Panopto.Core.Key.Enter &&
            (e.preventDefault(),
            w(),
            void 0 !== d && h.addEvent($.trim(v.val()), void 0, {})),
            e.stopPropagation();
        }),
        v.keydown(g)),
    ...
    return h.toggleControlsRequiringPrimaryStream(), h;
  });
__extends =
  (this && this.__extends) ||
  (function () {
...
!(function (e) {
      ...
      !(function (t) {
        var n = (function () {
          function t() {
            ...
            (this._seekCallbacks = new PanoptoCore.TypedCallback()),
              ...
              (this.eventDisplayTime = this.element.find(
                ".event-display-time"
              )),
              Panopto.Core.UI.Handlers.button(this.element, function () {
          ...
          return (
            Object.defineProperty(t.prototype, "seekCallbacks", {
              get: function () {
            ...
            (t.prototype.render = function (t, n) {
              this.event = t;
              var o = Panopto.Core.TimeHelpers.formatDuration(
                t.editorTime,
                Panopto.GlobalResources.TimeSeparator
              );
              ...
              var i =
                  n && n.isQuestionList
                    ? Panopto.Core.Constants.QuestionListIconCode
                    : void 0,
                a = this.isYoutubeEvent(t)
                  ? e.Viewer.Constants.YouTubeIconClass
                  : this.isSmartChapterEvent(t)
                  ? e.Viewer.Constants.SmartChapterIconClass
                  : void 0;
        ...
        var o = (function (t) {
          function n() {
            ...
            return (
              (n._editCallbacks = new PanoptoCore.TypedCallback()),
              ...
              n.eventInput.onChanged.add(function (e) {
                n._changedCallbacks.fire({ event: n.event, name: e });
              }),
              n.eventInput.onBlur.add(function () {
                n.element.removeClass("focused");
              }),
              (n.editEventMenu = new e.Viewer.Controls.EditEventMenu(
                n.element,
                n.element.find(".event-edit-toggle"),
                Panopto.GlobalResources,
                { toggleAppearsOnHover: !0 }
              )),
  ...
  (PanoptoLegacy.Viewer.Tabs.Editor.EditorTab = function (e, t, n, o, i, a, r) {
    var s = PanoptoLegacy.Viewer.Tabs.EventTab(
        e,
        t,
        n,
        void 0,
      ...
      l = s,
      c = Panopto.Core.Extensions.base(s),
      d = t.find(".event-tab-pane-header"),
      u = [],
      p = t.find(".event-tab-list");
    return (
      (l.templateDialog = function (e, t) {
        $.noop();
      }),
      ...
      (l.formatTime = function (e, t) {
        return Panopto.Core.TimeHelpers.formatDuration(
          e,
          Panopto.GlobalResources.TimeSeparator,
          !0,
          Panopto.Core.Constants.DisplayTimeMillisecondPrecision,
      ...
      (l.validateTime = function (e, t, n) {
        ...
        return (
          e
            ? Panopto.Core.TimeHelpers.validateFormattedDuration(
                e,
                Panopto.GlobalResources.TimeSeparator,
                Panopto.Core.Constants.DisplayTimeMillisecondPrecision
              )
              ? n ||
                ((r = t
                  ? _.find(i.activeState().streams(), function (e) {
                      return e.id === t;
                    })
                  : void 0)
                  ? ((s = i
                      .activeState()
                      .calculateEditorTimeFromAbsolute(r.absoluteStart)),
                    (c = i
                      .activeState()
                      .calculateEditorTimeFromAbsolute(r.absoluteEnd())))
                  : ((s = 0),
                    (c =
                      i.activeState().duration() /
                      Panopto.Core.Constants.TimelineChunkMultiplier)),
                (s =
                  Math.floor(
                    s *
                ...
                (c =
                  ...
                  PanoptoTS.Viewer.Constants.DisplayTimePrecisionMultiplier),
                ((a = Panopto.Core.TimeHelpers.durationFromFormattedString(
                  e,
                  Panopto.GlobalResources.TimeSeparator
                )) < s ||
                  a > c) &&
                  (o = Panopto.GlobalResources.ViewerPlus_Edit_Modal_Error_OutOfBounds.format(
                    l.formatTime(s),
                    l.formatTime(c)
                  )))
              : (o =
                  Panopto.GlobalResources
                    .ViewerPlus_Edit_Modal_Error_InvalidTime)
            : (o = Panopto.GlobalResources.ViewerPlus_Edit_Modal_Error_NoTime),
          o
        );
      }),
      (l.openEditDialog = function (e, t) {
        ...
        n.toggleScreens(!1),
          ...
          Panopto.ModalPopup.defaultInstance.closeCriteria.push(function () {
            return (
              !l.hasChanges(o, e) ||
              confirm(Panopto.GlobalResources.ViewerPlus_Edit_Modal_Confirm)
            );
          }),
      ...
      (l.render = function (e) {
        var t = !1,
          n = !0;
        0 === c.events().length && ((t = !0), (n = !1)),
          c.render(e, t, !1, n, !0);
      }),
      (l.afterRenderItem = function (e, t, n) {
        c.afterRenderItem(e, t, n);
        var o = new PanoptoTS.Viewer.Controls.EditEventMenu(
          t,
          t.find(".event-edit-toggle"),
          Panopto.GlobalResources,
          { toggleAppearsOnHover: !0 }
        );
        o.editCallbacks.add(function (e) {
          l.openEditDialog(
            _.find(s.events(), function (t) {
              return e.id === t.id;
            })
          );
        }),
  ...
  (Panopto.Viewer.Tabs = Panopto.Viewer.Tabs || {}),
  (Panopto.Viewer.Tabs.Editor = Panopto.Viewer.Tabs.Editor || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditQuestionListTab = function (
    e,
    t,
    n,
    o,
    ...
    var s = PanoptoLegacy.Viewer.Tabs.Editor.EditorTab(
        e,
        t,
        n,
        Panopto.Viewer.Analytics.Labels.EditQuestionList,
        o,
        void 0,
        r
      ),
    ...
    (s.render = function () {
      var e = _.map(s.events(), function (e) {
        ...
        return {
          ...
          eventId: e.id,
          time: t.seconds(),
          displayTime: Panopto.Core.TimeHelpers.formatDuration(
            t.seconds(),
            Panopto.GlobalResources.TimeSeparator
          ),
          text: e.name,
      ...
      (s.position = function (e) {
        l.toggleControlsRequiringPrimaryStreamOrEvent(e), c.position(e);
      }),
      (l.toggleControlsRequiringPrimaryStreamOrEvent = function (e) {
        d.toggleClass(
          Panopto.Core.Constants.DisabledClass,
          !u || !a.isValidTimeForEmbeddedEvent(e)
        );
      }),
      Panopto.Core.UI.Handlers.button(d, function () {
        d.hasClass(Panopto.Core.Constants.DisabledClass) ||
          o.addQuestionList(void 0);
      });
  ...
  (Panopto.Viewer.Tabs = Panopto.Viewer.Tabs || {}),
  (Panopto.Viewer.Tabs.Editor = Panopto.Viewer.Tabs.Editor || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditSlidesTab = function (
    e,
    t,
    n,
    o,
    ...
    var l,
      c = Panopto.Viewer.Analytics.EditSlides,
      d = PanoptoLegacy.Viewer.Tabs.Editor.EditTOCEventTab(
        e,
        t,
        n,
        c,
      ...
      y = function (e) {
        var t = $.Deferred();
        return (
          Panopto.Core.ServiceInterface.Rest.SlideDecks.getAllSlides(
            e.id,
            function (n) {
              (f[e.id] = n), t.resolve(n);
            },
            function () {
              t.reject();
            }
      ...
      P = function (e) {
        var t = new PanoptoTS.Viewer.Tabs.Editor.SlideDeckRow(d.$eventList);
        return (
          t.slideDeckDeletedCallbacks.add(function () {
            var t, n;
            o.pushEdit(),
          ...
          t.slideEventAddCallbacks.add(function (e) {
            ...
            if (o.activeState().isTimeInSessionReference(i)) {
              ...
              if (s >= o.activeState().duration())
                alert(
                  Panopto.GlobalResources
                    .ViewerPlus_EventTab_EventDuringClipAtEnd
                ),
                  (a = !1),
                  d.clearStartTime();
              else
            ...
            if (a) {
              var l = new PanoptoTS.Core.Logic.Time.UneditedFirstPrimaryRelative(
                  t
                ),
                c = Panopto.Core.ServiceInterface.Rest.Objects.Event({
                  name: e.name,
                  metadata: e.content,
      ...
      g = function (e) {
        var t = _.filter(d.events(), function (t) {
          return (
            t.type === Panopto.Core.EventType.SlideChange && t.slideId === e.id
          );
        });
        return (
          _.each(t, function (t) {
            t.slideDeckId || (t.slideDeckId = e.slideDeckId),
              (t.displayTime = Panopto.Core.TimeHelpers.formatDuration(
                t.editorTime,
                Panopto.GlobalResources.TimeSeparator
              ));
          }),
    ...
    a.onReady.add(function (e) {
      _.each(e, function (e) {
        ...
        u.hasAnyUploadingRow() && n.fireTabSelected(d);
    }),
      ...
      a.onComplete.add(function (e) {
        ...
        C(e),
          ...
          (l = t.promise()),
          d.render(void 0, void 0, void 0, void 0, void 0);
      }),
    ...
    var S = function (e) {
        if (!m.hasOwnProperty(e.uploadId)) {
          var t = new (i.debug
            ? PanoptoTS.Viewer.Tabs.Editor.PendingUploadRowDebug
            : PanoptoTS.Viewer.Tabs.Editor.PendingUploadRow)(
            Panopto.GlobalResources.ViewerPlus_Edit_InvalidSlideDeck,
            Panopto.GlobalResources
          );
    ...
    return (
      ...
      (u.setSlideDecks = function (e) {
        (l = v(e)), d.render(void 0, void 0, void 0, void 0, void 0);
      }),
      u
    );
  }),
  ...
  (Panopto.Viewer.Tabs = Panopto.Viewer.Tabs || {}),
  (Panopto.Viewer.Tabs.Editor = Panopto.Viewer.Tabs.Editor || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditStreamTab = function (
    e,
    t,
    n,
    o,
    ...
    var c = $(".add-streams"),
      d = Panopto.Core.StringHelpers.parseQueryString(
        window.location.search.slice(1)
      ),
      u = PanoptoLegacy.Viewer.Tabs.Editor.EditorTab(
        e,
        t,
        n,
        Panopto.Viewer.Analytics.Labels.EditStream,
        o,
        Panopto.GlobalResources.ViewerPlus_Edit_Modal_EditStreamTitle,
        l
      ),
      p = u,
      f = Panopto.Core.Extensions.base(u),
      h = new PanoptoTS.Viewer.Tabs.Editor.EditStreamList(
        Panopto.GlobalResources.ViewerPlus_Edit_Primary
      ),
      m = new PanoptoTS.Viewer.Tabs.Editor.EditStreamList(
        Panopto.GlobalResources.ViewerPlus_Edit_Secondary
      );
    u.$eventList.append(h.element).append(m.element);
    var v = _.template($("#editStreamTemplate").html()),
      ...
      C = {};
    Panopto.Core.UI.Handlers.button(c, function () {
      c.hasClass(Panopto.Core.Constants.DisabledClass) ||
        o.streamTab().showUploadOverlay({ secondaryOnly: !1 });
    });
    var w = $("#deletingEventsPopupWrapper"),
      b = PanoptoReactComponents.bootstrapReactComponent(
        PanoptoReactComponents.Input.DeletingEventsDialog
      )(w, {
        isOpen: !1,
        eventsToDelete: [],
        ...
        if (!C.hasOwnProperty(e.uploadId)) {
          var t = R(e.streamType),
            n = new (i.debug
              ? PanoptoTS.Viewer.Tabs.Editor.PendingUploadRowDebug
              : PanoptoTS.Viewer.Tabs.Editor.PendingUploadRow)(
              Panopto.GlobalResources.ViewerPlus_Edit_InvalidStreamFile,
              Panopto.GlobalResources
            );
          n.onPendingUploadDeleting.add(function (e) {
            ...
            (C[e.uploadId] = n),
            t.addPendingUploadRow(
              n,
              Panopto.Core.TimeHelpers.dateToWin32EpochTime(e.startTime)
            );
        }
      ...
      I = function () {
        o.overlayController.updateOverlayProcessing(
          _.map(_.values(C), function (e) {
      ...
      k = function (e) {
        ...
        n.synchronize(!0),
          !t || a || e
            ? p.showUploadOverlay({ secondaryOnly: t && a })
            : (o.overlayController.forceCloseOverlays(),
              (n.viewMode() === PanoptoTS.Viewer.ViewMode.Primary || i) &&
                o.overlayController.toggleSecondaryPlaceholder(!1)),
          p.hasAnyUploadingRow() && (n.fireTabSelected(u), I());
      },
      R = function (e) {
        var t;
        switch (e) {
      ...
      D = function (e) {
        var t,
          n = o.activeState().firstPrimaryOffset(),
          i = [],
          a = [],
          r = (function (e, t, n) {
            var i,
              ...
              t.isPrimary && t.id === e
                ...
                ? t.isPrimary && t.id !== e
                  ? (a++,
                    ...
                    (r = Math.min(r, t.absoluteStart)))
                  : (s = Math.min(s, t.absoluteStart))
                : (i = t);
            });
            var d = Math.max(0, r - s);
            if (!i || !a)
              return { case: PanoptoViewer.StreamDeleteCase.Unexpected };
            var p =
              o
                .activeState()
                .events()
                .filter(function (e) {
                  return (
                    e.streamId === i.id &&
                    e.type === Panopto.Core.EventType.Caption
                  );
                }).length > 0;
            return i.isPrimary
              ? 1 === a
                ...
                : (u
                    ...
                    .forEach(function (e) {
                      var t = o
                          .activeState()
                          .calculateEditorTimeFromAbsolute(e.absoluteStart),
                        n = o
                          .activeState()
                          .calculateEditorTimeFromAbsolute(
                            e.absoluteStart + e.duration
                          );
                      (l = Math.min(l, t)), (c = Math.max(c, n));
                    }),
                  t.push.apply(
                    t,
                    o
                      ...
                      .filter(function (e) {
                        var t =
                          e.firstStreamRelativeTicks.ticks() /
                          Panopto.Core.Constants.TimelineChunkMultiplier;
                        return t < l || t > c;
                      })
                  ),
                        ...
                        return (
                          !(
                            ...
                            -1 ===
                              e.link
                                .toLowerCase()
                                .indexOf("www.youtube.com/embed")
                          ) &&
                          (e.editorTime < l || e.editorTime > c)
                        );
                      })
                  ),
                  {
            ...
            if (f || i.length || a.length) {
              ...
              b.setProps({
                ...
                handleButtonClick: function (t) {
                  b.setProps({ isOpen: !1 }), t && x(e, s, l, c, d, p, n, i, a);
                },
              });
            } else x(e, s, l, c, d, p, n, i, a);
          else
            window.alert(
              Panopto.GlobalResources
                .ViewerPlus_Edit_DeleteStream_DeletingOnlyPrimary
            );
      },
      x = function (e, t, n, i, a, r, s, l, c) {
        o.pushEdit();
        var d,
          p,
          f,
        ...
        o
          ...
          t === PanoptoViewer.StreamDeleteCase.ActivePrimary
            ? (function (e, t, n, i, a, r) {
                ...
                var l = g.computeActiveSegments(
                  ...
                  d = g.computeNewStreamCuts(
                    ...
                    c,
                    l,
                    PanoptoTS.Viewer.Constants.StreamDeleteCutTolerance *
                      Panopto.Core.Constants.TimelineChunkMultiplier
                  );
                r.push.apply(r, d),
                  o
                  ...
                  (s = o.activeState().cuts()).push.apply(s, c);
                var u = o
                    .activeState()
                    .cuts()
                    .filter(function (e) {
            ...
            : t === PanoptoViewer.StreamDeleteCase.Secondary &&
              (function (e, t) {
                e !== t &&
                  o
                    .activeState()
          ...
          o
            ...
            .forEach(function (e) {
              if (
                e.type === Panopto.Core.EventType.Label &&
                e.link &&
                -1 !== e.link.toLowerCase().indexOf("www.youtube.com/embed")
              ) {
              ...
              o.activeState()
                .events()
                .splice(o.activeState().events().indexOf(e), 1);
            }),
          p.forEach(function (e) {
            for (
              var t = o.activeState().events(), n = -1, i = 0;
              i < t.length;
              i++
            )
              if (t[i].id === e.id) {
          ...
          f.forEach(function (e) {
            for (
              var t = o.activeState().questionLists(), n = -1, i = 0;
              i < t.length;
              i++
            )
              if (t[i].id === e.id) {
        ...
        u.events().splice(u.events().indexOf(m), 1),
          o.activeState().refreshTimeline(),
          o.applyState(),
          m.isPrimary && o.setViewerPosition(0);
      };
    return (
      (u.templateDialog = function (e, t) {
        var n = [];
          ...
          e.html(
            v({
              stream: {
                ...
                displayType: t.isPrimary
                  ? Panopto.GlobalResources.ViewerPlus_Edit_Primary
                  : Panopto.GlobalResources.ViewerPlus_Edit_Secondary,
                length: Panopto.Core.TimeHelpers.formatDuration(
                  t.duration / Panopto.Core.Constants.TimelineChunkMultiplier,
                  Panopto.GlobalResources.TimeSeparator,
                  !1,
                  Panopto.Core.Constants.DisplayTimeMillisecondPrecision
                ),
                startTime: u.formatTime(
                  u.toTimelineRelativeTime(t.absoluteStart)
                ),
      ...
      (u.hasChanges = function (e, t) {
        ...
        return (n =
          (n =
            (n =
              n ||
              e.find(".edit-stream-time").val() !==
                u.formatTime(u.toTimelineRelativeTime(t.absoluteStart))) ||
            e.find(".edit-stream-normalize-volume").is(":checked") !==
              t.normalizeVolume) ||
          parseInt(e.find(".edit-stream-vr-type").val(), 10) !== t.vrType);
      }),
      ...
      (u.populateEvent = function (e, t) {
        var n,
          i = o.activeState().absoluteStart(),
          a = o.activeState().firstPrimaryOffset(),
          r = Panopto.Core.TimeHelpers.durationFromFormattedString(
            e.find(".edit-stream-time").val(),
            Panopto.GlobalResources.TimeSeparator
          ),
          l = new PanoptoTS.Core.Logic.Time.UneditedFirstPrimaryRelative(
            r * Panopto.Core.Constants.TimelineChunkMultiplier
          ),
          c = s.toWin32EpochRelative(l),
          d = c.ticks() - t.absoluteStart,
          u = function (e) {
            var t = [];
            e &&
              (_.each(o.activeState().cuts(), function (n) {
                n.targetType ===
                  Panopto.Core.ServiceInterface.Rest.Objects.TypeName.Session &&
                  (n.end() + e <= o.activeState().firstPrimaryOffset() ||
                  n.start + e >= o.activeState().hostDuration()
                    ? t.push(n)
                    : ((n.start = Math.max(
                        n.start + e,
                        o.activeState().firstPrimaryOffset()
                      )),
                      (n.duration = Math.min(
                        n.duration,
                        o.activeState().hostDuration() - n.start
                      ))));
              }),
              _.each(t, function (e) {
                o.activeState()
        ...
        if (
          ((t.name = e.find(".edit-stream-name").val()),
          (t.absoluteStart = c.ticks()),
          (t.normalizeVolume = e
            .find(".edit-stream-normalize-volume")
            .is(":checked")),
          ...
          _.each(o.activeState().events(), function (e) {
            e.streamId === t.id && ((e.timelineTime += d), (e.edited = !0));
          });
          var p = o.activeState().absoluteStart() - i;
          u(p || o.activeState().firstPrimaryOffset() - a),
            t.isPrimary &&
              ((n = _.filter(o.activeState().cuts(), function (e) {
                return e.targetId === t.id;
              })),
              _.each(n, function (e) {
                o.activeState()
      ...
      (u.render = function () {
        _.each(u.events(), function (e) {
          ...
          var r =
            Panopto.viewer.isEditorStreamDeleteEnabled ||
            "true" === d.deleteStream;
          i.addStreamRow(S[t.id], t.absoluteStart),
            S[t.id].render(o.activeState(), t, r);
        }),
      ...
      (p.showUploadOverlay = function (e) {
        var t = (void 0 === e ? {} : e).secondaryOnly,
          i = void 0 !== t && t;
        o.overlayController.showOverlays(
          E(),
          V(),
          _.map(_.values(C), function (e) {
            return e.pendingUpload;
  ...
  (Panopto.Viewer.Tabs = Panopto.Viewer.Tabs || {}),
  (Panopto.Viewer.Tabs.Editor = Panopto.Viewer.Tabs.Editor || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditTOCEventTab = function (
    e,
    t,
    n,
    o,
    ...
    var c = PanoptoLegacy.Viewer.Tabs.Editor.EditEventTab(
        e,
        t,
        n,
        o,
        ...
        a,
        r,
        Panopto.GlobalResources.ViewerPlus_Edit_Modal_EditTOCTitle,
        s,
        l
      ),
      d = Panopto.Core.Extensions.base(c),
    ...
    return (
      (c.templateDialog = function (e, t) {
        var n = function () {
          var n,
            o = [];
          if (
            c.validateTime(e.find(".edit-contents-time").val(), void 0, void 0)
          )
            o.push(
              _.find(i.activeState().streams(), function (e) {
            ...
            var a = c.valueChanged(
              e.find(".edit-contents-time"),
              c.formatEventTime(t)
            )
              ? c.eventTimeFromFormattedString(
                  e.find(".edit-contents-time").val()
                )
              : t.timelineTime;
            o = i.activeState().activeStreams(a);
          }
          e.find(".edit-contents-stream").html(
            _.template($("#editStreamOptionTemplate").html())({
              streams: _.map(o, function (e) {
                return { id: e.id, displayName: i.getStreamName(e, e.id, !0) };
              }),
            })
          ),
            (n =
        ...
        e.html(
          _.template($("#editContentsTemplate").html())({
            event: {
              name: t.name,
              formattedTime: c.formatEventTime(t),
              thumbnailSrc:
                t.thumbnailUrl ||
                Panopto.cacheRoot + "/Images/no_thumbnail.svg",
          ...
          t.streamId && (n(), e.find(".edit-contents-time").blur(n)),
          e
            .find(".edit-contents-link")
            .width(
              e.find(".edit-contents-link").width() -
                e.find(".edit-contents-link-scheme").width() -
                5
            );
      }),
      (c.hasChanges = function (e, t) {
        var n = c.valueChanged(e.find(".edit-contents-title"), t.name);
        return (n =
          (n =
            (n =
              (n =
              ...
              (t.streamId &&
                t.streamId !== e.find(".edit-contents-stream").val())) ||
            c.valueChanged(e.find(".edit-contents-metadata"), t.metadata)) ||
          c.valueChanged(
            e.find(".edit-contents-link"),
            t.link ? t.link.replace(p, "") : ""
          ));
      }),
      (c.validate = function (e, t) {
        var n = c.validateTime(
          e.find(".edit-contents-time").val(),
          e.find(".edit-contents-stream").val() || void 0,
          void 0
        );
        if (!n) {
          var o = Panopto.Core.TimeHelpers.durationFromFormattedString(
            e.find(".edit-contents-time").val(),
            Panopto.GlobalResources.TimeSeparator
          );
          if (i.activeState().isTimeInSessionReference(o)) {
            var a = i.activeState().findNextTimeNotInSessionReference(o),
              r = Panopto.Core.TimeHelpers.formatDuration(
                a / Panopto.Core.Constants.TimelineChunkMultiplier,
                Panopto.GlobalResources.TimeSeparator,
                !0,
                Panopto.Core.Constants.DisplayTimeMillisecondPrecision
              );
            n = Panopto.GlobalResources.ViewerPlus_Edit_Modal_Error_TimeInClip.format(
              r
            );
          }
        }
      ...
      (c.populateEvent = function (e, t) {
        ...
        (t.name = e.find(".edit-contents-title").val()),
          (t.timelineTime = c.eventTimeFromFormattedString(
            e.find(".edit-contents-time").val()
          )),
  ...
  (Panopto.Viewer.Tabs = Panopto.Viewer.Tabs || {}),
  (Panopto.Viewer.Tabs.Editor = Panopto.Viewer.Tabs.Editor || {}),
  (PanoptoLegacy.Viewer.Tabs.Editor.EditTranscriptTab = function (
    e,
    t,
    n,
    o,
    ...
    var s,
      l =
        ...
        "\n        </span>",
      c = [Panopto.Core.EventType.Caption],
      d = PanoptoLegacy.Viewer.Tabs.Editor.EditEventTab(
        e,
        t,
        n,
        Panopto.Viewer.Analytics.EditTranscript,
        o,
        i,
        c,
        Panopto.GlobalResources.ViewerPlus_Edit_Modal_EditCaptionTitle,
        Panopto.GlobalResources.ViewerPlus_Edit_AddCaption,
        r
      ),
      u = Panopto.Core.Extensions.base(d),
      p = t.find("#editTranscriptPaneHeader"),
      f = p.find("#importTranscriptButton"),
      h = p.find("#importTranscriptPopup"),
    ...
    Panopto.LanguageSelector($("#languageSelector"), {
      ...
      onLanguageSelected: function (e) {
        (s = e), u.render(d.events(), !0, void 0, void 0, void 0, s);
      },
    }),
      (d.render = function (e, t, n, i, a) {
        var r =
          o.activeState().filterEvents(Panopto.Core.EventType.Caption).length >
          0;
        m.text(
          r
            ? Panopto.GlobalResources
                .ViewerPlus_Edit_ReplaceWithMachineTranscript
            : Panopto.GlobalResources.ViewerPlus_Edit_ImportMachineTranscript
        ),
          S(P, g),
          u.render(e, t, n, i, a, s);
      }),
      (d.templateDialog = function (e, t) {
        e.html(
          _.template($("#editTranscriptTemplate").html())({
            event: { name: t.name, formattedTime: d.formatEventTime(t) },
          })
        );
      }),
      (d.hasChanges = function (e, t) {
        var n = d.valueChanged(e.find(".edit-transcript-title"), t.name);
        return (n =
          n ||
          d.valueChanged(
            e.find(".edit-transcript-time"),
            d.formatEventTime(t)
          ));
      }),
      (d.validate = function (e, t) {
        var n, i;
        if (
          ((n = !!$.trim(e.find(".edit-transcript-title").val())),
          e
            .find(".edit-transcript-title-error")
            .text(
              n
                ? ""
                : Panopto.GlobalResources.ViewerPlus_Edit_Modal_Error_NoCaption
            ),
          !(i = d.validateTime(
            e.find(".edit-transcript-time").val(),
            t.streamId,
            void 0
          )))
        ) {
          var a = Panopto.Core.TimeHelpers.durationFromFormattedString(
            e.find(".edit-transcript-time").val(),
            Panopto.GlobalResources.TimeSeparator
          );
          if (o.activeState().isTimeInSessionReference(a)) {
            ...
            i = Panopto.GlobalResources.ViewerPlus_Edit_Modal_Error_TimeInClip.format(
              s
            );
          }
        }
        return (
          e.find(".edit-transcript-time-error").text(i || ""), (n = n && !i)
        );
      }),
      (d.populateEvent = function (e, t) {
        d.updateName(t, e.find(".edit-transcript-title").val()),
          (t.timelineTime = d.eventTimeFromFormattedString(
            e.find(".edit-transcript-time").val()
          )),
          (t.edited = !0);
      }),
      (d.updateName = function (e, t) {
        u.updateName(e, t), e.metadata && (e.metadata = t);
      }),
      (d.addEvent = function (e) {
        u.addEvent(e, Panopto.Core.EventType.Caption, { language: s }),
          g.hide();
      }),
      (d.filterForRender = function () {
        return _.filter(d.events(), function (e) {
          return (
            (_.contains(c, e.type) ||
              (e.forceShow &&
                e.type === Panopto.Core.EventType.SpeechRecognition)) &&
      ...
      Panopto.Core.UI.Components.popup(h, f, function () {
        h.show().css({ top: p.outerHeight() + "px" }),
          m.toggle(
            o
              .activeState()
              .filterEvents(Panopto.Core.EventType.SpeechRecognition).length > 0
          );
      }),
      Panopto.Core.UI.Handlers.button(m, function () {
        ...
        var t = _.filter(o.activeState().events(), function (e) {
          return (
            e.type === Panopto.Core.EventType.SpeechRecognition && !e.forceShow
          );
        });
        ...
        _.each(n, function (e) {
          d.events().splice(d.events().indexOf(e), 1);
        }),
          _.each(e, function (e) {
            d.events().push(e);
          }),
        ...
        !(function (t) {
          var n = PanoptoCore.TypedCallback,
            ...
            i = (function () {
              ...
              return (
                Object.defineProperty(t.prototype, "eventAdded", {
                  get: function () {
                ...
                (t.prototype.isCloseToAnotherEmbeddedEvent = function (t) {
                  var n = this,
                    o = function (t, n, o) {
                      return (
                        t > n - e.Viewer.Constants.UrlEventClosenessTolerance &&
                        t < o + e.Viewer.Constants.UrlEventClosenessTolerance
                      );
                    },
                    i = _.any(this.timelineState.questionLists(), function (e) {
                      var i = n.timeConverter
                          .toFirstPrimaryRelative(e.firstStreamRelativeTicks)
                          .seconds(),
                    ...
                    a = _.any(this.timelineState.events(), function (e) {
                      if (
                        ...
                        -1 !==
                          e.link.indexOf(
                            PanoptoViewer.Constants.YouTubeEmbedBaseUrl
                          )
                      ) {
                        var i =
                            n.timelineState.calculateEditorTimeTicksFromAbsolute(
                              e.timelineTime
                            ) / Panopto.Core.Constants.TimelineChunkMultiplier,
                          a = i + PanoptoViewer.Constants.UrlEventDuration;
                        return o(t, i, a);
                ...
                (t.prototype.isValidTimeForEmbeddedEvent = function (e) {
                  return (
                    !this.isCloseToAnotherEmbeddedEvent(e) &&
                    this.isValidTimeForEvent(e)
                  );
                }),
                ...
                (t.prototype.addUrlEvent = function (e, t) {
                  if (this.isValidTimeForEvent(t)) {
                    var n = new o(
                      ...
                      i = this.timeConverter.toWin32EpochRelative(n),
                      a = this.getActiveStreamIdAtTime(i.ticks(), !0),
                      r = e.match(Panopto.Core.Constants.UrlMatcher)
                        ? e
                        : void 0;
                    this.addEvent(
                      e,
          ...
          var t = (function () {
            function e(t, n) {
              ...
              (this.invalidFileErrorLabel = t),
                ...
                (this.uploadEventTime = this.element.find(
                  ".upload-event-time"
                )),
                (this.uploadProgress = this.element.find(".upload-progress")),
                (this.uploadProgressBar = this.element.find(
                  ".upload-progress-bar"
                )),
                (this.uploadBytes = this.element.find(".upload-bytes")),
                (this.uploadProcessing = this.element.find(
                  ".upload-processing"
                )),
            ...
            return (
              Object.defineProperty(e.prototype, "onPendingUploadDeleting", {
                get: function () {
              ...
              (e.prototype.render = function (e, t) {
                if (((this.pendingUpload = t), t.startTime)) {
                  ...
                  if (e.absoluteStart() === 1 / 0) n = 0;
                    ...
                    var o =
                      Panopto.Core.TimeHelpers.dateToWin32EpochTime(
                        t.startTime
                      ) * Panopto.Core.Constants.TimelineChunkMultiplier;
                    n = e.calculateEditorTimeFromAbsolute(o);
                  }
                  var i = Panopto.Core.TimeHelpers.formatDuration(
                    n,
                    Panopto.GlobalResources.TimeSeparator
                  );
                ...
                switch (
                  (this.uploadIcon.html(t.iconCode),
                  ...
                  case 4:
                    this.renderError(
                      Panopto.Core.StringHelpers.format(
                        this.resources.ViewerPlus_Edit_LargeFile,
                        Panopto.Core.StringHelpers.readableByteCount(
                          Panopto.features.uploadByteLimit,
                          this.resources
                        )
                      )
                  ...
                  case 5:
                    this.renderError(
                      Panopto.GlobalResources.ViewerPlus_Edit_UploadError
                    );
                    break;
                  case 6:
                    this.renderError(
                      t.errorMessage
                        ? t.errorMessage
                        : Panopto.GlobalResources
                            .ViewerPlus_Edit_UploadProcessingError
                    );
                    break;
                  case 7:
                    this.renderError(
                      Panopto.GlobalResources.ViewerPlus_Edit_UploadDeleteError
                    );
                    break;
                  default:
                    $.noop();
              ...
              (e.prototype.setUploadProgress = function (e, t) {
                var n = Panopto.Core.StringHelpers.readableUploadProgress(
                  e,
                  t,
                  Panopto.GlobalResources,
                  "ViewerPlus_Edit_UploadProgress"
                );
              ...
              return (
                document.addEventListener(n, function (e) {
                  e instanceof CustomEvent &&
                    r.renderUploadProgress(
                      e.detail.bytesUploaded,
                      e.detail.fileSize
                    );
                }),
            ...
            a = (function () {
              function e() {
                ...
                (this._seekCallbacks = new n()),
                  ...
                  (this.orderedContainer = new i()),
                  (this.expanded = !1),
                  (this.eventRows = {}),
                  (this.element = $(e.template())),
                  (this.sessionReferenceName = this.element.find(
                    ".session-reference-name"
                  )),
                  (this.sessionReferenceDisplayTime = this.element.find(
                    ".session-reference-display-time"
                  )),
                  (this.sessionReferenceToggle = this.element.find(
                    ".session-reference-toggle"
                  )),
                  (this.sessionReferenceExpandedToc = this.element.find(
                    ".session-reference-expanded-toc"
                  ));
                ...
                Panopto.Core.UI.Handlers.button(this.element, function () {
                  ...
                  (this.editMenu = new o(
                    a,
                    a.find(".session-reference-edit-toggle"),
                    Panopto.GlobalResources,
                    { toggleAppearsOnHover: !0 }
                  )),
              ...
              return (
                Object.defineProperty(e.prototype, "seekCallbacks", {
                  get: function () {
                    return this._seekCallbacks;
                  },
                  enumerable: !1,
                ...
                (e.prototype.render = function (e) {
                  ...
                  this.sessionReferenceName.text(e.name),
                    ...
                    this.editMenu.setEvent(e, { canEdit: !0, canDelete: !0 }),
                    this.renderToc();
                }),
                (e.prototype.toggleExpandedToc = function () {
                  (this.expanded = !this.expanded),
                    this.sessionReferenceToggle.toggleClass(
                      "expanded",
                      this.expanded
                    ),
                ...
                (e.prototype.renderToc = function () {
                  var e = this;
                  this.sessionReferenceExpandedToc.append(
                    this.orderedContainer.element
                  ),
                    _.each(
                      this.sessionReference.events.concat(
                        this.sessionReference.slideEvents
                      ),
                      function (t) {
                        t.isDefaultThumbnail ||
                          (e.eventRows.hasOwnProperty(t.id) ||
                            e.createTocRow(t),
          ...
          var n = (function () {
            function n(t) {
              ...
              (this.slideDeckTemplate = _.template(
                ...
                (this.slideDeckExpand = this.element.find(
                  ".slide-deck-expand"
                )),
                (this.slideDeckName = this.element.find(".slide-deck-name")),
                (this.slideList = this.element.find(".slide-list")),
                Panopto.Core.UI.Handlers.button(
                  this.slideDeckExpand,
                  function () {
                    n.slideDeckExpand.toggleClass(
                      Panopto.Core.Constants.ExpandedClass
                    ),
                      n.slideList.toggle(
                        n.slideDeckExpand.hasClass(
                          Panopto.Core.Constants.ExpandedClass
                        )
                      );
                  }
                ),
                (this.editMenu = new e.Viewer.Controls.EditEventMenu(
                  this.element,
                  this.element.find(".slide-deck-edit-toggle"),
                  Panopto.GlobalResources
                )),
                this.editMenu.deleteCallbacks.add(function (e) {
            ...
            return (
              (n.prototype.render = function (e) {
                (this.slideDeckId = e.id),
                  ...
                  this.editMenu.setEvent(e, { canEdit: !1, canDelete: !0 }),
                  this.element.show();
              }),
          ...
          var n = (function () {
            function t(t, n) {
              ...
              (this.container = t),
                ...
                Panopto.Core.UI.Handlers.button(
                  this.element.find(".slide-add"),
                  function () {
                    o.canAddSlide && o.slideEventAddCallbacks.fire(n);
                  }
                ),
                (this.eventListScrollingHighlight = Panopto.Core.UI.Components.scrollingHighlight(
                  this.eventList,
                  !0,
                  e.Viewer.Constants.EventScrollTimeout
                )),
                t.append(this.element);
            }
            return (
              (t.prototype.renderEvents = function (t) {
                var n = this;
                _.each(t, function (t) {
                  if (!n.eventElements.hasOwnProperty(t.id)) {
                    ...
                    var i = new e.Viewer.Controls.EditEventMenu(
                      o,
                      o.find(".event-edit-toggle"),
                      Panopto.GlobalResources,
                      { toggleAppearsOnHover: !0 }
                    );
          ...
          var n = (function () {
            function t() {
              ...
              (this._streamSeekCallbacks = new PanoptoCore.TypedCallback()),
                ...
                (this.streamDisplayTime = this.element.find(
                  ".stream-display-time"
                )),
                Panopto.Core.UI.Handlers.button(this.element, function () {
                  n._streamSeekCallbacks.fire(n.stream);
                }),
                (this.editEventMenu = new e.Viewer.Controls.EditEventMenu(
                  this.element,
                  this.element.find(".stream-edit-toggle"),
                  Panopto.GlobalResources,
                  { toggleAppearsOnHover: !0 }
                )),
            ...
            return (
              Object.defineProperty(t.prototype, "streamSeekCallbacks", {
                get: function () {
              ...
              (t.prototype.render = function (e, t, n) {
                ...
                this.streamIconCode.html(t.iconCode),
                  ...
                  this.streamDisplayTime.text(a),
                  this.element.show(),
                  this.editEventMenu.setEvent(t, { canEdit: !0, canDelete: n });
              }),
